...
using UpdaterAdminUnidad.Data;
using UpdaterAdminUnidad.FuncionesGenerales;
...
namespace UpdaterAdminUnidad
{
    ...
    public class RevisarActualizaciones
    {
        ...
        string sNombreLog = Application.StartupPath + "\\LogUpdateAdminUnidad_"; 
        ...
        private bool BuscarActualizacion()
        {
            ...
            try
            {
                Registro("Buscando actualización de Administración Unidad");
                RegistrarCambios(); 
        ...
        private bool ObtenerUrl()
        {
            ...
            bool bRegresa = false;
            string sXml = General.UnidadSO + ":\\SII-Unidad.xml";
    ...
    public class LeerVersion : clsLeer
    {
        ...
        private UpdaterAdminUnidad.wsUpdater.wsUpdater conexion;
        ...
        {
            conexion = new UpdaterAdminUnidad.wsUpdater.wsUpdater();
