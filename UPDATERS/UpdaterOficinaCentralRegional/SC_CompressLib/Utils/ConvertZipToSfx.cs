...
namespace SC_CompressLib.Zip.Examples
{
    ...
    public class ConvertZipToSfx
    {
        ...
        public ConvertZipToSfx(string[] args)
        {
            for (int i = 0; i < args.Length; i++)
            {
                switch (args[i])
                {
                    ...
                    case "-cmdline":
                        flavor = SC_CompressLib.Zip.SelfExtractorFlavor.ConsoleApplication;
                        break;
        ...
        SelfExtractorFlavor flavor = SC_CompressLib.Zip.SelfExtractorFlavor.WinFormsApplication;
