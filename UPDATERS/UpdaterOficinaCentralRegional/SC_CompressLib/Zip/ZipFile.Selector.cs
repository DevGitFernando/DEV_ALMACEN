...
namespace SC_CompressLib.Zip
{
    ...
    partial class ZipFile
    {
                                     ...
                                     bool recurseDirectories)
        {
            ...
            SC_CompressLib.FileSelector ff = new SC_CompressLib.FileSelector(selectionCriteria);
...
namespace SC_CompressLib
{
    ...
    {
        internal abstract bool Evaluate(SC_CompressLib.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(SC_CompressLib.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(SC_CompressLib.Zip.ZipEntry entry)
        {
        ...
        public System.Collections.Generic.ICollection<SC_CompressLib.Zip.ZipEntry> SelectEntries(SC_CompressLib.Zip.ZipFile zip)
        {
            var list = new System.Collections.Generic.List<SC_CompressLib.Zip.ZipEntry>();

            foreach (SC_CompressLib.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        /// 
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public System.Collections.Generic.ICollection<SC_CompressLib.Zip.ZipEntry> SelectEntries(SC_CompressLib.Zip.ZipFile zip, string directoryPathInArchive)
        {
            var list = new System.Collections.Generic.List<SC_CompressLib.Zip.ZipEntry>();
