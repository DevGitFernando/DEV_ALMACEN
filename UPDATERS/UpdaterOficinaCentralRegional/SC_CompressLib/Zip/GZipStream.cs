...
//
// last saved (in emacs): 
// Time-stamp: <2009-June-16 08:34:59>
//
// ------------------------------------------------------------------
//
...
namespace SC_CompressLib.Zlib
{
    ...
    /// cref="System.IO.Stream"/>.  It adds GZIP compression or decompression to any stream.
    /// </para>
    ///
    /// <para> Like the <c>System.IO.Compression.GZipStream</c> in the .NET Base
    /// Class Library, the SC_CompressLib.Zlib.GZipStream can compress while writing, or decompress
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == SC_CompressLib.Zlib.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == SC_CompressLib.Zlib.ZlibBaseStream.StreamMode.Reader)
        ...
        /// {
        ///     using (Stream decompressor= new SC_CompressLib.Zlib.GZipStream(input, CompressionMode.Decompress, true))
        ///     {
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == SC_CompressLib.Zlib.ZlibBaseStream.StreamMode.Undefined)
            {
