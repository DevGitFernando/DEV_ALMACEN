...
namespace SC_CompressLib.Zip
{
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "SC_CompressLib.Zip.WinFormsSelfExtractorStub.resources",
                    "SC_CompressLib.Zip.PasswordDialog.resources",
                    "SC_CompressLib.Zip.ZipContentsDialog.resources"},
                ResourcesToCompile = new List<string>{
                    "SC_CompressLib.Zip.Resources.WinFormsSelfExtractorStub.cs",
                    "SC_CompressLib.Zip.WinFormsSelfExtractorStub", // .Designer.cs
                    "SC_CompressLib.Zip.Resources.PasswordDialog.cs",
                    "SC_CompressLib.Zip.PasswordDialog",             //.Designer.cs"
                    "SC_CompressLib.Zip.Resources.ZipContentsDialog.cs",
                    "SC_CompressLib.Zip.ZipContentsDialog",             //.Designer.cs"
                    "SC_CompressLib.Zip.Resources.FolderBrowserDialogEx.cs",
                }
            },
            new ExtractorSettings() {
                ...
                ResourcesToCompile = new List<string>{"SC_CompressLib.Zip.Resources.CommandLineSelfExtractorStub.cs"}
            }
        };
        ...
        //         "namespace SC_CompressLib.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorFlavor flavor)
        {
            ...
            try
            {
                ...
                // get the SC_CompressLib.Zip assembly
                ...
                // This is the list of referenced assemblies.  SC_CompressLib.Zip is needed here.
                ...
                // add the SC_CompressLib.Utils.Zip DLL as an embedded resource
