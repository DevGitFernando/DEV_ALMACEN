...
using UpdateMail;
using UpdateMail.Data;
using UpdateMail.FuncionesGenerales;
...
namespace UpdateMail
{
    ...
    public class RevisarActualizaciones
    {
        ...
        string sNombreLog = Application.StartupPath + "\\LogUpdateMail_"; 
        ...
        private bool BuscarActualizacion()
        {
            ...
            try
            {
                Registro("Buscando actualización de SII-Mail");
                RegistrarCambios(); 
        ...
        private bool ObtenerUrl()
        {
            ...
            bool bRegresa = false; 
            string sXml = General.UnidadSO + ":\\Mail.xml";
    ...
    public class LeerVersion : clsLeer
    {
        ...
        private UpdateMail.wsUpdater.wsUpdater conexion;
        ...
        {
            conexion = new UpdateMail.wsUpdater.wsUpdater();
