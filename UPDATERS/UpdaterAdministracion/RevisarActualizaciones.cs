...
using UpdateAdministracion;
using UpdateAdministracion.Data;
using UpdateAdministracion.FuncionesGenerales;

using Microsoft.VisualBasic;
using Microsoft.Win32;

namespace UpdateAdministracion
{
    ...
    public class RevisarActualizaciones
    {
        ...
        string sNombreLog = Application.StartupPath + "\\LogUpdateAdministracion_"; 
        ...
        private bool BuscarActualizacion()
        {
            ...
            try
            {
                Registro("Buscando actualización de Administración");
                RegistrarCambios(); 
    ...
    public class LeerVersion : clsLeer
    {
        ...
        private UpdateAdministracion.wsUpdater.wsUpdater conexion;
        ...
        {
            conexion = new UpdateAdministracion.wsUpdater.wsUpdater();
