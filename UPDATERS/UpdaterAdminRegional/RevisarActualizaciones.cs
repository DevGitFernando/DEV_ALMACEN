...
using UpdaterAdminRegional;
using UpdaterAdminRegional.Data;
using UpdaterAdminRegional.FuncionesGenerales;

using Microsoft.VisualBasic;
using Microsoft.Win32; 

namespace UpdaterAdminRegional
{
    ...
    public class RevisarActualizaciones
    {
        ...
        string sNombreLog = Application.StartupPath + "\\LogUpdateAdminRegional_"; 
        ...
        public void CheckVersion()
        {
            ...
            ////{
            ////    Log.Flush(); 
            ////    Log.WriteLine("Actualización con éxito.");
            ////}
        ...
        private bool BuscarActualizacion()
        {
            ...
            try
            {
                Registro("Buscando actualización de Administración Regional");
                Registro(sUrl); 
                RegistrarCambios(); 
                while (iSolicitudes <= 3)
                {
                    ...
                    Registro(sSql + " ............ " + iSolicitudes.ToString());
                    RegistrarCambios(); 
                    ...
                    else
                    {
                        if (leerVersion.Leer())
                        {
                            bRegresa = DescargarVersion(leerVersion);
                            // bRegresa = true; 
                            iSolicitudes = 4; 
                        }
                    }
        ...
        private bool ObtenerUrl()
        {
            ...
            bool bRegresa = false;
            string sXml = General.UnidadSO + ":\\SII-Regional.xml";
            ...
            try
            {
                ...
                if (leer.Leer())
                {
                    ...
                    //sUrl += leer.Campo("PaginaAsmx").Replace(".asmx", "") + ".asmx";
                    sUrl += "wsUpdater.asmx";
        ...
        private bool DescargarVersion(clsLeer Descargar) 
        {
            bool bRegresa = true;
    ...
    public class LeerVersion : clsLeer
    {
        ...
        private UpdaterAdminRegional.wsUpdater.wsUpdater conexion;
        ...
        {
            conexion = new UpdaterAdminRegional.wsUpdater.wsUpdater();
