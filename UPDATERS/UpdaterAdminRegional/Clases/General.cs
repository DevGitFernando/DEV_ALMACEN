...
//using UpdaterAdminRegional.Errores;
//using UpdaterAdminRegional.Usuarios_y_Permisos;
...
namespace UpdaterAdminRegional
{
    ...
    public static class General
    {
        ...
        private static void ConexionesRed()
        {
            ...
            {
                // Ip del host
                foreach(IPAddress myIp in Dns.GetHostAddresses(sNombreHost))
                {
                ...
                PhysicalAddress adaptador = nics[0].GetPhysicalAddress();
                sMacAddress = adaptador.ToString();
