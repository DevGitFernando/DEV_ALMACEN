------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select Name From SysObjects(NoLock) Where Name = 'spp_INT_IFarmatel___GetServiciosADomicilio' and xType = 'P') 
    Drop Proc spp_INT_IFarmatel___GetServiciosADomicilio 
Go--#SQL 
  
--  ExCB spp_INT_IFarmatel___GetServiciosADomicilio '001', '11', '0003', '0001', '0001', 1, '2014-08-20'
  
Create Proc spp_INT_IFarmatel___GetServiciosADomicilio 
(   
...
--		spp_INT_IFarmatel___GetServiciosADomicilio 
