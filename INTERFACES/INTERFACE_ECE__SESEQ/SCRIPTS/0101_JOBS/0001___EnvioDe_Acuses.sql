...
--- Configurar JOB 
	...
	Set @sPrefijo = 'RP_001' 
	Set @sJob_Name = @sPrefijo + '__SND_Acuses_ISESEQ__' + @Nombre_BD + '' 
	
	Set @sPaso_01_name = @sPrefijo + '__01_Enviar_Acuses__' + @Nombre_BD	
	
	Set @sTM_01_name =	 @sPrefijo + '_02_Enviar_Acuses__' + @Nombre_BD		
	...
	Set @sRutaAplicacion = 'E:\SII_PUNTO_DE_VENTA\ISESEQ SERVICIOS.exe IN '
