-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_SESEQ__RecetasElectronicas_0012_AcusesInformacion' and xType = 'P' ) 
   Drop Proc spp_INT_SESEQ__RecetasElectronicas_0012_AcusesInformacion
Go--#SQL 

Create Proc spp_INT_SESEQ__RecetasElectronicas_0012_AcusesInformacion 
( 
...
------------------------------------------------- OBTENER LA INFORMACION SURTIDOS    
	Select X.IdEmpresa, X.IdEstado, X.IdFarmacia, X.Folio as FolioInterface, 
		X.UMedica, X.Folio_SESEQ, G.EsSurtido, G.FolioSurtido as FolioVenta,
