-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_SESEQ__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse_Detalles' and xType = 'P' ) 
   Drop Proc spp_INT_SESEQ__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse_Detalles
Go--#SQL 

Create Proc spp_INT_SESEQ__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse_Detalles 
( 
...
---		spp_INT_SESEQ__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse_Detalles 	
