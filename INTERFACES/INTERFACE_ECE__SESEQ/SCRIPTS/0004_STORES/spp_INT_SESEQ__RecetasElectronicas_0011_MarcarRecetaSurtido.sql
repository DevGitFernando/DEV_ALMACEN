-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_SESEQ__RecetasElectronicas_0011_MarcarRecetaSurtido' and xType = 'P' ) 
   Drop Proc spp_INT_SESEQ__RecetasElectronicas_0011_MarcarRecetaSurtido
Go--#SQL 

Create Proc spp_INT_SESEQ__RecetasElectronicas_0011_MarcarRecetaSurtido 
( 
...
------------------------------------------------- OBTENER LA INFORMACION   
	Update G Set EsSurtido = 1, EsSurtido_Electronico = 1, FolioSurtido = @FolioSurtido, FechaDeSurtido = getdate(), IntentosDeEnvio = IntentosDeEnvio + 1  
