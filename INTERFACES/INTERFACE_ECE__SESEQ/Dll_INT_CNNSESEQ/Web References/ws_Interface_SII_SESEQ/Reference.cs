...
namespace Dll_INT_CNNSESEQ.ws_Interface_SII_SESEQ {
    using System;
    ...
    public partial class wsISESEQ : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public wsISESEQ() {
            this.Url = global::Dll_INT_CNNSESEQ.Properties.Settings.Default.Dll_INT_CNNSESEQ_ws_Interface_SII_SESEQ_wsISESEQ;
        ...
        public void DescargarInventarioAsync(string Informacion_XML, string GUID, int TipoUnidad, object userState) {
            ...
            this.InvokeAsync("DescargarInventario", new object[] {
                        Informacion_XML,
                        GUID, TipoUnidad}, this.DescargarInventarioOperationCompleted, userState);
        }
