...
namespace Dll_SII_IMediaccess.wsUpdateVersion {
    using System;
    ...
    public partial class wsUpdater : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback RevisarVersion_ModuloOperationCompleted;
        ...
        /// <remarks/>
        public wsUpdater() {
            this.Url = global::Dll_SII_IMediaccess.Properties.Settings.Default.Dll_SII_IMediaccess_wsUpdateVersion_wsUpdater;
        ...
        /// <remarks/>
        public event RevisarVersion_ModuloCompletedEventHandler RevisarVersion_ModuloCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://SC-Solutions/ServiciosWeb/RevisarVersion_Modulo", RequestNamespace="http://SC-Solutions/ServiciosWeb/", ResponseNamespace="http://SC-Solutions/ServiciosWeb/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Data.DataSet RevisarVersion_Modulo(string Modulo, string Version, string VersionModulo) {
            object[] results = this.Invoke("RevisarVersion_Modulo", new object[] {
                        Modulo,
                        Version,
                        VersionModulo});
            return ((System.Data.DataSet)(results[0]));
        ...
        /// <remarks/>
        public void RevisarVersion_ModuloAsync(string Modulo, string Version, string VersionModulo) {
            this.RevisarVersion_ModuloAsync(Modulo, Version, VersionModulo, null);
        }
        
        /// <remarks/>
        public void RevisarVersion_ModuloAsync(string Modulo, string Version, string VersionModulo, object userState) {
            if ((this.RevisarVersion_ModuloOperationCompleted == null)) {
                this.RevisarVersion_ModuloOperationCompleted = new System.Threading.SendOrPostCallback(this.OnRevisarVersion_ModuloOperationCompleted);
            }
            this.InvokeAsync("RevisarVersion_Modulo", new object[] {
                        Modulo,
                        Version,
                        VersionModulo}, this.RevisarVersion_ModuloOperationCompleted, userState);
        }
        
        private void OnRevisarVersion_ModuloOperationCompleted(object arg) {
            if ((this.RevisarVersion_ModuloCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.RevisarVersion_ModuloCompleted(this, new RevisarVersion_ModuloCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1586.0")]
    public delegate void RevisarVersion_ModuloCompletedEventHandler(object sender, RevisarVersion_ModuloCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1586.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class RevisarVersion_ModuloCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal RevisarVersion_ModuloCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
