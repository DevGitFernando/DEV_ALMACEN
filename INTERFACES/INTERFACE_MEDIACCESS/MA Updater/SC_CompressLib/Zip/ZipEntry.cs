...
namespace SC_CompressLib.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.LastModified"/>
        ...
        ///
        /// <seealso cref="SC_CompressLib.Zip.ZipFile.ForceNoCompression"/>
        ...
        /// creating.  </remarks>
        ///
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.CompressedSize"/>
        ...
        /// </remarks>
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.ExtractExistingFile"/>
        ...
        /// </para>
        /// </remarks>
        /// <seealso cref="SC_CompressLib.Zip.ZipFile.ExtractExistingFile"/>
        ...
        ///
        /// </remarks>
        /// <seealso cref="SC_CompressLib.Zip.ZipFile.WillReadTwiceOnInflation"/>
        /// <seealso cref="SC_CompressLib.Zip.ReReadApprovalCallback"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                _provisionalAlternateEncoding = (value) ? System.Text.Encoding.GetEncoding("UTF-8") : SC_CompressLib.Zip.ZipFile.DefaultEncoding;
            }
        }
        ...
        private static bool ReadHeader(ZipEntry ze, System.Text.Encoding defaultEncoding)
        {
            ...
            int signature = SC_CompressLib.Zip.SharedUtilities.ReadSignature(ze.ArchiveStream);
            bytesRead += 4;
            ...
            ze._LastModified = SC_CompressLib.Zip.SharedUtilities.PackedToDateTime(ze._TimeBlob);
            ...
            if (!ze._LocalFileName.EndsWith("/") && (ze._BitField & 0x0008) == 0x0008)
            {
                ...
                while (wantMore)
                {
                    ...
                    long d = SC_CompressLib.Zip.SharedUtilities.FindSignature(ze.ArchiveStream, ZipConstants.ZipEntryDataDescriptorSignature);
                    if (d == -1) return false;
        ...
        internal static void HandlePK00Prefix(Stream s)
        {
            ...
            uint datum = (uint)SC_CompressLib.Zip.SharedUtilities.ReadInt(s);
        ...
        private static void HandleUnexpectedDataDescriptor(ZipEntry entry)
        {
            ...
            {
                int sz = SC_CompressLib.Zip.SharedUtilities.ReadInt(s);
                if (sz == entry._CompressedSize)
                {
                    sz = SC_CompressLib.Zip.SharedUtilities.ReadInt(s);
        ...
        internal static ZipEntry Create(String filename, string nameInArchive, bool isStream, Stream stream)
        {
            if (String.IsNullOrEmpty(filename))
                throw new SC_CompressLib.Zip.ZipException("The entry name must be non-null and non-empty.");
...
#if NETCF
                // workitem 6878
                // SC_CompressLib.Zip.SharedUtilities.AdjustTime_Win32ToDotNet
                entry._Mtime = SC_CompressLib.Zip.SharedUtilities.AdjustTime_Win32ToDotNet(File.GetLastWriteTime(filename));
                entry._Ctime = SC_CompressLib.Zip.SharedUtilities.AdjustTime_Win32ToDotNet(File.GetCreationTime(filename));
                entry._Atime = SC_CompressLib.Zip.SharedUtilities.AdjustTime_Win32ToDotNet(File.GetLastAccessTime(filename));
        ...
        ///         
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.Extract(bool)"/>
        ///
        /// <remarks>
        ///
        ...
        /// 
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        /// <seealso cref="SC_CompressLib.Zip.ZipFile.Extract(string)"/>
        /// 
        /// <example>
        ...
        ///         
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        ...
        /// cref="SC_CompressLib.Zip.ZipEntry.ExtractExistingFile"/>property, or call <see
        ...
        /// 
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para> Existing entries in the filesystem will not be overwritten. If you would
        /// like to force the overwrite of existing files, see the <see
        ...
        /// 
        /// <para>
        /// The <see cref="SC_CompressLib.Zlib.CrcCalculatorStream"/> that is returned is just a regular
        ...
        ///   using (SC_CompressLib.Zlib.CrcCalculatorStream s = e1.OpenReader())
        ///   {
        ...
        ///       Using s As SC_CompressLib.Zlib.CrcCalculatorStream = e1.OpenReader
        ///           Dim n As Integer
        ...
        /// </code>
        /// </example>
        /// <seealso cref="SC_CompressLib.Zip.ZipEntry.Extract(System.IO.Stream)"/>
        /// <returns>The Stream for reading.</returns>
        public SC_CompressLib.Zlib.CrcCalculatorStream OpenReader()
        {
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public SC_CompressLib.Zlib.CrcCalculatorStream OpenReader(string password)
        {
        ...
        private SC_CompressLib.Zlib.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
...
#endif
            return new SC_CompressLib.Zlib.CrcCalculatorStream((CompressionMethod == 0x08)
                                                      ? new SC_CompressLib.Zlib.DeflateStream(input2, SC_CompressLib.Zlib.CompressionMode.Decompress, true)
                                                      : input2,
                                                      _UncompressedSize);
        }
        ...
        private void InternalExtract(string baseDir, Stream outstream, string password)
        {
                ...
                if (TargetFile != null)
                {
                    ...
                    if (_ntfsTimesAreSet)
                    {
                        ...
                        DateTime[] adjusted = new DateTime[] {
                            SC_CompressLib.Zip.SharedUtilities.AdjustTime_DotNetToWin32(_Ctime),
                            SC_CompressLib.Zip.SharedUtilities.AdjustTime_DotNetToWin32(_Atime),
                            SC_CompressLib.Zip.SharedUtilities.AdjustTime_DotNetToWin32(_Mtime),
                        };
                    ...
                    {
                        // workitem 6191
                        DateTime AdjustedLastModified = SC_CompressLib.Zip.SharedUtilities.AdjustTime_DotNetToWin32(LastModified);
            ...
            catch (Exception ex1)
            {
                ...
                if (ex1 as SC_CompressLib.Zip.ZipException == null)
 ...
 Encryption != EncryptionAlgorithm.None)
        ...
        private Int32 _ExtractOne(Stream output)
        {
            ...
            if (Encryption == EncryptionAlgorithm.PkzipWeak)
                ...
                //input2 = new SC_CompressLib.Zlib.CrcCalculatorStream(input, _CompressedFileDataSize);
                input2 = input;
            ...
            using (var s1 = new SC_CompressLib.Zlib.CrcCalculatorStream(input3))
            {
                while (LeftToRead > 0)
                {
        ...
        private void WriteHeader(Stream s, int cycle)
        {
            ...
            // LastMod
            _TimeBlob = SC_CompressLib.Zip.SharedUtilities.DateTimeToPacked(LastModified);
        ...
        private Int32 FigureCrc32()
        {
            if (_crcCalculated == false)
            {
                ...
                var crc32 = new SC_CompressLib.Zlib.CRC32();
        ...
        private void _WriteFileData(Stream s)
        {
            ...
            Stream input = null;
            SC_CompressLib.Zlib.CrcCalculatorStream input1 = null;
            ...
            try
            {
                ...
                input1 = new SC_CompressLib.Zlib.CrcCalculatorStream(input);
                ...
                {
                    var o = new SC_CompressLib.Zlib.DeflateStream(output1, SC_CompressLib.Zlib.CompressionMode.Compress,
        ...
        private void CopyThroughOneEntry(Stream outstream)
        {
            ...
            Stream input = this.ArchiveStream;
            var input1 = new SC_CompressLib.Zlib.CrcCalculatorStream(input);
