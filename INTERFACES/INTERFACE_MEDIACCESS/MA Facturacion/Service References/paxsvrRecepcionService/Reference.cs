...
namespace MA_Facturacion.paxsvrRecepcionService {
    ...
    public interface wcfRecepcionASMXSoap {
        ...
        MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLResponse fnEnviarXML(MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : MA_Facturacion.paxsvrRecepcionService.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<MA_Facturacion.paxsvrRecepcionService.wcfRecepcionASMXSoap>, MA_Facturacion.paxsvrRecepcionService.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLResponse MA_Facturacion.paxsvrRecepcionService.wcfRecepcionASMXSoap.fnEnviarXML(MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLRequest inValue = new MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLRequest();
            inValue.Body = new MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLRequestBody();
            ...
            MA_Facturacion.paxsvrRecepcionService.fnEnviarXMLResponse retVal = ((MA_Facturacion.paxsvrRecepcionService.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
