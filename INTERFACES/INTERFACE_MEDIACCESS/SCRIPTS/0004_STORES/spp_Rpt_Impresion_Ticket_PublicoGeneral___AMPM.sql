--------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_Rpt_Impresion_Ticket_PublicoGeneral___AMPM' and xType = 'P' ) 
   Drop Proc spp_Rpt_Impresion_Ticket_PublicoGeneral___AMPM 
Go--#SQL  

Create Proc	 spp_Rpt_Impresion_Ticket_PublicoGeneral___AMPM 
(
