--------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_Rpt_Impresion_Ticket___MEDIACCESS_Copago' and xType = 'P' ) 
   Drop Proc spp_Rpt_Impresion_Ticket___MEDIACCESS_Copago 
Go--#SQL  

Create Proc	 spp_Rpt_Impresion_Ticket___MEDIACCESS_Copago 
( 
	@IdEmpresa varchar(3) = '002', @IdEstado varchar(2) = '9', @IdFarmacia varchar(4) = '0012', @Folio varchar(8) = '664' 
)    
With Encryption 
As 
Begin 
