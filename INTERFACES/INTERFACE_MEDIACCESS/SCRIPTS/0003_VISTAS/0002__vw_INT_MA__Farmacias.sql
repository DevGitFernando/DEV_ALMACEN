...
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'vw_INT_MA__Farmacias' and xType = 'V' ) 
   Drop View vw_INT_MA__Farmacias
Go--#SQL

Create View vw_INT_MA__Farmacias
With Encryption 
As 
	...
	Select 
		...
		MA.Referencia_MA, MA.Referencia_MA_Facturacion, 
	...
	Inner Join INT_MA__CFG_FarmaciasClinicas MA (NoLock) 
