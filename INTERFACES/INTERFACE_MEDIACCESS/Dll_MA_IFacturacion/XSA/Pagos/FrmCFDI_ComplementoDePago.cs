...
namespace Dll_MA_IFacturacion.XSA
{
    public partial class FrmCFDI_ComplementoDePago : FrmBaseExt
    {
        ...
        string sStoreEnc_Real = " spp_Mtto_CFDI_Documentos_Generados ";
        string sStoreDet_Detalles_Real = " spp_Mtto_CFDI_PG_02__Pagos_Detalles ";
        string sStoreDet_MetodoDePago_Real = " spp_Mtto_CFDI_Documentos_MetodosDePago ";
        string sStoreDet_Detalles_UUID_Real = " spp_Mtto_CFDI_PG_03__Pagos_DoctosRelacionados ";

        //string sStoreEnc_VP = " spp_Mtto_FACT_CFDI_PG_01__Pagos_VP ";
        string sStoreEnc_VP = " spp_Mtto_CFDI_Documentos_Generados_VP ";
        string sStoreDet_Detalles_VP = " spp_Mtto_CFDI_PG_02__Pagos_Detalles_VP ";
        string sStoreDet_MetodoDePago_VP = " spp_Mtto_CFDI_Documentos_MetodosDePago_VP ";
        string sStoreDet_Detalles_UUID_VP = " spp_Mtto_CFDI_PG_03__Pagos_DoctosRelacionados_VP ";
        ...
        private void btnConsultarTimbres_Click(object sender, EventArgs e)
        {
            ...
            Dll_MA_IFacturacion.CFDI.Timbrar.clsTimbrar.Preparar_ConexionTimbrado(DtGeneral.EmpresaDatos.RFC, DtIFacturacion.PAC_Informacion);
        ...
        private void ObtenerInformacion_Empresa_y_Sucursal()
        {
            ...
            sSql += string.Format("Select IdEmpresa, IdEstado, IdFarmacia, Nombre, RFC, Status, Actualizado " +
                " From CFDI_Emisores_Sucursales (NoLock) " +
        ...
        private void Cargar__InformacionEmisor()
        {
            ...
            cboEmisor_RFC_BancoOrigen.Add("0", "<< Seleccione >>");

            cboEmisor_RFC_BancoOrigen.Add(consulta_MA.CFDI_Pagos__EmisorBancos_Cuentas(false, ""), true, "RFC_Banco", "NombreBanco");
            cboEmisor_RFC_BancoOrigen.SelectedIndex = 0;

            dtsCuentas_Emisor = consulta_MA.CFDI_Pagos__EmisorBancos_Cuentas(true, ""); 
        }

        private void Cargar__InformacionReceptor()
        {
            cboReceptor_RFC_BancoDestino.Clear();
            cboReceptor_RFC_BancoDestino.Add("0", "<< Seleccione >>");

            cboReceptor_RFC_BancoDestino.Add(consulta_MA.CFDI_Pagos__ReceptorBancos_Cuentas(false, ""), true, "RFC_Banco", "NombreBanco");
            cboReceptor_RFC_BancoDestino.SelectedIndex = 0;

            dtsCuentas_Receptor = consulta_MA.CFDI_Pagos__ReceptorBancos_Cuentas(true, "");  
        }

        private void Cargar__FormasDePago()
        {
            cboFormasDePago.Clear();
            cboFormasDePago.Add("0", "<< Seleccione >>");
            cboFormasDePago.Add(consulta_MA.CFDI_ComplementoPagos__FormasDePago(DtIFacturacion.Pago_FormaDePago, "Cargar__FormasDePago()"), true, "IdFormaDePago", "Descripcion_FormaDePago");
        ...
        {
            cboMonedas.Clear();
            cboMonedas.Add("0", "<< Seleccione >>");
            cboMonedas.Add(consulta_MA.CFDI_Monedas(DtIFacturacion.Pago_Moneda, ""), true, "Clave", "Moneda");
        ...
        private void Obtener_UsoCFDI()
        {
            cboUsosCFDI.Clear();
            cboUsosCFDI.Add();
            cboUsosCFDI.Add(consulta_MA.CFDI_UsosDeCFDI("Obtener_UsoCFDI()"), true, "Clave", "UsoDeCFDI");
        ...
        private void ObtenerSeries_y_Folios()
        {
            cboSeries.Clear();
            cboSeries.Add();
            dtsSeries = consulta_MA.CFDI_Series_y_Folios(sIdEmpresa, sIdEstado, sIdFarmacia, "", "ObtenerSeries_y_Folios()");
        ...
        private void txtId_Validating(object sender, CancelEventArgs e)
        {
            if (txtId.Text != "")
            {
                leer.DataSetClase = consulta_MA.CFDI_Clientes(txtId.Text, false, "txtId_Validating");
                if (leer.Leer())
                {
                    DatosCliente();
                }
        ...
        private bool RegistrarDocumentoElectronico() // sTipoDoctoCFDI
        {
            ...
            sSql = string.Format("Exec {0} " +
                ...
                " @TipoDocumento = '{22}', @TipoInsumo = '{23}', @IdPersonalEmite = '{24}', " +
                " @UsoDeCFDI = '{25}', @TipoRelacion = '{26}', @SAT_ClaveDeConfirmacion = '{27}', @CFDI_Relacionado_CPago = '{28}', " +
                " @Serie_Relacionada_CPago = '{29}', @Folio_Relacionado_CPago = '{30}', @TienePagoRelacionado = '{31}' ",
                sStoreEnc,
                ...
                iTipoDocumento, iTipoInsumo, DtGeneral.IdPersonal,
                DtIFacturacion.Pago_UsoCDFI, "", "", txtRelacion__UUID.Text.Trim(), txtRelacion__Serie.Text.Trim(), txtRelacion__Folio.Text.Trim(), 1
                );
            ...
            else
            {
                ...
                if (bRegresa)
                {
                    for (int Renglon = 1; Renglon <= grid.Rows; Renglon++)
                    {
                        ...
                        dImporte_SaldoAnterior = grid.GetValueDou(Renglon, Cols.SaldoAnterior);
                        dImporte_Pagado = grid.GetValueDou(Renglon, Cols.Abono);
                        dImporte_SaldoInsoluto = grid.GetValueDou(Renglon, Cols.SaldoFinal);
        ...
        private bool GenerarFolioDocumentoElectronico()
        {
            ...
            else
            {
                ...
                if (VistaPrevia)
                {
                    ...
                    sSql = string.Format("Delete From CFDI_ComplementoDePagos_DoctosRelacionados_VP " +
                        " Where IdEmpresa = '{0}' and IdEstado = '{1}' and IdFarmacia = '{2}' and Serie = '{3}' and Folio = '{4}' \n",
                        sIdEmpresa, sIdEstado, sIdFarmacia, sSerie, sFolio);
                    sSql += string.Format("Delete From CFDI_ComplementoDePagos_Detalles_VP " +
                        " Where IdEmpresa = '{0}' and IdEstado = '{1}' and IdFarmacia = '{2}' and Serie = '{3}' and Folio = '{4}' \n",
                        sIdEmpresa, sIdEstado, sIdFarmacia, sSerie, sFolio);
        ...
        private bool ImprimirDocumento_Timbrado()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    DtIFacturacion.GenerarImpresionWebBrowser_ComplementoDePagos(VistaPrevia, sFileName, true, GetExtras(leer.DataSetClase), sPDF, sXML, bVisualizar, null, false);
                }
            }
        ...
        private bool GenerarTimbre_PAC()
        {
            ...
            long pk = PK;
            long pkResult = 0;
            string sImpresion = VistaPrevia ? " spp_CFDI_ComplementoPagos_ObtenerDatos_VP " : " spp_CFDI_ComplementoPagos_ObtenerDatos ";
        ...
        private bool CargarInformacionDeHoja()
        {
            ...
            bulk.ClearColumns();
            bulk.DestinationTableName = "CFDI_ComplementoDePagos__CargaMasiva";
            ...
            leer.Exec("Truncate table CFDI_ComplementoDePagos__CargaMasiva ");
        ...
        {
            bool bRegresa = false;
            string sSql = string.Format("Exec spp_PRCS_CFDI__ComplementoDePagos_Validar_Datos  " +
        ...
        {
            bool bRegresa = false;
            string sSql = string.Format("Exec spp_PRCS_CFDI__ComplementoDePagos_ObtenerDatos  " +
        ...
        private void Inicializar_Cbo_CuentaEmisor()
        {
            ...
            cboEmisor_CuentaOrdenante.Add("0", "<< Seleccione >>");
        ...
        private void Inicializar_Cbo_CuentaBeneficiario()
        {
            ...
            cboReceptor_CuentaBeneficiario.Add("0", "<< Seleccione >>");
        ...
        private void BuscarDocumento( string sSerie, string sFolio )
        {
            ...
            sSql = string.Format(
                "Select *, \n"+
                " dbo.fg_CFDI_ComplementoPagos_Parcialidad ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) As Parcialidad, \n" +
                " dbo.fg_CFDI_ComplementoPagos_Acumulado ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) As ImporteTotal_Abonos \n" +  
            ...
            if(!bConError)
            {
                if(bEncontrado)
                {
                    ...
                    else
                    {
                        ...
                        grid.SetValue(grid.ActiveRow, (int)Cols.ValorNominal, leer.CampoDouble("Total"));
                        grid.SetValue(grid.ActiveRow, (int)Cols.TotalPagado, leer.CampoDouble("ImporteTotal_Abonos"));
                    }
                }
                else
                {
