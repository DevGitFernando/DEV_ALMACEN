...
namespace Dll_MA_IFacturacion.XSA
{
    internal partial class FrmFormaMetodoPago : FrmBaseExt
    {
        ...
        private void CargarInformacionInicial(bool ValidarCierreAutomatico)
        {
            ...
            {
                sValorBusqueda_MetodoDePago = "PUE";
                ...
                txtCondicionesPago.Text = string.Format("CONTADO");
            }
            else 
            {
                if (DtIFacturacion.ImplementaInformacionPredeterminada)
                {
                    ...
                    if (DtIFacturacion.PlazoDiasVenceFactura > 0)
                    {
                        ...
                        txtCondicionesPago.Enabled = false;
                        txtCondicionesPago.Text = string.Format("{0} {1} días", cboFormasDePago.Text, DtIFacturacion.PlazoDiasVenceFactura);
                    }

                    //txtCondicionesPago.Text = string.Format("{0}", DtIFacturacion.PlazoDiasVenceFactura);
