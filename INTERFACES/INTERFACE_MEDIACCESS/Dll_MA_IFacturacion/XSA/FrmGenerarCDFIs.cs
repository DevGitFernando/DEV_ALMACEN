            ...
            else
            {
                ...
                for (int Renglon = 1; Renglon <= list.Registros; Renglon++)
                {
                    ...
                    sSql = string.Format("Exec {0} " + 
                        ...
                        SubTotal.ToString().Replace(",", ""), Iva.ToString().Replace(",", ""), Total.ToString().Replace(",", ""), TipoImpuesto);  
        ...
        private bool ImprimirDocumento_Timbrado()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    DtIFacturacion.GenerarImpresionWebBrowser(VistaPrevia, sFileName, GetExtras(leer.DataSetClase), sPDF, sXML, bVisualizar, null);
                }
            }
