...
using Dll_MA_IFacturacion.PAC_VirtualSoft;
#endregion USING WEB SERVICES

namespace Dll_MA_IFacturacion.VirtualSoft
{
    public class vsWebServices
    {
        ...
        public vsWebServices()
        {
        }

        public vsWebServices(string Servidor)
        {
