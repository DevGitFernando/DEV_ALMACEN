...
namespace Dll_MA_IFacturacion.CFDI.geCFD
{
    public class clsCFDI
    {
        ...
        {
            ////clsGrabarError.LogFileError(string.Format("clsCFDI.{0}:    {1}", Funcion, Mensaje));
            clsLog_CFDI.Log("clsCFDI", Funcion, Mensaje); 
        }

        public string getXML(string filename, bool omitSeal)
        {
            LogProceso("Iniciando generación XML"); 
            ...
            documentElement.SetAttribute("schemaLocation", "http://www.w3.org/2001/XMLSchema-instance", "http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv32.xsd" + str);
            ...
            foreach (clsConcepto concepto in this.Conceptos)
            {
                iConceptos++;
                object[] obj = { 
                    iConceptos, toUTF8(concepto.noIdentificacion), toUTF8(concepto.descripcion), toUTF8(concepto.unidad), 
            ...
            if (this.Impuestos.Traslados.Count > 0)
            {
                ...
                {
                    object[] obj = { toUTF8(traslado.impuesto), traslado.tasa, traslado.importe };
        ...
        private void Preparar_Dts_01_Comprobante()
        {
            ...
            object[] obj = { 
                ...
                toUTF8(sello), toUTF8(formaDePago), toUTF8(metodoDePago), toUTF8(metodoDePagoDescripcion), 
