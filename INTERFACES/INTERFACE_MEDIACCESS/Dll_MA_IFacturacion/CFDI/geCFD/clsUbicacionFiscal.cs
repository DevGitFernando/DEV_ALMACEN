...
{
    public class clsUbicacionFiscal
    {
        ...
        {
            clsLog_CFDI.Log("clsUbicacionFiscal", Funcion, Mensaje);
        }
        ...
        private bool containsPipe(string fieldName, string fieldValue)
        {
            ...
            {
                this.lastError = "Atributo " + fieldName + "incorrecto. Ningún elemento puede contener el caracter | (pipe).";
        ...
        public bool isOK()
        {
            string str = "Falta atributo requerido: ";
            if ((this.calle == "") || (this.calle == null))
            {
                this.lastError = str + "calle";
                LogProceso("isOK", this.lastError); 
                return false;
            }
            if ((this.municipio == "") || (this.municipio == null))
            {
                this.lastError = str + "municipio";
                LogProceso("isOK", this.lastError); 
                return false;
            }
            if ((this.estado == "") || (this.estado == null))
            {
                this.lastError = str + "estado";
                LogProceso("isOK", this.lastError); 
                return false;
            }
            if ((this.pais == "") || (this.pais == null))
            {
                this.lastError = str + "pais";
                LogProceso("isOK", this.lastError); 
                return false;
            }
            if (this.codigoPostal == null)
            {
                this.lastError = str + "codigoPostal";
                LogProceso("isOK", this.lastError); 
                return false;
            }
