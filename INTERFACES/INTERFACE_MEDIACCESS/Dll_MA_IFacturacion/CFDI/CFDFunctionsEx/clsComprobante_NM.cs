...
{
    public class clsComprobante_NM
    {
        ...
        clsInformacionAdicional cInformacionAdicional = new clsInformacionAdicional(); 
        ...
        public clsComprobante_NM()
        {
        }

        public clsComprobante_NM(DataSet DatosComprobante)
        {
        ...
        public clsInformacionAdicional InformacionAdicional
        {
            get { return cInformacionAdicional; }
            set { cInformacionAdicional = value; }
        }
        ...
        private void RenombrarTablas()
        {
            ...
            leer.RenombrarTabla(8, "ConceptosDetalles");

            leer.RenombrarTabla(9, "Impuestos");


            ////leer.RenombrarTabla(8, "Traslados");
            ////leer.RenombrarTabla(9, "InformacionAdicional");
