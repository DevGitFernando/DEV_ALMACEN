...
namespace Dll_MA_IFacturacion.CFDI
{
    internal class SC_DllImports 
    {
        ...
        {
            descargarLibreria(sRuta, Dll_MA_IFacturacion.Properties.Resources.diCrPKI, "diCrPKI.dll");

            descargarLibreria(RutaDestino, Dll_MA_IFacturacion.Properties.Resources.libeay32, "libeay32.dll");
            descargarLibreria(RutaDestino, Dll_MA_IFacturacion.Properties.Resources.ssleay32, "ssleay32.dll");
            descargarLibreria(RutaDestino, Dll_MA_IFacturacion.Properties.Resources.openssl, "openssl.exe");
