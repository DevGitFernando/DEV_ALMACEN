    ...
    public class clsConceptos
    {
        ...
        private void CargarDatos()
        {
            ...
            while (leerConceptos.Leer())
            {
                ...
                concepto.ImporteIva = leerConceptos.CampoDouble("ImporteIva");
                concepto.ImporteDescuento = leerConceptos.CampoDouble("Descuento"); 
                ...
                concepto.ClaveProdServ_Descripcion = leerConceptos.Campo("ClaveProdServ_Descripcion");
                concepto.ClaveUnidad = leerConceptos.Campo("ClaveUnidad");
                concepto.ClaveUnidad_Descripcion = leerConceptos.Campo("ClaveUnidad_Descripcion");
                ...
                concepto.Impuesto_TasaOCuotaRetencion = leerConceptos.CampoDouble("Impuestos_TasaOCuota__RetencionIVA");
                concepto.Impuesto_ImporteRetencion = leerConceptos.CampoDouble("RetencionIVA");
