    ...
    public class clsCFDI_33_Pagos
    {
        ...
        public string getXML(string filename, bool omitSeal)
        {
            ...
            foreach (clsConcepto concepto in this.Conceptos)
            {
                ...
                elementTraslado_Item.SetAttribute("Impuesto", toUTF8(concepto.Impuesto_Impuesto));
            ...
            if (this.Impuestos.Traslados.Count > 0)
            {
                ...
                {
                    object[] obj = { toUTF8(traslado.impuesto), traslado.Impuesto_TipoFactor, traslado.tasa, traslado.importe };
                    ...
                    element5.SetAttribute("Impuesto", this.toUTF8(traslado.Impuesto_Impuesto));
