...
namespace Dll_MA_IFacturacion.CFDI.geCFD_33
{
    public class clsCFDI_33_Pagos
    {
        ...
        private string defPrefix_nm = "pago10";
        private string defURI = "http://www.sat.gob.mx/cfd/3";
        private string defURI_nm = "http://www.sat.gob.mx/Pagos";
        ...
        public string getXML( string filename, bool omitSeal )
        {
            ...
            documentElement.SetAttribute("xmlns:pago10", defURI_nm);
            ...
            documentElement.SetAttribute("schemaLocation",
                ...
                "http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv33.xsd http://www.sat.gob.mx/Pagos http://www.sat.gob.mx/sitio_internet/cfd/Pagos/Pagos10.xsd" + str);
            ...
            pagoElement.SetAttribute("Version", "1.0");


            clsLeer conceptoItem = new clsLeer();
            dtConceptos_Pago = dtsInformacion_Pago.Tables[0]; 
            ...
            while(conceptoItem.Leer())
            {
                ...
                if(datos_UUIDS.Registros > 0)
                {
                    while(datos_UUIDS.Leer())
                    {
                        ...
                        {
                            pagoElement_UUID_Relacionado_Item.SetAttribute("TipoCambioDR", this.toUTF8(datos_UUIDS.CampoDouble("TipoCambio").ToString("0.###0")));
                        }
