...
namespace Dll_MA_IFacturacion.CFDI.CFDFunctions
{
    public class clsGenCFDI_33_Factura
    {
        ...
        public void clsCFDI_33_Factura()
        {
        ...
        private clsCFDI_33_Factura generarCFD(CFDFunctionsEx.clsComprobante Comprobante)
        {
            ...
            try
            {
                ...
                foreach (CFDFunctionsEx.clsConcepto comprobante in Comprobante.Conceptos.Conceptos)
                {
                    ...
                    concepto.ClaveProdServ_Descripcion = comprobante.ClaveProdServ_Descripcion;
                    concepto.ClaveUnidad = comprobante.ClaveUnidad;
                    concepto.ClaveUnidad_Descripcion = comprobante.ClaveUnidad_Descripcion;
                    ...
                    concepto.ImporteDescuento = comprobante.ImporteDescuento;
                ...
                /////// Siempre agregar el nodo de Traslados, por el Medicamento ( Tasa CERO ) 
                //if (ccfdi.Impuestos.totalImpuestosTrasladados > 0.0)
                {
                    foreach (CFDFunctionsEx.clsTraslado tras in Comprobante.Traslados.ListaTraslados)
                    {
                        clsTraslado traslado_aux = new clsTraslado();
                        traslado_aux.impuesto = tras.Impuesto_Impuesto; 
