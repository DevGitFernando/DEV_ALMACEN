...
namespace Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://test.paxfacturacion.com.mx:453", ConfigurationName="PAC_pax_test_svrRecepcionService.wcfRecepcionASMXSoap")]
    public interface wcfRecepcionASMXSoap {
        ...
        Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLResponse fnEnviarXML(Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.wcfRecepcionASMXSoap>, Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLResponse Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.wcfRecepcionASMXSoap.fnEnviarXML(Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLRequest inValue = new Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLRequest();
            inValue.Body = new Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLRequestBody();
            ...
            Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.fnEnviarXMLResponse retVal = ((Dll_MA_IFacturacion.PAC_pax_test_svrRecepcionService.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
