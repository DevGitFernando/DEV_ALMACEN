------------------------------------------------------------------------------------------------------------------------------------------------ 
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_CFDI_ObtenerDatos_VP' and xType = 'P' ) 
   Drop Proc spp_CFDI_ObtenerDatos_VP 
Go--#SQL  

Create Proc spp_CFDI_ObtenerDatos_VP 
( 
	@Identificador bigint = 1927  
...
------------------------------------------ Obtener informacion 	
	Select 
		...
		--D.XMLMetodoPago,		---	  Exec  spp_CFDI_ObtenerDatos_VP 9 
