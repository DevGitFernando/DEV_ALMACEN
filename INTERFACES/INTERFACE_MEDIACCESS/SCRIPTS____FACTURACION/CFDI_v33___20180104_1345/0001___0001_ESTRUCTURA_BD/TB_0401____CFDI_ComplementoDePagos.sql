------------------------------------------------------------------------------------------------ 
------------------------------------------------------------------------------------------------ 
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'CFDI_ComplementoDePagos_DoctosRelacionados' and xType = 'U' ) 
	Drop Table CFDI_ComplementoDePagos_DoctosRelacionados   
Go--#SQL 

If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'CFDI_ComplementoDePagos_Detalles' and xType = 'U' ) 
	Drop Table CFDI_ComplementoDePagos_Detalles   
Go--#SQL 



------------------------------------------------------------------------------------------------ 
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'CFDI_ComplementoDePagos' and xType = 'U' ) 
	Drop Table CFDI_ComplementoDePagos  
Go--#SQL 

Create Table CFDI_ComplementoDePagos  
( 
...
Alter Table CFDI_ComplementoDePagos Add Constraint PK_CFDI_ComplementoDePagos 
	Primary Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 

----Alter Table CFDI_ComplementoDePagos Add Constraint FK_CFDI_ComplementoDePagos__FACT_CFD_Sucursales_Series  
...
Alter Table CFDI_ComplementoDePagos Add Constraint FK_CFDI_ComplementoDePagos__CFDI_TiposDeDocumentos 
...
Create Table CFDI_ComplementoDePagos_Detalles  
( 
	IdEmpresa varchar(3) Not Null, 
	IdEstado varchar(2) Not Null, 
	IdFarmacia varchar(4) Not Null, 
...
Alter Table CFDI_ComplementoDePagos_Detalles Add Constraint PK_CFDI_ComplementoDePagos_Detalles 
	Primary Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 
	
Alter Table CFDI_ComplementoDePagos_Detalles Add Constraint FK_CFDI_ComplementoDePagos_Detalles___CFDI_ComplementoDePagos 
	Foreign Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
	References CFDI_ComplementoDePagos ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 	
...
Create Table CFDI_ComplementoDePagos_DoctosRelacionados   
( 
	IdEmpresa varchar(3) Not Null, 
	IdEstado varchar(2) Not Null, 
	IdFarmacia varchar(4) Not Null, 
...
Alter Table CFDI_ComplementoDePagos_DoctosRelacionados Add Constraint PK_CFDI_ComplementoDePagos_DoctosRelacionados 
	Primary Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 
	
Alter Table CFDI_ComplementoDePagos_DoctosRelacionados Add Constraint FK_CFDI_ComplementoDePagos_DoctosRelacionados___CFDI_ComplementoDePagos 
	Foreign Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
	References CFDI_ComplementoDePagos ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 	
