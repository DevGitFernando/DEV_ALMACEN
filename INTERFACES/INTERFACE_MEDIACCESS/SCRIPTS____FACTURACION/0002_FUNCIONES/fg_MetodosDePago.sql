...
----------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From sysobjects (NoLock) Where Name = 'fg_MetodosDePago' and xType = 'FN' ) 
   Drop Function dbo.fg_MetodosDePago
Go--#SQL    	

---		select dbo.fg_MetodosDePago( '002', '09', '0001', 'MAT', 4, 3 )

Create Function fg_MetodosDePago 
( 
...
Declare 
	...
	Cursor For 
		Select top 1 S.IdMetodoDePago, M.Descripcion as MetodoDePagoDescripcion, S.Referencia 
		From CFDI_Documentos_MetodosDePago S (NoLock)  
