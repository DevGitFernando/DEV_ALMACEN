------------------------------------------------------------------------------------------------------------------------------------------------------ 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_CFDI_ComplementoPagos_ObtenerDatos' and xType = 'P' ) 
   Drop Proc spp_CFDI_ComplementoPagos_ObtenerDatos 
Go--#SQL  

--Exec  spp_CFDI_ComplementoPagos_ObtenerDatos  @Identificador = 9477 

Create Proc spp_CFDI_ComplementoPagos_ObtenerDatos  
(
...
---		spp_FACT_CFDI_ComplementoPagos_ObtenerDatos	
	...
	From CFDI_ComplementoDePagos_Detalles (NoLock) 
	Where IdEmpresa = @IdEmpresa And IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and Serie = @Serie and Folio = @Folio  
