If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_MA__FACT_GetInformacion_FacturarVenta___TEST' and xType = 'P' ) 
   Drop Proc spp_INT_MA__FACT_GetInformacion_FacturarVenta___TEST
Go--#SQL 

/* 
Begin tran 

	Exec spp_INT_MA__FACT_GetInformacion_FacturarVenta___TEST

rollback tran 

*/ 

Create Proc spp_INT_MA__FACT_GetInformacion_FacturarVenta___TEST 
(
...
--		spp_INT_MA__FACT_GetInformacion_FacturarVenta___TEST 
