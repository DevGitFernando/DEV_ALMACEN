If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_MA__PRCS__CalcularPorcentajes____TEST' and xType = 'P' ) 
   Drop Proc spp_INT_MA__PRCS__CalcularPorcentajes____TEST
Go--#SQL 

Create Proc spp_INT_MA__PRCS__CalcularPorcentajes____TEST 
With Encryption 
As 
Begin 
Set NoCount On 
