---------------------------------------------------------------------------------------------------------------------------	
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_CFDI_GetListaComprobantes_VP' and xType = 'P' ) 
   Drop Proc spp_CFDI_GetListaComprobantes_VP  
Go--#SQL  

--		sp_listacolumnas__Stores spp_CFDI_GetListaComprobantes_VP , 1  

--		Exec spp_CFDI_GetListaComprobantes_VP '00000001', 2014, 2, 0, '59'  


Create Proc spp_CFDI_GetListaComprobantes_VP 
(
...
Set DateFormat YMD	
	...
	Left Join CFDI_XML_VP X (NoLock) 
