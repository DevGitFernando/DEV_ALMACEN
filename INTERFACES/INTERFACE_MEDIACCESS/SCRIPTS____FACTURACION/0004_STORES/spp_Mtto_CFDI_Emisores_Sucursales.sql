---------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select Name From sysobjects (NoLock) Where Name = 'spp_Mtto_CFDI_Emisores_Sucursales' and xType = 'P' ) 
   Drop Proc spp_Mtto_CFDI_Emisores_Sucursales 
Go--#SQL 

Create Proc spp_Mtto_CFDI_Emisores_Sucursales 
( 
...
Declare 
	...
	If @Status = 'A' 
	Begin 
		If Not Exists ( Select * From CFDI_Emisores_Sucursales (NoLock) 
						Where IdEmpresa = @IdEmpresa and IdEstado = @IdEstado and IdFarmacia = @IdFarmacia ) 
			Begin 
				Insert Into CFDI_Emisores_Sucursales 
				( 
					IdEmpresa, IdEstado, IdFarmacia, NombreFiscal, NombreComercial, RFC, EsPersonaFisica, PublicoGeneral_AplicaIva, 
...
--		sp_listacolumnas__Stores spp_Mtto_CFDI_Emisores_Sucursales , 1 
