...
Declare -- @Tabla varchar(50), 
	...
	@QueryFinalAux varchar (8000), 		
	@Query varchar(8000),
	@Campo varchar(2000), 
	@CampoAux varchar(2000), 	
	@ListaCampos varchar(8000), 	
	@ListaCamposInserts varchar(8000), 		
	@Tipo tinyint, 
	@Padre varchar(80), 
	@Tiene_Pk bit, 
	@Parte_Exists varchar(8000), 
	@bParamVal int, @sMsj varchar(8000), 
	@iCampos int  
