---------------------------------------------------------------------------------------------------------------------------------- 
---------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select Name From SysObjects(NoLock) Where Name = 'spp_INT_MA__FACT_GetInformacion_ExportarTXT_Factura___TEST' and xType = 'P' )
    Drop Proc spp_INT_MA__FACT_GetInformacion_ExportarTXT_Factura___TEST
Go--#SQL 

--	Exec spp_FACT_CFD_GetRemision  @IdEmpresa = '002', @IdEstado = '09', @IdFarmaciaGenera = '0001', @FolioRemision = '0000000001', @Detallado = '1'  
--- Exec spp_INT_MA__FACT_GetInformacion_ExportarTXT_Factura___TEST  @IdEmpresa = '002', @IdEstado = '09', @IdFarmaciaGenera = '0001', @FolioRemision = '0000000001', @Detallado = '1' 
  
--		sp_listacolumnas__Stores spp_INT_MA__FACT_GetInformacion_ExportarTXT_Factura___TEST,  1   
  
Create Proc spp_INT_MA__FACT_GetInformacion_ExportarTXT_Factura___TEST 
( 
	@IdEmpresa varchar(3) = '002', @IdEstado varchar(2) = '09', 
	@IdFarmaciaGenera varchar(4) = '0001',  @FolioFactura varchar(10) = '1711' 
) 
With Encryption		
As 
Begin 
...
--	spp_INT_MA__FACT_GetInformacion_ExportarTXT_Factura___TEST  	
...
--	Select top 10 NumeroReceta =  ltrim(rtrim(left(NumeroReceta, len(NumeroReceta) - (len(NumeroReceta)-CHARINDEX('-', NumeroReceta)+1)))), * 
