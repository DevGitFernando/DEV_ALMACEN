------------------------------------------------------------------------------------------------
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_Mtto_CFDI_XML_VP' and xType = 'P' ) 
	Drop Proc spp_Mtto_CFDI_XML_VP    
Go--#SQL  

Create Proc spp_Mtto_CFDI_XML_VP 
(	
