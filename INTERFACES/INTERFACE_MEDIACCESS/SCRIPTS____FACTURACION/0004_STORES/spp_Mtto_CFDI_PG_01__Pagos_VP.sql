...
-----------------------------------------------------------------------------------------------------------------------------
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_Mtto_CFDI_PG_02__Pagos_Detalles_VP' and xType = 'P' )
   Drop Proc spp_Mtto_CFDI_PG_02__Pagos_Detalles_VP
Go--#SQL 

Create Proc spp_Mtto_CFDI_PG_02__Pagos_Detalles_VP
( 
	@IdEmpresa varchar(3) = '001', @IdEstado varchar(2) = '21', @IdFarmacia varchar(4) = '0001', 
	@Serie varchar(10) = '', @Folio int = 0, 
...
--		sp_listacolumnas FACT_CFDI_ComplementoDePagos_Detalles 
	...
	If Not Exists ( Select * From CFDI_ComplementoDePagos_Detalles_VP (NoLock) 
					Where IdEmpresa = @IdEmpresa and IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and Serie = @Serie and Folio = @Folio ) 
	Begin 
		Insert Into CFDI_ComplementoDePagos_Detalles_VP
		( 
...
-----------------------------------------------------------------------------------------------------------------------------
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_Mtto_CFDI_PG_03__Pagos_DoctosRelacionados_VP' and xType = 'P' )
   Drop Proc spp_Mtto_CFDI_PG_03__Pagos_DoctosRelacionados_VP
Go--#SQL 

Create Proc spp_Mtto_CFDI_PG_03__Pagos_DoctosRelacionados_VP
( 
	@IdEmpresa varchar(3) = '001', @IdEstado varchar(2) = '21', @IdFarmacia varchar(4) = '0001',   
	@Serie varchar(10) = '', @Folio int = 0, 
...
--		sp_listacolumnas FACT_CFDI_ComplementoDePagos_DoctosRelacionados 
	...
	If Not Exists ( Select * From CFDI_ComplementoDePagos_DoctosRelacionados_VP (NoLock) 
					Where IdEmpresa = @IdEmpresa and IdEstado = @IdEstado and IdFarmacia = @IdFarmacia 
						  and Serie = @Serie and Folio = @Folio and Serie_Relacionada = @Serie_Relacionada and Folio_Relacionado = @Folio_Relacionado ) 
	Begin 
		Insert Into CFDI_ComplementoDePagos_DoctosRelacionados_VP
		( 
