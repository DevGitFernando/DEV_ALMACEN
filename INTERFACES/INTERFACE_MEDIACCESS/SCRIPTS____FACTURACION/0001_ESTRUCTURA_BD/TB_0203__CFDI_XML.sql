...
Alter Table CFDI_XML Add Constraint PK_CFDI_XML Primary Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 

Alter Table CFDI_XML Add Constraint FK_CFDI_XML___CFDI_Documentos 
