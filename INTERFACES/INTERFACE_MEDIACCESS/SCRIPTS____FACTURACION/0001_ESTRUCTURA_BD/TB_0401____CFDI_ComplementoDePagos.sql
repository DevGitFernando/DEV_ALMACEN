...
Alter Table CFDI_ComplementoDePagos_Detalles Add Constraint FK_CFDI_ComplementoDePagos_Detalles___CFDI_Documentos
...
Alter Table CFDI_ComplementoDePagos_DoctosRelacionados Add Constraint FK_CFDI_ComplementoDePagos_DoctosRelacionados___CFDI_Documentos
	Foreign Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
	References CFDI_Documentos ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 	
