...
---------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'CFDI_BancosCuentas__Emisor' and xType = 'U' )  
	Drop Table CFDI_BancosCuentas__Emisor  
Go--#SQL 

Create Table CFDI_BancosCuentas__Emisor  
( 
	IdEmpresa varchar(3) Not Null, 
	IdEstado varchar(2) Not Null, 
	IdFarmacia varchar(4) Not Null, 
...
Alter Table CFDI_BancosCuentas__Emisor Add Constraint PK_CFDI_BancosCuentas__Emisor 
...
Alter Table CFDI_BancosCuentas__Emisor Add Constraint FK_CFDI_BancosCuentas__Emisor____CFDI__Bancos  
	Foreign Key ( RFC_Banco ) References CFDI__Bancos ( RFC )  
Go--#SQL 
...
If Not Exists ( Select * From CFDI_BancosCuentas__Emisor Where IdEmpresa = '001' and IdEstado = '13' and IdFarmacia = '0001' and RFC_Emisor = 'SSH9611185F9' and RFC_Banco = 'RFC_x_014' and NumeroDeCuenta = 'SANTANDER-1357' )  Insert Into CFDI_BancosCuentas__Emisor (  IdEmpresa, IdEstado, IdFarmacia, RFC_Emisor, RFC_Banco, NumeroDeCuenta, Status )  Values ( '001', '13', '0001', 'SSH9611185F9', 'RFC_x_014', 'SANTANDER-1357', 'A' ) 
 Else Update CFDI_BancosCuentas__Emisor Set Status = 'A' Where IdEmpresa = '001' and IdEstado = '13' and IdFarmacia = '0001' and RFC_Emisor = 'SSH9611185F9' and RFC_Banco = 'RFC_x_014' and NumeroDeCuenta = 'SANTANDER-1357'  
Go--#SQL 
