------------------------------------------------------------------------------------------------ 
------------------------------------------------------------------------------------------------ 
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'CFDI_ComplementoDePagos_DoctosRelacionados_VP' and xType = 'U' ) 
	Drop Table CFDI_ComplementoDePagos_DoctosRelacionados_VP  
Go--#SQL 

If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'CFDI_ComplementoDePagos_Detalles_VP' and xType = 'U' ) 
	Drop Table CFDI_ComplementoDePagos_Detalles_VP
Go--#SQL 
...
Create Table CFDI_ComplementoDePagos_Detalles_VP
( 
	IdEmpresa varchar(3) Not Null, 
	IdEstado varchar(2) Not Null, 
	IdFarmacia varchar(4) Not Null, 
...
Alter Table CFDI_ComplementoDePagos_Detalles_VP Add Constraint PK_CFDI_ComplementoDePagos_Detalles_VP
	Primary Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 
	
Alter Table CFDI_ComplementoDePagos_Detalles_VP Add Constraint FK_CFDI_ComplementoDePagos_Detalles_VP___CFDI_Documentos_VP
	Foreign Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
	References CFDI_Documentos_VP ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 	
...
Create Table CFDI_ComplementoDePagos_DoctosRelacionados_VP
( 
	IdEmpresa varchar(3) Not Null, 
	IdEstado varchar(2) Not Null, 
	IdFarmacia varchar(4) Not Null, 
...
Alter Table CFDI_ComplementoDePagos_DoctosRelacionados_VP Add Constraint PK_CFDI_ComplementoDePagos_DoctosRelacionados_VP
	Primary Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio, Serie_Relacionada, Folio_Relacionado ) 
Go--#SQL 
	
Alter Table CFDI_ComplementoDePagos_DoctosRelacionados_VP Add Constraint FK_CFDI_ComplementoDePagos_DoctosRelacionados_VP___CFDI_Documentos_VP
	Foreign Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
	References CFDI_Documentos_VP ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 	
