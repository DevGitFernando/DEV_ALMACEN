...
Declare 
	...
	If Exists ( Select * From FP_Huellas (NoLock) Where ReferenciaHuella = @ReferenciaHuella and NumDedo = @Dedo ) 
	Begin 
	...
	Else 
	Begin 
		Insert Into FP_Huellas ( FechaRegistro, ReferenciaHuella, NumDedo, Huella, Status ) 
