If Exists ( Select * From Sysobjects (NoLock) Where Name  = 'spp_Get_Huellas_Personal' and xType = 'P' ) 
   Drop Proc spp_Get_Huellas_Personal 
Go--#SQL 

Create Proc spp_Get_Huellas_Personal ( @ReferenciaHuella varchar(100) = '00000001' ) 
As 
Begin 
--Set NoCount On 
