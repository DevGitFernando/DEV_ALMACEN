...
namespace SII_INT_EPharma
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Dll_INT_EPharma.Vales.ValesEnvio valeEnvios = null;
            //ValesRecepcionRegistrar valesReg = null;
            ...
            General.ArchivoIni = "SII INT EPharma";
            ...
            else
            {
                ...
                valeEnvios = new Dll_INT_EPharma.Vales.ValesEnvio(General.DatosConexion);


                if (valeEnvios.ObtenerInformacion())
                {
                    valeEnvios.EnviarInformacion();
                }
