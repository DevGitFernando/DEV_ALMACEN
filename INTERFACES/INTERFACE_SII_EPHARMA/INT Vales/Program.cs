...
namespace INT_Vales
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ValesEnvio.ValesEnvio valesEnvio = null;
            ...
            else 
            {
                ...
                valesEnvio = new ValesEnvio.ValesEnvio(General.DatosConexion);


                if (valesEnvio.ObtenerInformacion())
                {
                    valesEnvio.EnviarInformacion();
                }
