...
namespace Dll_INT_EPharma.Vales
{
    public class ValesEnvio 
    {
        wsEPharmaInformacionDeVales.wsEPharma_RecepcionVales wsRecepcion_cnn = new wsEPharmaInformacionDeVales.wsEPharma_RecepcionVales();
        ...
        {
            bool bRegresa = false;
            wsEPharmaInformacionDeVales.ResponseSolicitud respuesta = new wsEPharmaInformacionDeVales.ResponseSolicitud();
            wsEPharmaInformacionDeVales.ValesRecepcionRegistrarInformacion informacion = new wsEPharmaInformacionDeVales.ValesRecepcionRegistrarInformacion();
            List<wsEPharmaInformacionDeVales.ItemInsumo> insumos = new List<wsEPharmaInformacionDeVales.ItemInsumo>();
            wsEPharmaInformacionDeVales.ItemInsumo insumoItem = new wsEPharmaInformacionDeVales.ItemInsumo();
            int iRegistro = 0;
            ...
            try
            {
                ...
                if (Pedido.Leer())
                {
                    ...
                    informacion.Beneficiario = new wsEPharmaInformacionDeVales.ItemBeneficiario();
                    ...
                    informacion.Medico = new wsEPharmaInformacionDeVales.ItemMedico();
                    ...
                    while (detalles.Leer())
                    {
                        insumoItem = new wsEPharmaInformacionDeVales.ItemInsumo();
                    ...
                    informacion.Insumos = new wsEPharmaInformacionDeVales.ItemInsumo[iRegistro];
        ...
        private bool MarcarValeEnviado(wsEPharmaInformacionDeVales.ValesRecepcionRegistrarInformacion info)
        {
            bool bRegresa = false;
