...
namespace Dll_IRE_INTERMED
{
    ...
    public enum TipoProcesoReceta
    {
        ...
        DescargaRecetaIndividual = 101, 
        DescargaRecetasMasivo = 102, 
        EnviarInformacionSurtido = 103 
    }
    ...
    public static class GnDll_SII_RE_INTERMED
    {
        ...
        {
            if (!GnDll_SII_RE_INTERMED.bMostrarInterface)
            {
                if (GnDll_SII_RE_INTERMED.EsRespuestaWeb)
                {
        ...
        public static void ObtenerURL_Interface(string IdEmpresa, string IdEstado, string IdFarmacia, string ValidarURL)  
        {
            ...
            clsGrabarError Error = new clsGrabarError(General.DatosConexion, GnDll_SII_RE_INTERMED.DatosApp, "GnDll_SII_SIADISSEP");
            string sSql = "";
