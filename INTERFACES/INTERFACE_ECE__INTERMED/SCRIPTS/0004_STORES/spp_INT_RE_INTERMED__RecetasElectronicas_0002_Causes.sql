-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_INTERMED__RecetasElectronicas_0002_Causes' and xType = 'P' ) 
   Drop Proc spp_INT_RE_INTERMED__RecetasElectronicas_0002_Causes
Go--#SQL 

Create Proc spp_INT_RE_INTERMED__RecetasElectronicas_0002_Causes 
( 
	@IdEmpresa varchar(3) = '', 
	@IdEstado varchar(2) = '', 
...
Declare 
	...
	If Not Exists ( Select * From INT_RE_INTERMED__RecetasElectronicas_0002_Causes (NoLock) 
	...
	Begin 
		Insert Into INT_RE_INTERMED__RecetasElectronicas_0002_Causes 
		( 
