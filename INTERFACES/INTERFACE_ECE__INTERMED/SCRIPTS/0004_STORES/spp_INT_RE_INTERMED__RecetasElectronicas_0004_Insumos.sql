-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_INTERMED__RecetasElectronicas_0004_Insumos' and xType = 'P' ) 
   Drop Proc spp_INT_RE_INTERMED__RecetasElectronicas_0004_Insumos
Go--#SQL 

Create Proc spp_INT_RE_INTERMED__RecetasElectronicas_0004_Insumos 
( 
	@IdEmpresa varchar(3) = '', 
	@IdEstado varchar(2) = '', 
...
Declare 
	...
	If Not Exists ( Select * From INT_RE_INTERMED__RecetasElectronicas_0004_Insumos (NoLock) 
					Where IdEmpresa = @IdEmpresa and IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and  Folio = @sFolio and ClaveSSA = @ClaveSSA ) 
		Begin 
			Insert Into INT_RE_INTERMED__RecetasElectronicas_0004_Insumos 
			( 
	...
	Else
		Begin
			Update INT_RE_INTERMED__RecetasElectronicas_0004_Insumos Set CantidadEntregada = @CantidadEntregada
			Where IdEmpresa = @IdEmpresa and IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and  Folio = @sFolio and ClaveSSA = @ClaveSSA
		End 
