-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_INTERMED__RecetasElectronicas_0001_General' and xType = 'P' ) 
   Drop Proc spp_INT_RE_INTERMED__RecetasElectronicas_0001_General
Go--#SQL 

Create Proc spp_INT_RE_INTERMED__RecetasElectronicas_0001_General 
( 
	@IdEmpresa varchar(3) = '', 
	@IdEstado varchar(2) = '', 
...
Declare 
	...
	If Not Exists ( Select * From INT_RE_INTERMED__RecetasElectronicas_0001_General (NoLock) 
					Where IdEmpresa = @IdEmpresa and IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and Folio = @sFolio 
						) 
		Begin 
			Insert Into INT_RE_INTERMED__RecetasElectronicas_0001_General 
			( 
	...
	Else
		Begin
			Update INT_RE_INTERMED__RecetasElectronicas_0001_General Set FechaProcesado = getdate()
			Where IdEmpresa = @IdEmpresa and IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and Folio = @sFolio 
		End
