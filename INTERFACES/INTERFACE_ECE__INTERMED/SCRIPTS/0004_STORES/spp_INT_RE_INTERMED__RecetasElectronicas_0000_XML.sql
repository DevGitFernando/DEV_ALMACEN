-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_INTERMED__RecetasElectronicas_001_XML' and xType = 'P' ) 
   Drop Proc spp_INT_RE_INTERMED__RecetasElectronicas_001_XML
Go--#SQL 

Create Proc spp_INT_RE_INTERMED__RecetasElectronicas_001_XML 
( 
	@UMedica varchar(50) = '', 
...
----- Obtener los datos de la farmacia
	...
	If Not Exists ( Select * 
		...
		Begin 
			Insert Into INT_RE_INTERMED__RecetasElectronicas_XML 
			(
	...
	Else
		Begin
			Update INT_RE_INTERMED__RecetasElectronicas_XML Set FechaRegistro = getdate()
			Where IdEmpresa = @IdEmpresa and IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and Folio_SIADISSEP = @Folio_SIADISSEP And uMedica = @UMedica
		End
