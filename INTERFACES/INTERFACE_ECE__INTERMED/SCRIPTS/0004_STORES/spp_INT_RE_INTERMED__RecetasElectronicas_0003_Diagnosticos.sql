-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_INTERMED__RecetasElectronicas_0003_Diagnosticos' and xType = 'P' ) 
   Drop Proc spp_INT_RE_INTERMED__RecetasElectronicas_0003_Diagnosticos
Go--#SQL 

Create Proc spp_INT_RE_INTERMED__RecetasElectronicas_0003_Diagnosticos 
( 
	@IdEmpresa varchar(3) = '', 
	@IdEstado varchar(2) = '', 
...
Declare 
	...
	If Not Exists ( Select * From INT_RE_INTERMED__RecetasElectronicas_0003_Diagnosticos (NoLock) 
					Where IdEmpresa = @IdEmpresa and IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and Folio = @sFolio 
						and CIE10 = @CIE10 ) 
	Begin 
		Insert Into INT_RE_INTERMED__RecetasElectronicas_0003_Diagnosticos 
		( 
