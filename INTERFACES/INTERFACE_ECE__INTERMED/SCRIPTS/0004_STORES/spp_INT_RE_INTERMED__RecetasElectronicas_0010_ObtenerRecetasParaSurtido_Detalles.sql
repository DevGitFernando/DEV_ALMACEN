-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_INTERMED__RecetasElectronicas_0010_ObtenerRecetasParaSurtido_Detalles' and xType = 'P' ) 
   Drop Proc spp_INT_RE_INTERMED__RecetasElectronicas_0010_ObtenerRecetasParaSurtido_Detalles
Go--#SQL 

Create Proc spp_INT_RE_INTERMED__RecetasElectronicas_0010_ObtenerRecetasParaSurtido_Detalles 
( 
	...
	@FolioInterface varchar(20) = '000000000001', 
...
------------------------------------------------- OBTENER LA INFORMACION   
	...
	Into #tmp_01_General 
	From INT_RE_INTERMED__RecetasElectronicas_0001_General G (NoLock) 
	Left Join INT_RE_INTERMED__RecetasElectronicas_0003_Diagnosticos D (NoLock) 
	...
	Select 
		...
		I.ClaveSSA, I.CantidadRequerida, C.DescripcionClave, 	
		I.IdEmpresa, I.IdEstado, I.IdFarmacia, I.Folio, 0 as Relacioando 
	Into #tmp_02_Medicamentos 
	From INT_RE_INTERMED__RecetasElectronicas_0004_Insumos I (NoLock) 	
...
---		spp_INT_RE_INTERMED__RecetasElectronicas_0010_ObtenerRecetasParaSurtido_Detalles 			
	...
	If Not Exists ( 
		...
		Begin 
			...
			Exec spp_Mtto_CatBeneficiarios 
				...
				@IdBeneficiario = '*', @Nombre = @NombreB, @ApPaterno = @ApPatB, @ApMaterno = @ApMatB, @Sexo = @Sexo, 					
				@FechaNacimiento = @FechaNacimientoB, 
				@FolioReferencia = @NumReferencia, @CURP = @NumReferencia, 
...
---		select top 10 * from INT_RE_INTERMED__RecetasElectronicas_0004_Insumos 
