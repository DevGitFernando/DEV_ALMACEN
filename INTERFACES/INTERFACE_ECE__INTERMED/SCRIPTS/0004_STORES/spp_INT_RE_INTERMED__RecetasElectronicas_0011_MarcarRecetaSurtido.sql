-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_INTERMED__RecetasElectronicas_0011_MarcarRecetaSurtido' and xType = 'P' ) 
   Drop Proc spp_INT_RE_INTERMED__RecetasElectronicas_0011_MarcarRecetaSurtido
Go--#SQL 

Create Proc spp_INT_RE_INTERMED__RecetasElectronicas_0011_MarcarRecetaSurtido 
( 
...
------------------------------------------------- OBTENER LA INFORMACION   
	...
	From INT_RE_INTERMED__RecetasElectronicas_0004_Insumos X
