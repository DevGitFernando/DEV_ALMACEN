...
namespace ISIIECE_SERVICIOS
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] argsAux2 = { "iS" };
            GnDll_SII_RE_INTERMED.MostrarInterface = true;
            ...
            {
                GnDll_SII_RE_INTERMED.MostrarInterface = !(appArgumentos.GetValor("I") == "N");
            }

            if (appArgumentos.GetValor("D") != "")
            {
                bDetener = appArgumentos.GetValor("D") != "S"; 
            }


            if (GnDll_SII_RE_INTERMED.MostrarInterface)
            {
