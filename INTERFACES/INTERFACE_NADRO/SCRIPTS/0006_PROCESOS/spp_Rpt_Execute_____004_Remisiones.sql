...
---   5, 34, 188, 224, 313  
	...
	Where F.IdEstado = 7 and F.IdFarmacia >= 100    -- in ( 11  ) -- , 13, 14, 15, 18, 30, 32, 41 )  	-- and 1 = 0	
	...
	Insert Into #tmpPeriodos_X ( FechaInicial, FechaFinal ) Select '2015-07-01', '2015-07-05' 
	Insert Into #tmpPeriodos_X ( FechaInicial, FechaFinal ) Select '2015-07-06', '2015-07-10' 	
	Insert Into #tmpPeriodos_X ( FechaInicial, FechaFinal ) Select '2015-07-11', '2015-07-15' 
	Insert Into #tmpPeriodos_X ( FechaInicial, FechaFinal ) Select '2015-07-16', '2015-07-20' 	
	Insert Into #tmpPeriodos_X ( FechaInicial, FechaFinal ) Select '2015-07-21', '2015-07-25' 
	Insert Into #tmpPeriodos_X ( FechaInicial, FechaFinal ) Select '2015-07-26', '2015-07-31' 		
		...
		BEGIN 
			...
			FETCH NEXT FROM #cursor_002 Into @IdFarmacia, @CodigoCliente  
				...
				BEGIN 	
						...
						----------- Generar la tabla general NADRO  
						Exec spp_INT_ND_Unidad_GenerarRemisiones_PrepararInformacion @IdEmpresa, @IdEstado, @IdFarmacia, @CodigoCliente, @GUID 
		    

						-------------------------------------------------------------------------------------------------------------------------- 
						---		sp_help spp_INT_ND_Unidad_GenerarRemisiones_Detallado 


						Exec spp_INT_ND_Unidad_GenerarRemisiones_Detallado 
							@IdEmpresa, @IdEstado, @CodigoCliente, 
							@FechaInicial, @FechaFinal, 
							@GUID, @IdFarmacia, @Año_Causes, @SepararCauses   
