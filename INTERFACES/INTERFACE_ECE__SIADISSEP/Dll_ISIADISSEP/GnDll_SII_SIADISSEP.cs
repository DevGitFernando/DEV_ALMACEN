...
namespace Dll_ISIADISSEP
{
    ...
    public enum TipoProcesoReceta
    {
        ...
        SurtimientoColectivoMedicamentos = 5 
        //SURTIMIENTOCOLECTIVOMEDICAMENTOS
    }
    ...
    public static class GnDll_SII_SIADISSEP
    {
        ...
        {
            if (!GnDll_SII_SIADISSEP.bMostrarInterface)
            {
                if (GnDll_SII_SIADISSEP.EsRespuestaWeb)
                {
        ...
        public static void ObtenerURL_Interface(string IdEmpresa, string IdEstado, string IdFarmacia, string ValidarURL)  
        {
            ...
            clsGrabarError Error = new clsGrabarError(General.DatosConexion, GnDll_SII_SIADISSEP.DatosApp, "GnDll_SII_SIADISSEP");
            string sSql = "";
