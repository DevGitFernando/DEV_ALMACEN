...
namespace Dll_ISIADISSEP.Informacion
{
    public class ColectivoElectronico
    {
        ...
        public ColectivoElectronico(clsDatosConexion DatosConexion)
        {
            ...
            Error = new clsGrabarError(datosDeConexion, GnDll_SII_SIADISSEP.DatosApp, "ColectivoElectronico");
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (Guardar_001_XML(respuesta))
                    {
                        ...
                        respuesta.AddItemRespuesta("idColectivo", sFolio_SIADISSEP); //sFolioReceta_SIADISSEP); 
        ...
        private bool Guardar_002_General(ResponseRecetaElectronica Respuesta)
        {
            ...
            while (datos.Leer())
            {
                sFolioReceta = string.Format("{0}-{1}", sFolio_SIADISSEP, datos.Campo("FolioPaciente"));
