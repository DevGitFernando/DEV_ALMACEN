-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_SIADISSEP__RecetasElectronicas_0006_ColectivosEnviarAcuse_Detalles' and xType = 'P' ) 
   Drop Proc spp_INT_SIADISSEP__RecetasElectronicas_0006_ColectivosEnviarAcuse_Detalles
Go--#SQL 

Create Proc spp_INT_SIADISSEP__RecetasElectronicas_0006_ColectivosEnviarAcuse_Detalles 
( 
	@IdEmpresa varchar(3) = '001', 
	@IdEstado varchar(2) = '21', 
	@IdFarmacia varchar(4) = '2406', 
	@FolioVenta varchar(20) = '00081577' 
) 
With Encryption 
As 
Begin 
...
------------------------------------------------- OBTENER LA INFORMACION   
	...
	Select 
		...
		cast('' as varchar(30)) as ClaveSSA, cast('' as varchar(7500)) As DescripcionSal, cast('' as varchar(30)) as IdClaveSSA, 
		L.IdProducto, L.CodigoEAN, L.ClaveLote, convert(varchar(10), I.FechaCaducidad, 120) as Caducidad, 
		0 as CantidadRecetada, cast(L.CantidadVendida as int) as CantidadSurtida, 0 as CantidadVale, 0 as Tipo, 0 as Eliminar, 0 as TipoDeInsumo    
	...
	Update M Set IdClaveSSA = P.IdClaveSSA_Sal, ClaveSSA = P.ClaveSSA, DescripcionSal = P.DescripcionSal
	...
	( 
		IdEmpresa, IdEstado, IdFarmacia, FolioVenta, ClaveSSA, IdClaveSSA, DescripcionSal, IdProducto, CodigoEAN, ClaveLote, Caducidad, 
	...
	Select @IdEmpresa, @IdEstado, @IdFarmacia, @FolioVenta as FolioVenta, 
		cast(I.ClaveSSA as varchar(30)) as ClaveSSA, cast('' as varchar(30)) as IdClaveSSA, cast('' as varchar(7500)) As DescripcionSal, 
		'' as IdProducto, '' as CodigoEAN, '' as ClaveLote, cast('' as varchar(20)) as Caducidad, 
