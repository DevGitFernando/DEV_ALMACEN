-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_SIADISSEP__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse' and xType = 'P' ) 
   Drop Proc spp_INT_SIADISSEP__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse
Go--#SQL 

Create Proc spp_INT_SIADISSEP__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse 
( 
...
---		spp_INT_SIADISSEP__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse 	
