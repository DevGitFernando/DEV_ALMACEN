-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_SIADISSEP__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse_Detalles' and xType = 'P' ) 
   Drop Proc spp_INT_SIADISSEP__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse_Detalles
Go--#SQL 

Create Proc spp_INT_SIADISSEP__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse_Detalles 
( 
	@IdEmpresa varchar(3) = '001', 
	@IdEstado varchar(2) = '21', 
	@IdFarmacia varchar(4) = '2406', 
	@FolioInterface varchar(30) = '000000000010'  
) 
With Encryption 
As 
Begin 
...
---		spp_INT_SIADISSEP__RecetasElectronicas_0007_ObtenerCancelacionRecetasEnviarAcuse_Detalles 	
