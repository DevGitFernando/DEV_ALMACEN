-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_SIADISSEP__RecetasElectronicas_0000_XML__Log' and xType = 'P' ) 
   Drop Proc spp_INT_SIADISSEP__RecetasElectronicas_0000_XML__Log
Go--#SQL 

Create Proc spp_INT_SIADISSEP__RecetasElectronicas_0000_XML__Log 
( 
	@UMedica varchar(50) = '', 
...
----- Obtener los datos de la farmacia 	
	...
	From INT_SIADISSEP__RecetasElectronicas_XML__Log (NoLock) 
	...
	Begin 
		Insert Into INT_SIADISSEP__RecetasElectronicas_XML__Log 
		(
