...
--------------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'INT_SIADISSEP__RecetasElectronicas_XML' and xType = 'U' ) 
   Drop Table INT_SIADISSEP__RecetasElectronicas_XML  
Go--#SQL   

Create Table INT_SIADISSEP__RecetasElectronicas_XML 
( 
...
Alter Table INT_SIADISSEP__RecetasElectronicas_XML 
	Add Constraint PK_INT_SIADISSEP__RecetasElectronicas_XML Primary Key ( IdEmpresa, IdEstado, IdFarmacia, Folio ) 
Go--#SQL   
