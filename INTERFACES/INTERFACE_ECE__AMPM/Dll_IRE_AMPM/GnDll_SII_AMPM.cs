...
namespace Dll_IRE_AMPM
{
    ...
    public static class GnDll_SII_AMPM
    {
        #region Declaracion de Variables        
        private static clsDatosApp dpDatosApp = new clsDatosApp("Dll_IRE_AMPM", "");
        private static basGenerales Fg = new basGenerales(); 

        private static string sReferencia_SIADISSEP = ""; 
        private static string sURL_Interface = ""; //@"http://localhost:21734/wsSII_INT_IAMPM/wsISIADISSEP.asmx";
        ...
        #region Propiedades 
        public static string Referencia_SIADISSEP
        {
            get { return sReferencia_SIADISSEP; }
            set { sReferencia_SIADISSEP = value; }
        }
        ...
        {
            if (!GnDll_SII_AMPM.bMostrarInterface)
            {
                if (GnDll_SII_AMPM.EsRespuestaWeb)
                {
        ...
        public static void ObtenerURL_Interface(string IdEmpresa, string IdEstado, string IdFarmacia, string ValidarURL)  
        {
            ...
            clsGrabarError Error = new clsGrabarError(General.DatosConexion, GnDll_SII_AMPM.DatosApp, "GnDll_SII_SIADISSEP");
            string sSql = "";
            ...
            else
            {
                if ( leer.Leer())
                {
                    ...
                    sReferencia_SIADISSEP = leer.Campo("Referencia_SIADISSEP"); 
                }
            }
