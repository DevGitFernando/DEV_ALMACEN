-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_AMPM__RecetasElectronicas_0005_ObtenerRecetasParaSurtido' and xType = 'P' ) 
   Drop Proc spp_INT_RE_AMPM__RecetasElectronicas_0005_ObtenerRecetasParaSurtido
Go--#SQL 

Create Proc spp_INT_RE_AMPM__RecetasElectronicas_0005_ObtenerRecetasParaSurtido 
( 
