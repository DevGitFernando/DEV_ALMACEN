...
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'INT_AMPM__RecetasElectronicas_0005_CancelacionRecetas' and xType = 'U' ) 
   Drop Table INT_AMPM__RecetasElectronicas_0005_CancelacionRecetas 
Go--#SQL   
...
--------------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'INT_AMPM__RecetasElectronicas_XML' and xType = 'U' ) 
   Drop Table INT_AMPM__RecetasElectronicas_XML  
Go--#SQL   

Create Table INT_AMPM__RecetasElectronicas_XML 
( 
	...
	Folio_AMPM varchar(50) Not Null Default '', 
	...
	InformacionXML_Base xml Not Null Default '',  
	InformacionXML xml Not Null Default '' 

) 
Go--#SQL   

Alter Table INT_AMPM__RecetasElectronicas_XML 
	Add Constraint PK_INT_AMPM__RecetasElectronicas_XML Primary Key ( IdEmpresa, IdEstado, IdFarmacia, Folio ) 
Go--#SQL   
