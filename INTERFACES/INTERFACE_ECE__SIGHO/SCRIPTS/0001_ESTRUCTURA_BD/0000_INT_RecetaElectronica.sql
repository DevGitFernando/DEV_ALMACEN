...
If Not Exists ( Select * From INT_RecetaElectronica_Interfaces Where Interface = 900 )  Insert Into INT_RecetaElectronica_Interfaces (  Interface, NombreInterface, Status )  Values ( 2, 'SIGHO', 'A' ) 
