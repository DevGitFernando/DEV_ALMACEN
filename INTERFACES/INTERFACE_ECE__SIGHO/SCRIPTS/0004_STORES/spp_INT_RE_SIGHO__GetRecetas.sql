-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_SIGHO__GetRecetas' and xType = 'P' ) 
   Drop Proc spp_INT_RE_SIGHO__GetRecetas
Go--#SQL 

Create Proc spp_INT_RE_SIGHO__GetRecetas
( 
