-------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_INT_RE_SIGHO__RecetasElectronicas_0010_ObtenerRecetasParaSurtido_Detalles' and xType = 'P' ) 
   Drop Proc spp_INT_RE_SIGHO__RecetasElectronicas_0010_ObtenerRecetasParaSurtido_Detalles
Go--#SQL 

Create Proc spp_INT_RE_SIGHO__RecetasElectronicas_0010_ObtenerRecetasParaSurtido_Detalles 
( 
	@IdEmpresa varchar(3) = '001', 
	@IdEstado varchar(2) = '13', 
	@IdFarmacia varchar(4) = '12', 
	@IdCliente varchar(4) = '0002', 
	@IdSubCliente varchar(4) = '0010',
...
------------------------------------------------- OBTENER LA INFORMACION   
	...
	Into #tmp_01_General 
	From INT_RE_SIGHO__RecetasElectronicas_0001_General G (NoLock) 
	...
	From INT_RE_SIGHO__RecetasElectronicas_0004_Insumos I (NoLock) 	
