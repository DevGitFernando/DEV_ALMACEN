If Exists ( Select Name From Sysobjects Where Name = 'spp_CFG_MigrarDatos_Generar_Script' and xType = 'P' )
	Drop Proc spp_CFG_MigrarDatos_Generar_Script
Go--#SQL

Create Proc spp_CFG_MigrarDatos_Generar_Script 
(
    @BaseDeDatosOrigen varchar(100) = 'SII_ElDiez', 
	@BaseDeDatosDestino varchar(100) = 'SII_RegionalSinaloa'
)
-- with Encryption 
As
Begin 
...
-- print 'Begin tran' 
    ...
    Set @sSql = ' Insert Into ##CFGC_EnvioDetalles ' + 
        ...
        'From ' + @BaseDeDatosDestino + '..CFGC_EnvioDetalles (Nolock) ' + 
...
(
    @BaseDeDatosOrigen varchar(100) = 'SII_ElDiez', 
    @BaseDeDatosDestino varchar(100) = 'SII_RegionalSinaloa', 
    @Tabla varchar(50) = 'Net_CFGC_Parametros', @SalidaFinal varchar(8000) = '' output   
)
with Encryption 
As
Begin
