If Exists ( Select Name From Sysobjects Where Name = 'spp_INF_SEND_UPD_Detalles' and xType = 'P' )
	Drop Proc spp_INF_SEND_UPD_Detalles
Go--#SQL 

Create Proc spp_INF_SEND_UPD_Detalles 
(
...
--- No se habilita la replicacion de diferencias 
	Set @Campo_Diferencia = '' 	
...
----	Exec(@QueryFinal)
------  spp_INF_SEND_UPD_Detalles 'CatEstados'
