If Exists ( Select Name From Sysobjects Where Name = 'spp_INF_SEND__OC' and xType = 'P' )
	Drop Proc spp_INF_SEND__OC 
Go--#SQL 

---  Exec spp_INF_SEND__OC 'SII_PtoVta_EnBlanco', '[CENTRAL].[SII_OficinaCentral]', 'SII_PtoVta_EnBlanco'

-- Exec spp_INF_SEND__OC 'SII_OficinaCentral', '[SVRPUEBLA].[SII_RegionalPuebla]', 'SII_OficinaCentral', 'CFGSC_EnvioCatalogos', 1, 1 

-- Exec spp_INF_SEND__OC 'SII_OficinaCentral', '[SVROAXACA].[SII_Oaxaca]', 'SII_OficinaCentral', 'CFGSC_EnvioCatalogos', 1, 1 


Create Proc spp_INF_SEND__OC 
(
...
----print 'Begin tran' 
	...
	Insert Into #CFGC_EnvioDetalles Select 'OrdenesDeComprasEnc', 0, 1, 1 
	Insert Into #CFGC_EnvioDetalles Select 'OrdenesDeComprasDet', 0, 1, 1 
	Insert Into #CFGC_EnvioDetalles Select 'OrdenesDeComprasDet_Lotes', 0, 1, 1 
	Insert Into #CFGC_EnvioDetalles Select 'OrdenesDeComprasDet_Lotes_Ubicaciones', 0, 1, 1 			
