If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'vw_Impresion_Recepcion_Orden_Compra' and xType = 'V' ) 
	Drop View vw_Impresion_Recepcion_Orden_Compra 
Go--#SQL 	

Create View vw_Impresion_Recepcion_Orden_Compra 
With Encryption 
As 

	Select -- L.*, vP.*  
		   E.IdEmpresa, E.Empresa, E.IdEstado, E.Estado, E.ClaveRenapo, E.IdFarmacia, E.Farmacia, 
		   L.IdSubFarmacia, S.SubFarmacia, E.Folio,  E.FolioOrdenCompraReferencia,
		   ...
		   E.SubTotal, E.Iva, E.Total, E.ImporteFactura, 
		   E.Status, -- E.Keyx as KeyEncabezado, 
		   ...
		   F.FechaCaducidad, E.FechaRegistro  
	From vw_OrdenesDeComprasEnc E (NoLock) 
	Inner Join OrdenesDeComprasDet D (NoLock) On ( E.IdEmpresa = D.IdEmpresa and E.IdEstado = D.IdEstado and E.IdFarmacia = D.IdFarmacia and E.Folio = D.FolioOrdenCompra ) 
