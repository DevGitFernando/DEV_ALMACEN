...
As
	Select M.IdEmpresa, Ex.Nombre as Empresa,		    
		 ...
		 M.Observaciones, M.Status, M.EsAutomatica, M.FolioPedido As FolioPedidoUnidad, M.EsCentral, M.EsContado, 
		 M.IdCliente, CC.NombreCliente, M.IdSubCliente, CC.NombreSubCliente 
...
As 
	...
	Select M.IdEmpresa, M.Empresa, M.IdEstado, M.Estado, M.IdFarmacia, M.Farmacia, M.Folio,
		...
		D.Cantidad as CantidadCajas, (D.Cantidad * P.ContenidoPaquete) as Cantidad, D.Precio, 
		-- cast((D.PrecioUnitario / (P.ContenidoPaquete * 1.0)) as numeric(14,4)) as Precio, 		
		D.Descuento, D.TasaIva, D.Iva,
--		D.PrecioUnitario as PrecioCaja, 
		(D.Precio - ( D.Precio * (D.Descuento/100.00))) as PrecioCaja,
		cast((D.Precio / (P.ContenidoPaquete * 1.0)) as numeric(14,4)) as PrecioUnitario, 
		D.ImpteIva, 
--		D.Importe, 
		(D.Cantidad * (D.Precio - ( D.Precio * (D.Descuento/100.00)))) as Importe, D.CantidadSobreCompra, D.ObservacionesSobreCompra, M.Status,
