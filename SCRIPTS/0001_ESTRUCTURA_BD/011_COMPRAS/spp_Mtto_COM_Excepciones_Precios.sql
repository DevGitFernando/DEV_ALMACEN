...
( 
	...
	@IdPersonal varchar(4), @IdProveedor varchar(4), @GUID varchar(100), @CodigoEAN varchar(30)
)
With Encryption 
As
Begin
...
--		Select * From COM_Excepciones_Precios (Nolock)
		...
		' From Com_Pedidos_Compras (Nolock) Where GUID = ' + Char(39) + @GUID + Char(39) + ' And IdProveedor = ' + Char(39) + @IdProveedor + Char(39) +
