If Exists ( Select Name From Sysobjects Where Name = 'spp_INF_SEND_Detalles' and xType = 'P' )
...
---- Implementar Esquema 
    ...
    If @Update = 1 
        Begin 
            If @Tiene_Pk = 1 
            Begin 
            Set @Parte_Update = '-------------------------- Parte Update ' + char(10) + 
	            ...
	            + 'Where ' + @Alias_Origen + 'Actualizado = 0 ' + char(13) --- + char(10)  
