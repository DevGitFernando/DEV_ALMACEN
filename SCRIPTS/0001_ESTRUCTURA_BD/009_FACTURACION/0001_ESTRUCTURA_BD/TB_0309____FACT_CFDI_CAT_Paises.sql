...
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'FACT_CFDI_Paises_01_Estados' and xType = 'U' ) 
   Drop Table FACT_CFDI_Paises_01_Estados 
Go--#SQL 
...
Create Table FACT_CFDI_Paises_01_Estados 
( 
...
Alter Table FACT_CFDI_Paises_01_Estados Add Primary Key ( ClavePais, Clave )
Go--#SQL 

Alter Table FACT_CFDI_Paises_01_Estados Add Constraint FK_FACT_CFDI_Paises_01_Estados___FACT_CFDI_Paises
...
Alter Table FACT_CFDI_Paises_02_CodigosPostales Add Constraint FK_FACT_CFDI_Paises_02_CodigosPostales___FACT_CFDI_Paises_01_Estados
	Foreign Key ( ClavePais, ClaveEstado ) References FACT_CFDI_Paises_01_Estados ( ClavePais, Clave ) 
Go--#SQL  
...
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'AGU' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'AGU', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'AGU'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'BCN' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'BCN', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'BCN'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'BCS' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'BCS', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'BCS'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'CAM' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'CAM', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'CAM'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'CHH' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'CHH', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'CHH'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'CHP' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'CHP', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'CHP'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'COA' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'COA', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'COA'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'COL' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'COL', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'COL'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'DIF' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'DIF', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'DIF'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'DUR' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'DUR', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'DUR'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'GRO' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'GRO', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'GRO'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'GUA' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'GUA', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'GUA'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'HID' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'HID', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'HID'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'JAL' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'JAL', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'JAL'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'MEX' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'MEX', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'MEX'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'MIC' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'MIC', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'MIC'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'MOR' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'MOR', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'MOR'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'NAY' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'NAY', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'NAY'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'NLE' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'NLE', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'NLE'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'OAX' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'OAX', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'OAX'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'PUE' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'PUE', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'PUE'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'QUE' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'QUE', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'QUE'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'ROO' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'ROO', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'ROO'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'SIN' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'SIN', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'SIN'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'SLP' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'SLP', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'SLP'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'SON' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'SON', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'SON'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'TAB' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'TAB', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'TAB'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'TAM' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'TAM', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'TAM'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'TLA' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'TLA', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'TLA'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'VER' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'VER', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'VER'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'YUC' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'YUC', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'YUC'  
If Not Exists ( Select * From FACT_CFDI_Paises_01_Estados Where ClavePais = 'MEX' and Clave = 'ZAC' )  Insert Into FACT_CFDI_Paises_01_Estados (  ClavePais, Clave, Descripcion, Status )  Values ( 'MEX', 'ZAC', 'A', 'A' ) 
 Else Update FACT_CFDI_Paises_01_Estados Set Descripcion = 'A', Status = 'A' Where ClavePais = 'MEX' and Clave = 'ZAC'  
