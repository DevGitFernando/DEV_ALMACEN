...
(
     ...
     IdCFDI varchar(100) Not Null, 
     TieneXML bit Not Null,
     TienePDF bit Not Null,
     ...
     TieneTimbre bit Not Null,
     FormatoBase varchar(1) Not Null,
     ...
     TipoInsumo smallint Not Null,
     IdRubroFinanciamiento varchar(4) Not Null,
     IdFuenteFinanciamiento varchar(4) Not Null,           
     IdFormaDePago varchar(2) Not Null, 
     NumeroCuentaPredial varchar(500) Not Null, 
     XMLFormaPago varchar(500) Not Null, 
     XMLCondicionesPago varchar(500) Not Null, 
     XMLMetodoPago varchar(500) Not Null, 
