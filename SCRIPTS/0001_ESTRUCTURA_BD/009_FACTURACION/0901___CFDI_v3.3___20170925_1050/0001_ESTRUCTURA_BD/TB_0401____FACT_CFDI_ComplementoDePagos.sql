...
Alter Table FACT_CFDI_ComplementoDePagos_Detalles Add Constraint FK_FACT_CFDI_ComplementoDePagos_Detalles___FACT_CFDI_ComplementoDePagos 
	Foreign Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
	References FACT_CFDI_ComplementoDePagos ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 	
...
Alter Table FACT_CFDI_ComplementoDePagos_DoctosRelacionados Add Constraint FK_FACT_CFDI_ComplementoDePagos_DoctosRelacionados___FACT_CFDI_ComplementoDePagos 
	Foreign Key ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
	References FACT_CFDI_ComplementoDePagos ( IdEmpresa, IdEstado, IdFarmacia, Serie, Folio ) 
Go--#SQL 	
