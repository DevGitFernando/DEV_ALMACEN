--------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'sp_Proceso_FACT_RemisionesManuales__CargaMasiva_001_Integrar_Remisiones' and xType = 'P' ) 
   Drop Proc sp_Proceso_FACT_RemisionesManuales__CargaMasiva_001_Integrar_Remisiones 
Go--#SQL 

Create Proc sp_Proceso_FACT_RemisionesManuales__CargaMasiva_001_Integrar_Remisiones
(
...
Declare 
	...
	--Set @sGUID = '918C03F0-9FC6-452A-8533-FCAEF1547830' 
	--Set @iFolioRemision = 11137 

	Update C Set 
		IdEmpresa = right('00000000' + IdEmpresa, 3),  IdEstado = right('00000000' + IdEstado, 2),   
		IdCliente = right('00000000' + IdCliente, 4),  IdSubCliente = right('00000000' + IdSubCliente, 4),   
		IdFarmaciaGenera = right('00000000' + IdFarmaciaGenera, 4),  IdFarmacia = right('00000000' + IdFarmacia, 4),   
		IdBeneficiario = right('00000000' + IdBeneficiario, 8),  
		IdFuenteFinanciamiento = right('00000000' + IdFuenteFinanciamiento, 4),  IdFinanciamiento = right('00000000' + IdFinanciamiento, 4)  
	From FACT_Remisiones_Manuales__CargaMasiva C 
	...
	--		sp_Proceso_FACT_RemisionesManuales__CargaMasiva_001_Integrar_Remisiones 
	...
	*/ 
	...
	Select 
		...
		convert(varchar(10), getdate(), 120) as FechaRemision, 
		convert(varchar(10), getdate(), 120) as FechaValidacion, 
		
		--convert(varchar(10), cast('2019-11-27' as datetime), 120) as FechaRemision, 
		--convert(varchar(10), cast('2019-11-27' as datetime), 120) as FechaValidacion, 
