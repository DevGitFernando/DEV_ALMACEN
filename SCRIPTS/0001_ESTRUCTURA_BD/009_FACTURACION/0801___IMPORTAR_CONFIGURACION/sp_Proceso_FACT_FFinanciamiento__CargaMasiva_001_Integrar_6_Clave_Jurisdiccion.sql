...
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'sp_Proceso_FACT_FFinanciamiento__CargaMasiva_001_Integrar_6_Clave_Jurisdiccion' and xType = 'P' ) 
   Drop Proc sp_Proceso_FACT_FFinanciamiento__CargaMasiva_001_Integrar_6_Clave_Jurisdiccion 
Go--#SQL 

Create Proc sp_Proceso_FACT_FFinanciamiento__CargaMasiva_001_Integrar_6_Clave_Jurisdiccion
With Encryption 
As 
Begin 
Set NoCount On 
 Set Ansi_Warnings Off  --- Especial, peligroso 
	...
	From FACT_Fuentes_De_Financiamiento_Detalles_ClavesSSA__Beneficiario T
	...
	Insert Into FACT_Fuentes_De_Financiamiento_Detalles_ClavesSSA
		(IdFuenteFinanciamiento, IdFinanciamiento, ClaveSSA, PorcParticipacion,
	...
	--Carga en la tabla FACT_Fuentes_De_Financiamiento_Detalles_ClavesSSA__Farmacia
	...
	From FACT_Fuentes_De_Financiamiento__CargaMasiva F (NoLock)
	Where Not Exists
		(Select * From FACT_Fuentes_De_Financiamiento_Detalles_ClavesSSA__Farmacia C (NoLock)
		 Where
			F.IdFuenteFinanciamiento = C.IdFuenteFinanciamiento And F.IdFinanciamiento = C.IdFinanciamiento And 
			F.IdEstado = C.IdEstado And F.IdFarmacia = C.IdFarmacia And F.ClaveSSA = C.ClaveSSA And F.Referencia_05 = C.Referencia_05)
		--And ClaveSSA = '010.000.0101.00'
	Group By
		IdFuenteFinanciamiento, IdFinanciamiento, IdEstado, IdFarmacia, ClaveSSA, PorcParticipacion,
		Status, Actualizado, Referencia_01, Referencia_02, Referencia_03, Referencia_04, Referencia_05
	...
	Insert Into FACT_Fuentes_De_Financiamiento_Detalles_ClavesSSA__Beneficiario
	...
	Left Join FACT_Fuentes_De_Financiamiento_Detalles_ClavesSSA__Beneficiario T (NoLock)
		On (T.IdFuenteFinanciamiento = F.IdFuenteFinanciamiento And T.IdFinanciamiento = F.IdFinanciamiento 
			And T.IdEstado = F.IdEstado And T.IdFarmacia = F.IdFarmacia And T.IdCliente  = F.IdCliente And T.IdSubCliente = F.IdSubCliente
			And T.IdBeneficiario = F.IdBeneficiario And T.Referencia_01 = F.Referencia_01 And T.ClaveSSA = F.ClaveSSA  And T.Referencia_05 = F.Referencia_05)
