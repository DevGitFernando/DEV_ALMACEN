---------------------------------------------------------------------------------------------------------------------------------- 
---------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From SysObjects(NoLock) Where Name = 'spp_FACT_CFD_GetRemisionesManuales_Descarga' and xType = 'P' )
    Drop Proc spp_FACT_CFD_GetRemisionesManuales_Descarga
Go--#SQL 
  
Create Proc spp_FACT_CFD_GetRemisionesManuales_Descarga  
( 
	@IdEmpresa varchar(3) = '1', @IdEstado varchar(2) = '13', @IdFarmaciaGenera varchar(4) = '0001', 
	...
	@FolioInicial int = 1, @FolioFinal int = 2000, 
...
--------------------------------------------- 
	...
	From vw_FACT_Remisiones_Manuales 
	Where 1 = 0 
	...
	Set @sSql = 
		...
		'From vw_FACT_Remisiones_Manuales (NoLock) '  + char(13) + 
	...
	From #vw_FACT_Remisiones R (NoLock) 
	Inner Join FACT_Remisiones_Manuales_Detalles D (NoLock) 
...
---		spp_FACT_CFD_GetRemisionesManuales_Descarga  
