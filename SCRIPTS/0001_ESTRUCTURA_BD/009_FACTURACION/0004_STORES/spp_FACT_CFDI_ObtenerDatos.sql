...
---		spp_FACT_CFDI_ObtenerDatos	
	...
	Select IdEmpresa, IdEstado, IdFarmacia, Serie, Folio, Serie_Relacionada, Folio_Relacionado, CFDI_Relacionado as UUID_Relacionado, 0 as Total_Base, SubTotal, IVA, 0 as Total 
	Into #tmp_CFDIs_Relacionados 
	From FACT_CFD_Documentos_Generados (NoLock) 
	Where IdEmpresa = @IdEmpresa And IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and Serie = @Serie and Folio = @Folio  
		and CFDI_Relacionado <> '' 
