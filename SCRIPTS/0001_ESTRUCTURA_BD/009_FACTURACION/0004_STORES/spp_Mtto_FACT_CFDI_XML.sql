------------------------------------------------------------------------------------------------
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_Mtto_FACT_CFDI_XML' and xType = 'P' ) 
	Drop Proc spp_Mtto_FACT_CFDI_XML    
Go--#SQL  

Create Proc spp_Mtto_FACT_CFDI_XML 
(	
