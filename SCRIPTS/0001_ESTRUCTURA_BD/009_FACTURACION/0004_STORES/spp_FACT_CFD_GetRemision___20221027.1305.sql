---------------------------------------------------------------------------------------------------------------------------------- 
---------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From SysObjects(NoLock) Where Name = 'spp_FACT_CFD_GetRemision___TEST' and xType = 'P' )
    Drop Proc spp_FACT_CFD_GetRemision___TEST  
Go--#SQL 
  
/* 

	Exec spp_FACT_CFD_GetRemision___TEST	
...
Create Proc spp_FACT_CFD_GetRemision___TEST 
( 
...
------------------- INFORMACION BASE  
	...
	--		spp_FACT_CFD_GetRemision___TEST 
...
----		spp_FACT_CFD_GetRemision___TEST @FolioRemision = '5928', @MostrarResumen = 0  
...
------------------- Información Adicional 
	...
	Update D Set 
			...
			Descripcion_Base = left(C.DescripcionClave + ' -- ' + C.Presentacion + '' + @sSpacios_SAT, 1000), 
...
--		sp_listacolumnas__Stores	spp_FACT_CFD_GetRemision___TEST  	, 1 
...
--		spp_FACT_CFD_GetRemision___TEST  
		...
		----	BEGIN 				
		----		Exec spp_FACT_CFD_GetRemision___TEST_Detalles @IdEmpresa, @IdEstado, @IdFarmaciaGenera, @FolioRemision, @ClaveSSA, @Informacion output 
...
----		spp_FACT_CFD_GetRemision___TEST @FolioRemision = '3652'  , @MostrarResumen = 1 
