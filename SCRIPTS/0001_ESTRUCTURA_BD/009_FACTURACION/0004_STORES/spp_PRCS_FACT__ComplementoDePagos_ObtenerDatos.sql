---------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_PRCS_FACT__ComplementoDePagos_ObtenerDatos' and xType = 'P' ) 
   Drop Proc spp_PRCS_FACT__ComplementoDePagos_ObtenerDatos 
Go--#SQL 

Create Proc spp_PRCS_FACT__ComplementoDePagos_ObtenerDatos   
( 
...
----------------------- SALIDA FINAL	
	...
	From FACT_CFDI_ComplementoDePagos__CargaMasiva (NoLock) 
