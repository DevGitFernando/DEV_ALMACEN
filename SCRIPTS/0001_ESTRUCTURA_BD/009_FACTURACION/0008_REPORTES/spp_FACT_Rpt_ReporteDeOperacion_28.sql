--------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_FACT_Rpt_ReporteDeOperacion_28' and xType = 'P' ) 
   Drop Proc spp_FACT_Rpt_ReporteDeOperacion_28 
Go--#SQL  

Create Proc	 spp_FACT_Rpt_ReporteDeOperacion_28
(
...
Declare @sNA varchar(10)  
	...
	if (@iOpcion = 1)
	Begin 
		Exec spp_FACT_Rpt_ReporteDeOperacion_28____2N_Farmacias
