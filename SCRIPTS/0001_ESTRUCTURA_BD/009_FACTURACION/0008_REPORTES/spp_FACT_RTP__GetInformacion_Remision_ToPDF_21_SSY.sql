-------------------------------------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select * From SysObjects(NoLock) Where Name = 'spp_FACT_RTP__GetInformacion_Remision_ToPDF_21_SSY' and xType = 'P' )
    Drop Proc spp_FACT_RTP__GetInformacion_Remision_ToPDF_21_SSY
Go--#SQL 

/* 

Exec spp_FACT_RTP__GetInformacion_Remision_ToPDF_21_SSY  @IdEmpresa = '001', @IdEstado = '13', @IdFarmaciaGenera = '0001',  @FolioRemision = '20629' 

*/ 


Create Proc spp_FACT_RTP__GetInformacion_Remision_ToPDF_21_SSY 
( 
	@IdEmpresa varchar(3) = '001', @IdEstado varchar(2) = '21', 
	@IdFarmaciaGenera varchar(4) = '0001',  @FolioRemision varchar(10) = '2' 
) 
With Encryption 
As 
Begin 
...
--------------------------------------------------------------------------------- 
	...
	---		Exec spp_FACT_RTP__GetInformacion_Remision_ToPDF_21_SSY 
