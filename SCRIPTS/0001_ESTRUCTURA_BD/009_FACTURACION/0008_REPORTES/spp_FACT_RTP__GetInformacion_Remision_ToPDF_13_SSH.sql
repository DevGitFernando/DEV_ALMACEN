-------------------------------------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select * From SysObjects(NoLock) Where Name = 'spp_FACT_RTP__GetInformacion_Remision_ToPDF_13_SSH' and xType = 'P' )
    Drop Proc spp_FACT_RTP__GetInformacion_Remision_ToPDF_13_SSH
Go--#SQL 

/* 

Exec spp_FACT_RTP__GetInformacion_Remision_ToPDF_13_SSH  @IdEmpresa = '001', @IdEstado = '13', @IdFarmaciaGenera = '0001',  @FolioRemision = '20629' 

*/ 


Create Proc spp_FACT_RTP__GetInformacion_Remision_ToPDF_13_SSH 
( 
	@IdEmpresa varchar(3) = '001', @IdEstado varchar(2) = '13', 
	@IdFarmaciaGenera varchar(4) = '0001',  @FolioRemision varchar(10) = '62820' 
) 
With Encryption 
As 
Begin 
...
--------------------------------------------------------------------------------- 
	...
	---		Exec spp_FACT_RTP__GetInformacion_Remision_ToPDF_13_SSH 
	...
	Update E Set Causes_NoCauses = 'No Causes'
	From #vw_FACT_Remisiones_Detalles E (NoLock) 
	Where Causes_NoCauses = '' 
