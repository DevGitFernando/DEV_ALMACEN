--------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_FACT_Rpt_Reporte_1N___TEST' and xType = 'P' ) 
   Drop Proc spp_FACT_Rpt_Reporte_1N___TEST 
Go--#SQL  

Create Proc	spp_FACT_Rpt_Reporte_1N___TEST
( 
