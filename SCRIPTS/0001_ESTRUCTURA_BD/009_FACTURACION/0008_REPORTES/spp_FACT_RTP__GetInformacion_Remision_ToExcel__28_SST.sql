-------------------------------------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select * From SysObjects(NoLock) Where Name = 'spp_FACT_RTP__GetInformacion_Remision_ToExcel__28_SST' and xType = 'P' )
    Drop Proc spp_FACT_RTP__GetInformacion_Remision_ToExcel__28_SST
Go--#SQL
  
Create Proc spp_FACT_RTP__GetInformacion_Remision_ToExcel__28_SST 
( 
...
*/ 
	...
	Select 
		...
		'Clave SSA' = ClaveSSA_Mascara, 'Descripción Clave SSA' = Descripcion_Mascara, 
