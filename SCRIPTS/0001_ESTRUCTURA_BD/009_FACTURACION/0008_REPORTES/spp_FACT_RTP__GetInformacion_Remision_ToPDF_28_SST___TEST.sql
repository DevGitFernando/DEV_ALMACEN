-------------------------------------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select * From SysObjects(NoLock) Where Name = 'spp_FACT_RTP__GetInformacion_Remision_ToPDF_28_SST___TEST' and xType = 'P' )
    Drop Proc spp_FACT_RTP__GetInformacion_Remision_ToPDF_28_SST___TEST
Go--#SQL 

Create Proc spp_FACT_RTP__GetInformacion_Remision_ToPDF_28_SST___TEST 
( 
	@IdEmpresa varchar(3) = '001', @IdEstado varchar(2) = '28', 
	@IdFarmaciaGenera varchar(4) = '0001',  @FolioRemision varchar(10) = '0000019336' 
)
With Encryption 
As 
Begin 
...
--		spp_FACT_RTP__GetInformacion_Remision_ToPDF_28_SST___TEST__TEST
	...
	---		Exec spp_FACT_RTP__GetInformacion_Remision_ToPDF_28_SST___TEST 
