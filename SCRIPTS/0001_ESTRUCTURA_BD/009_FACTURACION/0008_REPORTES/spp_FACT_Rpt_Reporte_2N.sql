------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_FACT_Rpt_Reporte_2N' and xType = 'P' ) 
   Drop Proc spp_FACT_Rpt_Reporte_2N 
Go--#SQL   

--	Exec spp_FACT_Rpt_Reporte_2N @AplicarFiltroFolios = 1, @FolioInicial = 19469, @FolioFinal = 19469  

Create Proc	 spp_FACT_Rpt_Reporte_2N  
(
...
--		Exec spp_FACT_Rpt_Reporte_2N @AplicarFiltroFolios = 1, @FolioInicial = 19469, @FolioFinal = 19469  
	...
	Select 
		...
		Año_Venta, 
		Mes_Venta, 
		CentroDeCosto, IdFarmacia, NombreOficial, NumFactura As 'FolioFactura Electronica', FolioFiscal_SAT, FolioFiscal_SAT_Corto,
