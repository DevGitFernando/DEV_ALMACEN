------------------------------------------------------------------------------------------------------------------------------------------------------ 
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_FACT_CFDI_NotaDeCredito_ObtenerDatos_VP' and xType = 'P' ) 
   Drop Proc spp_FACT_CFDI_NotaDeCredito_ObtenerDatos_VP 
Go--#SQL  

Create Proc spp_FACT_CFDI_NotaDeCredito_ObtenerDatos_VP 
(
...
------------------------------------------ Obtener informacion 	
	Select 
		...
		dbo.fg_ObtenerMetodosDePago(D.IdEmpresa, D.IdEstado, D.IdFarmacia, D.Serie, D.Folio, 1, 1) as XMLFormaPago, 
		dbo.fg_ObtenerMetodosDePago(D.IdEmpresa, D.IdEstado, D.IdFarmacia, D.Serie, D.Folio, 1, 2) as XMLFormaPagoDescripcion, 
