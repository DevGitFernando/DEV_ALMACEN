------------------------------------------------------------------------------------------------------------------------------------------------------------ 
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'fg_FACT_NotasDeCredito_Total_Previo' and xType = 'FN' )
   Drop Function fg_FACT_NotasDeCredito_Total_Previo  
Go--#SQL     
      
Create Function dbo.fg_FACT_NotasDeCredito_Total_Previo
(
...
Declare 
	...
	Select Top 1 @Anterior = Sum(Total)
	--Select Sum(Total)
