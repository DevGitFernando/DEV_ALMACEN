---------------------------------------------------------------------------------------------------------------------------	
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_FACT_CFDI_GetListaComprobantes' and xType = 'P' ) 
   Drop Proc spp_FACT_CFDI_GetListaComprobantes  
Go--#SQL  

--		sp_listacolumnas__Stores spp_FACT_CFDI_GetListaComprobantes , 1  

--		Exec spp_FACT_CFDI_GetListaComprobantes '00000001', 2014, 2, 0, '59'  
