------------------------------------------------------------------------------------------------------------------------------------------------------------ 
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'fg_FACT_ComplementoPagos_Parcialidad' and xType = 'FN' )
   Drop Function fg_FACT_ComplementoPagos_Parcialidad  
Go--#SQL     
      
Create Function dbo.fg_FACT_ComplementoPagos_Parcialidad
( 
