...
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_Mtto_CFGC_Huellas' and xType = 'P' ) 
   Drop Proc spp_Mtto_CFGC_Huellas 
Go--#SQL   

Create Proc spp_Mtto_CFGC_Huellas 
( 
	...
	*/
	...
	If @iOpcion = 1
	  Begin
		...
		Delete From CFGC_Huellas
 
		Insert Into CFGC_Huellas ( Servidor, WebService, PaginaWeb, Status, Actualizado ) 
	...
	Else
	  Begin
		Set @sStatus = 'C'
		Update CFGC_Huellas Set Status = @sStatus
