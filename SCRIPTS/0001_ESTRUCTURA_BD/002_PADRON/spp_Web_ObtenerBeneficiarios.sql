...
----     Exec spp_Web_ObtenerBeneficiarios '21', '2', '2502001487', '', '', '', '', '', '0002' 
...
---    select @sBdPadron, @sTablaPadron 
	...
	Select Top 0 
		   FolioReferencia, space(2) as Consecutivo, 
	...
	Set @sSql = 
		' Insert Into #tmpBeneficiarios	( 
				 FolioReferencia, Consecutivo, Nombre, ApPaterno, ApMaterno, Sexo, FechaNacimiento, Edad, EsVigente, FechaInicioVigencia, FechaFinVigencia ) ' + char(13) + 
		' Select Folio, Consecutivo, Nombre, ApPaterno, ApMaterno, Sexo, FechaNacimiento, 0 as Edad, 
...
--	Print @sSql 
	...
	Select 
		   ...
		   'Sexo' = (case when Sexo = 'M' then 'Masculino' else 'Femenino' end), 
