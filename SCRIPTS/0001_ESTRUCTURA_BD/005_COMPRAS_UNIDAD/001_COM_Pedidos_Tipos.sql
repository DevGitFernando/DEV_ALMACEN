If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'COM_FAR_Pedidos_Tipos_Farmacias' and xType = 'U' ) 
   Drop Table COM_FAR_Pedidos_Tipos_Farmacias 
Go--#SQL 
	
------------------- 
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'COM_FAR_Pedidos_Tipos' and xType = 'U' ) 
   Drop Table COM_FAR_Pedidos_Tipos 
Go--#SQL  
