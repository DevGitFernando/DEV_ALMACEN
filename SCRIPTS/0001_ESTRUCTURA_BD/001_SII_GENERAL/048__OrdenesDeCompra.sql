...
( 
	...
	EsFacturaOriginal bit Not Null Default 0, 

	FolioMovtoInv varchar(30) Not Null, 
	IdPersonal varchar(4) Not Null, 
	IdAutoriza_CheckList varchar(8) Not Null Default '', 
	...
	ImporteFactura numeric(14, 4) Not Null Default 0, --  Importe Neto de la Factura recibida 
...
If Not Exists ( Select * From sysobjects so (nolock) Where name = 'CK_OrdenesDeComprasDet_Cantidad' and xType = 'C' ) 
Begin 
	Alter Table OrdenesDeComprasDet With NoCheck 
		Add Constraint CK_OrdenesDeComprasDet_Cantidad Check Not For Replication (CantidadRecibida >= 0)
End 	
Go--#SQL 
...
If Not Exists ( Select * From sysobjects so (nolock) Where name = 'CK_OrdenesDeComprasDet_Lotes_Cantidad' and xType = 'C' ) 
Begin 
	Alter Table OrdenesDeComprasDet_Lotes With NoCheck 
		Add Constraint CK_OrdenesDeComprasDet_Lotes_Cantidad Check Not For Replication (CantidadRecibida >= 0)
End 
Go--#SQL 
...
If Not Exists ( Select * From sysobjects so (nolock) Where name = 'CK_OrdenesDeComprasDet_Lotes_Ubicaciones_Cantidad' and xType = 'C' ) 
Begin 
	Alter Table OrdenesDeComprasDet_Lotes_Ubicaciones With NoCheck 
		Add Constraint CK_OrdenesDeComprasDet_Lotes_Ubicaciones_Cantidad Check Not For Replication (CantidadRecibida >= 0)
End 
Go--#SQL 
