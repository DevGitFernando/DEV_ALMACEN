If Exists ( Select Name From Sysobjects (nolock) Where Name = 'fg_PtoVta_FechaCriterioValidacion' and xType = 'FN' ) 
   Drop Function fg_PtoVta_FechaCriterioValidacion 
Go--#SQL
 

Create Function dbo.fg_PtoVta_FechaCriterioValidacion 
( 
