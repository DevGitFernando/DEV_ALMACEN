--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select Name From Sysobjects (nolock) Where Name = 'fg_CalcularPrecioMinimoDeVenta' and xType = 'FN' ) 
   Drop Function fg_CalcularPrecioMinimoDeVenta 
Go--#SQL	

Create Function dbo.fg_CalcularPrecioMinimoDeVenta 
( 
    @Tipo tinyint = 1, 
...
Declare @dPrecioVenta numeric(14,4), 
	...
	Select @dUtilidadProducto = UtilidadProducto   
	...
	Where IdEstado = @IdEstado and IdFarmacia = @IdFarmacia and IdProducto = @IdProducto  
