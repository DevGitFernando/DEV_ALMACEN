...
Create Procedure spp_Mtto_COM_OCEN_AsignacionDePedidosCompradores( @IdEmpresa varchar(3), @IdEstado varchar(2), @IdFarmacia varchar(4), 
	...
	@FechaRegistro varchar(10), @Observaciones varchar(200), @EsCentral tinyint )
As
Begin
	...
	If Not Exists ( Select FolioPedido From COM_OCEN_AsignacionDePedidosCompradores (NoLock)
	 ...
	 Begin
		Insert Into COM_OCEN_AsignacionDePedidosCompradores( IdEmpresa, IdEstado, IdFarmacia, IdTipoPedido, FolioPedido, EsCentral, IdPersonal,
		IdEstadoRegistra, IdFarmaciaRegistra, IdPersonalRegistra,
		FechaRegistro, Observaciones, StatusPedido, Status, Actualizado )
		Select @IdEmpresa, @IdEstado, @IdFarmacia, @IdTipoPedido, @FolioPedido, @EsCentral, @IdPersonal, 
		@IdEstadoRegistra, @IdFarmaciaRegistra, @IdPersonalRegistra,
		@FechaRegistro, @Observaciones, @iStatusPedido, @sStatus, @iActualizado
