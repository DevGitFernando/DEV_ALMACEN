...
Create Procedure spp_Mtto_COM_OCEN_Pedidos( @IdEmpresa varchar(3), @IdEstado varchar(2), @IdFarmacia varchar(4), @IdTipoPedido varchar(2), 
	@FolioPedido varchar(6), @IdPersonal varchar(4), @FechaSistema varchar(10), @Observaciones varchar(200),
	@IdEstadoRegistra varchar(2), @IdFarmaciaRegistra varchar(4) 
	)
As
Begin
	...
	If Not Exists ( Select FolioPedido From COM_OCEN_Pedidos (NoLock)
	 ...
	 Begin
		Insert Into COM_OCEN_Pedidos( IdEmpresa, IdEstado, IdFarmacia, IdTipoPedido, FolioPedido, IdPersonal, FechaSistema, FechaRegistro, 
					Observaciones, Status, Actualizado, IdEstadoRegistra, IdFarmaciaRegistra, StatusPedido )
		Select @IdEmpresa, @IdEstado, @IdFarmacia, @IdTipoPedido, @FolioPedido, @IdPersonal, @FechaSistema, GetDate(), 
		@Observaciones, @sStatus, @iActualizado, @IdEstadoRegistra, @IdFarmaciaRegistra, @sStatusPedido
...
Create Procedure spp_Mtto_COM_OCEN_REG_Pedidos( @IdEmpresa varchar(3), @IdEstado varchar(2), @IdFarmacia varchar(4), @IdTipoPedido varchar(2), 
@FolioPedido varchar(6), @IdPersonal varchar(4), @FechaSistema varchar(10), @Observaciones varchar(200), @FolioPedidoUnidad varchar(6),
@IdEstadoRegistra varchar(2), @IdFarmaciaRegistra varchar(4) )
As
Begin
	Declare @sMensaje varchar(1000), 
	...
	If Not Exists ( Select FolioPedido From COM_OCEN_REG_Pedidos (NoLock)
		...
		And IdTipoPedido = @IdTipoPedido And FolioPedido = @FolioPedido )
	 Begin
		Insert Into COM_OCEN_REG_Pedidos( IdEmpresa, IdEstado, IdFarmacia, IdTipoPedido, FolioPedido, IdPersonal, FechaSistema, FechaRegistro, 
										Observaciones, Status, Actualizado, StatusPedido, FolioPedidoUnidad, IdEstadoRegistra, IdFarmaciaRegistra )
		Select @IdEmpresa, @IdEstado, @IdFarmacia, @IdTipoPedido, @FolioPedido, @IdPersonal, @FechaSistema, GetDate(), 
		@Observaciones, @sStatus, @iActualizado, @StatusPedido, @FolioPedidoUnidad, @IdEstadoRegistra, @IdFarmaciaRegistra
