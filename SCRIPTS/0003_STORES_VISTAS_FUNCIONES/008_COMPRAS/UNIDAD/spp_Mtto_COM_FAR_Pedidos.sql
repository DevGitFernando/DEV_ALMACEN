...
( 
	...
	@FolioPedido varchar(6), @IdPersonal varchar(4), @FechaSistema varchar(10), @Observaciones varchar(200), @TipoDePedido int 
) 
With Encryption 
As
Begin
	...
	If Not Exists ( Select FolioPedido From COM_FAR_Pedidos (NoLock)
	 ...
	 Begin
		Insert Into COM_FAR_Pedidos ( IdEmpresa, IdEstado, IdFarmacia, IdTipoPedido, TipoDePedido, FolioPedido, IdPersonal, FechaSistema, FechaRegistro, Observaciones, Status, Actualizado )
		Select @IdEmpresa, @IdEstado, @IdFarmacia, @IdTipoPedido, @TipoDePedido, @FolioPedido, @IdPersonal, @FechaSistema, GetDate(), @Observaciones, @sStatus, @iActualizado
