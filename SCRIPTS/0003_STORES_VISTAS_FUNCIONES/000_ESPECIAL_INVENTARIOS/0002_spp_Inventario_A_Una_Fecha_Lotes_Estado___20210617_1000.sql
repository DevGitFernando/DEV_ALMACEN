...
Go--#SQL 	
	...
	---			Exec spp_Inventario_A_Una_Fecha_Lotes_Estado '11', '2015-08-31', 0, 'tmpInventario_A_Una_Fecha_Lotes'
	 
	----		Select * From tmpInventario_A_Una_Fecha_Lotes_Estado
	
Create Proc spp_Inventario_A_Una_Fecha_Lotes_Estado 
( 
	@IdEstado varchar(2) = '22', @FechaRevision varchar(10) = '2022-11-15', @iMostrarResultado int = 0, 
