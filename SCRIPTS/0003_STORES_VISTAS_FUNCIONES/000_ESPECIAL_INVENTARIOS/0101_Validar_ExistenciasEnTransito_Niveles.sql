	...
	Where IdEmpresa = 1 and IdEstado = 21 and IdFarmacia = 2182  -- and IdProducto = 00006257 
		and Exists 
		(
			Select * 
			From TransferenciasDet T (nolock) 
			Where IdEstado = 21 and IdFarmacia = 2182 and FolioTransferencia = 'TS00041995' 
				and T.IdProducto = F.IdProducto 
		) 
...
-------------------------------------------------------------------------------------------------------------------------------------------------  		
	...
	Where 
		( 
		(ExistenciaEnTransito < 0) or 
		(ExistenciaEnTransito_EAN < 0) or (ExistenciaEnTransito_Lote < 0) or ( ExistenciaEnTransito_U < 0 ) 
		) 		
	...
	Where 
		( 
		(ExistenciaEnTransito > Existencia) or 
		(ExistenciaEnTransito > Existencia_EAN) or (ExistenciaEnTransito > Existencia_Lote) or (
		 ExistenciaEnTransito > Existencia_U  ) 
		) 		
