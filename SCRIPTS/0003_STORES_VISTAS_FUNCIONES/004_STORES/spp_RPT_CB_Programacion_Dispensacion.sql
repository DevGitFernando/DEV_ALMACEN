----------------------------------------------------------------------------------------------------------------------------------------------------------------  
----------------------------------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_RPT_CB_Programacion_Dispensacion' and xType = 'P' ) 
	Drop Proc spp_RPT_CB_Programacion_Dispensacion
Go--#SQL 

Create Proc spp_RPT_CB_Programacion_Dispensacion 
( 
...
---		spp_RPT_CB_Programacion_Dispensacion    
