If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_DEV_AfectarVentas' and xType = 'P' ) 
   Drop Proc spp_DEV_AfectarVentas 
Go--#SQL

Create Proc spp_DEV_AfectarVentas ( @IdEmpresa varchar(3) = '001', @IdEstado varchar(2) = '25', @IdFarmacia varchar(4) = '0001', 
...
------------------------- 
	...
	Select IdEmpresa, IdEstado, IdFarmacia, FolioVenta, IdProducto, CodigoEAN, Renglon, UnidadDeSalida, 
		   Cant_Entregada, Cant_Devuelta, CantidadVendida, CostoUnitario, PrecioUnitario, TasaIva, ImpteIva, PorcDescto, ImpteDescto 
	Into #tmpVentas 
...
------------------------- 
	...
	Update V Set Cant_Devuelta = D.Cant_Devuelta, CantidadVendida = D.CantidadVendida 
	From VentasDet_Lotes_Ubicaciones V 
