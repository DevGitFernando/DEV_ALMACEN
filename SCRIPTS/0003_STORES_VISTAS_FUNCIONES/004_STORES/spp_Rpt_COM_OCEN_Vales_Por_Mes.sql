...
Begin 
	...
	Select	IdEmpresa, IdEstado, IdJurisdiccion, IdFarmacia, FolioVale as 'Folio Vale', FolioVenta as 'Folio Venta', NumReceta as 'Numero Receta', 
			Convert(varchar(10), FechaReceta, 120) as 'Fecha Receta', 
			Cantidad, IdBeneficiario, Beneficiario, Poliza, FechaRegistro as 'Fecha Registro', FechaCanje as 'Fecha Canje',
