...
--	Exec spp_Rpt_OCEN_ConsumoEstados_Claves '001', '11', '001', [ '3308', '5438', '4489' ], '2013-01-01', '2013-08-05', 0, 0, '0251'   
...
( 
	...
	@FechaInicio varchar(10), @FechaFin varchar(10), @TipoDispensacion int, @TipoReporte int, @IdLaboratorio varchar(4) = '*' 
) 
With Encryption 
As 
Begin 
	...
	if @IdLaboratorio <> '*'
		Set @sWhereLab = ' And P.IdLaboratorio = ' + char(39) + @IdLaboratorio + char(39)
...
---------------------------------- GENERAR DETALLE DE LOS CONSUMOS    
	Set @sSql = ' Insert Into #tmpConsumosEstados (IdEmpresa, Empresa, IdEstado, Estado, IdJurisdiccion, Jurisdiccion, IdFarmacia, Farmacia, ' + char(13) + char(10) + 
		...
		' ' + @sWhereJuris + char(13) + char(10) + @sWhereLab + char(13) + char(10) + 
