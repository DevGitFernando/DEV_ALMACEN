...
Create Proc spp_Rpt_Central_CaducarSales ( @IdEmpresa varchar(3) = '', @IdEstado varchar(2) = '21', @IdFarmacia varchar(4) = '0182', 
	 @IdClaveSSA_Sal varchar(20) = '', @IdProducto varchar(8) = '', @CodigoEAN varchar(20) = '', @Mostrar tinyint = 2, 
	 @FechaInicial varchar(10) = '2011-01-01' , @FechaFinal varchar(10) = '2040-01-01' ) 
With Encryption 
As 
Begin 
Set NoCount On 
...
Declare @sEncPrinRpt varchar(300), 
	...
	if 	@IdClaveSSA_Sal <> ''
				Set @sWhere = @sWhere + ' and ' + char(13) + 'ClaveSSA = ' + char(39) + @IdClaveSSA_Sal + char(39)

	Set @sSql = 
		' Insert Into #tmpReportesCaducar ( EncPrincipal, EncSecundario, IdEmpresa, Empresa, IdEstado, Estado, IdFarmacia, Farmacia, 
			IdSubFarmacia, SubFarmacia, IdClaveSSA_Sal, ClaveSSA, DescripcionSal, 
	...
	Select EncPrincipal, EncSecundario, 
		IdEmpresa, Empresa, IdEstado, Estado, IdFarmacia, Farmacia, IdSubFarmacia, SubFarmacia, IdClaveSSA_Sal, ClaveSSA, 
		DescripcionSal, IdProducto, CodigoEAN, DescripcionProducto, ClaveLote, Convert( varchar(10), FechaCaducidad, 120 ) as FechaCaducidad, 
		FechaRegistro, Existencia, FechaDeImpresion  
	From #tmpReportesCaducar (NoLock)	
	Order by IdEmpresa, Empresa, IdEstado, Estado, IdFarmacia, Farmacia, IdSubFarmacia, SubFarmacia, DescripcionSal 
