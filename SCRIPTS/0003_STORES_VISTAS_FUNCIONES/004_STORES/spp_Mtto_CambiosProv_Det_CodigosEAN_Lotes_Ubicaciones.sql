...
If Exists (Select Name From SysObjects(NoLock) Where Name = 'spp_Mtto_CambiosProv_Det_CodigosEAN_Lotes_Ubicaciones' and xType = 'P')
    Drop Proc spp_Mtto_CambiosProv_Det_CodigosEAN_Lotes_Ubicaciones
Go--#SQL

  
Create Proc spp_Mtto_CambiosProv_Det_CodigosEAN_Lotes_Ubicaciones 
( 
	...
	*/
	...
	If @iOpcion = 1 
       Begin 
		   ...
		   If Not Exists ( Select * From CambiosProv_Det_CodigosEAN_Lotes_Ubicaciones (NoLock) 
			  ...
			  Begin 
				Insert Into CambiosProv_Det_CodigosEAN_Lotes_Ubicaciones 
...
--			  Begin 
--			     
--				Update CambiosProv_Det_CodigosEAN_Lotes_Ubicaciones Set 
...
--              End 
    ...
    Else 
       Begin 
			Set @sStatus = 'C'
			Update CambiosProv_Det_CodigosEAN_Lotes_Ubicaciones Set Status = @sStatus, Actualizado = @iActualizado 
			Where IdEmpresa = @IdEmpresa And IdEstado = @IdEstado And IdFarmacia = @IdFarmacia And IdSubFarmacia = @IdSubFarmacia 
