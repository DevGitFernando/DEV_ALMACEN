...
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_Mtto_CFGC_AutorizacionHuellas' and xType = 'P' ) 
   Drop Proc spp_Mtto_CFGC_AutorizacionHuellas
Go--#SQL   

Create Proc spp_Mtto_CFGC_AutorizacionHuellas
( 
...
Declare @sMensaje varchar(1000), 
	...
	*/
	...
	Else
	  Begin
		Set @sStatus = 'C'
		Update CFGC_AutorizacionHuellas Set Status = @sStatus
