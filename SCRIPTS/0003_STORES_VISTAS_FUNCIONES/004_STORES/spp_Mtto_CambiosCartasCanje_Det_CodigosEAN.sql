If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_Mtto_CambiosCartasCanje_Det_CodigosEAN' and xType = 'P' ) 
   Drop Proc spp_Mtto_CambiosCartasCanje_Det_CodigosEAN
Go--#SQL

Create Proc spp_Mtto_CambiosCartasCanje_Det_CodigosEAN 
( 
...
Declare @Mensaje varchar(1000), 
	...
	If @iOpcion = 1
	Begin
		Insert Into CambiosCartasCanje_Det_CodigosEAN ( IdEmpresa, IdEstado, IdFarmacia, FolioCambio, IdProducto, CodigoEAN, Cantidad, Costo, TasaIva, 
