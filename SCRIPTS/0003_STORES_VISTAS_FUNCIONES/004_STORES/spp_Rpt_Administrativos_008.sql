...
--		delete from RptAdmonDispensacion Where  IdGrupoPrecios = 3 
...
------------------------------------ Descontar las Claves con Vale generado 
	...
	Insert Into RptAdmonDispensacion 
	( 
		...
		IdClaveSSA_Sal, ClaveSSA, DescripcionSal, ContenidoPaquete_ClaveSSA, IdProducto, CodigoEAN, EsConsignacion, EsControlado, Renglon, 
		DescProducto, DescripcionCorta, UnidadDeSalida, 
		TasaIva, Cantidad, PrecioUnitario, PrecioLicitacion, PrecioLicitacionUnitario, ImporteEAN, ImporteEAN_Licitado, 
	...
	Select 
		...
		IdClaveSSA_Sal, ClaveSSA, DescripcionSal, ContenidoPaquete_ClaveSSA, IdProducto, CodigoEAN, EsConsignacion, EsControlado, Renglon, 
		DescProducto, DescripcionCorta, UnidadDeSalida, 
		TasaIva, 0 as Cantidad, PrecioUnitario, PrecioLicitacion, PrecioLicitacionUnitario, 0 as ImporteEAN, 0 as ImporteEAN_Licitado, 
		SubTotalLicitacion_0, SubTotalLicitacion, IvaLicitacion, TotalLicitacion, 
...
--		sp_listacolumnas  RptAdmonDispensacion  
