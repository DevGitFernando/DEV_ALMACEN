If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_Verificar_Salida' and xType = 'P' ) 
   Drop Proc spp_Verificar_Salida 
Go--#SQL     

Create Proc spp_Verificar_Salida 
( 
	@IdEmpresa varchar(3) = '001', @IdEstado varchar(2) = '21', @IdFarmacia varchar(4) = '0187', 
	@TablaBase varchar(100) = 'tmpListaLotes_70F1A1AD63BF_20110930_133252' -- 'tmpLotes_0000EA' ) 
)
With Encryption 
As 
Begin 
...
--- Tabla Base del Proceso 
	Select Top 0 IdEmpresa, IdEstado, IdFarmacia, IdSubFarmacia, IdProducto, CodigoEAN, ClaveLote, 
	     0 as C_Gral, 0 as C_EAN, cast(Existencia as int) as Cantidad,  
	     0 as ExistenciaGral, 0 as ExistenciaEAN, 0 as ExistenciaLotes, 
	     0 as Error    	     
...
--- Insertar Datos 
	Set @sSql = 'Insert Into #tmpListaProductos ( IdEmpresa, IdEstado, IdFarmacia, IdSubFarmacia, IdProducto, CodigoEAN, ClaveLote, Cantidad, C_Gral, C_EAN, ExistenciaGral, ExistenciaEAN, ExistenciaLotes, Error  ) ' + 
		' Select IdEmpresa, IdEstado, IdFarmacia, IdSubFarmacia, IdProducto,CodigoEAN, ClaveLote, Cantidad, 0, 0, 0, 0, 0, 0  ' +  
		' From ' +  @TablaBase 
	Exec(@sSql) 
	-- Print @sSql 
...
---------------------------- Verificar Cantidades 	
	...
	Select IdSubFarmacia, dbo.fg_ObtenerNombreSubFarmacia(T.IdEstado, T.IdFarmacia, T.IdSubFarmacia)  as SubFarmacia, 
	    T.CodigoEAN, P.Descripcion, T.ClaveLote, ExistenciaGral, ExistenciaEAN, ExistenciaLotes, Cantidad as CantidadRequerida, T.IdProducto 
