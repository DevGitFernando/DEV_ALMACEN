...
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_Kardex_Controlados_Farmacia_Lotes' and xType = 'P' ) 
   Drop Proc spp_Kardex_Controlados_Farmacia_Lotes 
Go--#SQL  

Create Proc	 spp_Kardex_Controlados_Farmacia_Lotes( @IdEmpresa varchar(3) = '001', @IdEstado varchar(2) = '25', @IdFarmacia varchar(4) = '0008',
	@IdClaveSSA varchar(4) = '0498', @IdProducto varchar(8) = '00000566',  
	@FechaInicial varchar(10) = '2010-01-01', @FechaFinal varchar(10) = '2010-01-31', @TipoReporte smallint = 0, 
...
Declare @sNA varchar(10)  
	...
	Where 1 = 0 		
			...
			If exists ( select * from sysobjects (nolock) Where Name = 'tmpKardex_Controlados_Farmacia_Lotes' and xType = 'U' ) 
				Drop table tmpKardex_Controlados_Farmacia_Lotes
			...
			Select 
				...
				Into #tmptmpKardex_Controlados_Base   
		...
		------------------- Informacion Base  
			...
			Into tmpKardex_Controlados_Farmacia_Lotes
			-- Drop Table tmpKardex_Controlados_Farmacia_Lotes
			From #tmptmpKardex_Controlados_Base V (NoLock)		
		...
		------------------- Informacion Base 
			...
			From tmpKardex_Controlados_Farmacia_Lotes K 	
		...
		---- Generar el orden del reporte 
			...
			into #tmpOrden 
			From tmpKardex_Controlados_Farmacia_Lotes 
			Order by DescripcionClave 

			Update T Set OrdenReporte = O.OrdenReporte 
			From tmpKardex_Controlados_Farmacia_Lotes T 
...
----------------------------------------------------------------------------------------------------------------------------------------------
		--		spp_Kardex_Controlados_Farmacia_Lotes 
...
--		Select * From tmpKardex_Controlados_Farmacia_Lotes
--		Order By TipoMovto
