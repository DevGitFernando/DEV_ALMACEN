...
Declare @sSql varchar(8000),   
	...
	Set @dFecha = getdate() 
	Select 
		IdEmpresa, Empresa, IdEstado, Estado, IdFarmacia, Farmacia, IdSubFarmacia, SubFarmacia, IdClaveSSA_Sal, 
		ClaveSSA_Base, ClaveSSA, ClaveSSA_Aux, DescripcionSal, 
			IdProducto, CodigoEAN, DescripcionProducto, IdPresentacion, Presentacion, ClaveLote, FechaCaducidad, FechaRegistro, Existencia,
			ExistenciaEnTransito, ExistenciaSurtidos, ExistenciaAux as ExistenciaTotal, 
	...
	Set @sSql = 
		' Insert Into #tmpReporesExistencias ( IdEmpresa, Empresa, IdEstado, Estado, IdFarmacia, Farmacia, IdSubFarmacia, SubFarmacia, 
			IdClaveSSA_Sal, ClaveSSA_Base, ClaveSSA, ClaveSSA_Aux, DescripcionSal, IdProducto, CodigoEAN, DescripcionProducto, IdPresentacion, Presentacion, ClaveLote, 
			FechaCaducidad, FechaRegistro, Existencia, ExistenciaEnTransito, ExistenciaSurtidos, ExistenciaTotal, FechaDeImpresion ) ' + char(13) + 	
		' Select ' + char(13) + 
		'	IdEmpresa, Empresa, IdEstado, Estado, IdFarmacia, Farmacia, IdSubFarmacia, SubFarmacia, IdClaveSSA_Sal, ClaveSSA_Base, ClaveSSA, ClaveSSA_Aux, DescripcionSal, 
			IdProducto, CodigoEAN, DescripcionProducto, IdPresentacion, Presentacion, ClaveLote, FechaCaducidad, FechaRegistro, 
			Existencia, ExistenciaEnTransito, ExistenciaSurtidos, ExistenciaAux, getdate() ' + char(13) + 
	...
	Select 
		IdEmpresa, Empresa, IdEstado, Estado, IdFarmacia, Farmacia, IdSubFarmacia, SubFarmacia, IdClaveSSA_Sal, ClaveSSA_Base, ClaveSSA, ClaveSSA_Aux, DescripcionSal, 
		IdProducto, CodigoEAN, DescripcionProducto, IdPresentacion, Presentacion, ClaveLote, FechaCaducidad, FechaRegistro, Existencia, 
		ExistenciaEnTransito, ExistenciaSurtidos, ExistenciaTotal, FechaDeImpresion  
