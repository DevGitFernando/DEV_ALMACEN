	...
	*/
	...
	If @iOpcion = 1 
       Begin 
		   ...
		   Set @sMensaje = 'La información se guardo satisfactoriamente con la clave ' + @FolioTraspaso 
	   End 
    Else 
       Begin 
			Set @sStatus = 'C'
			...
			Where IdEmpresa = @IdEmpresa And IdEstado = @IdEstado And IdFarmacia = @IdFarmacia And IdSubFarmacia = @IdSubFarmacia 
				...
				And Renglon = @Renglon And IdPasillo = @IdPasillo and IdEstante = @IdEstante and IdEntrepaño = @IdEntrepaño

		   Set @sMensaje = 'La información del Folio ' + @FolioTraspaso + ' ha sido cancelada satisfactoriamente.' 
	   End 
