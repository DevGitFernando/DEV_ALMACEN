If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_Mtto_TransferenciasEnvioValidar' and xType = 'P' ) 
	Drop Proc spp_Mtto_TransferenciasEnvioValidar 
Go--#SQL

Create Proc spp_Mtto_TransferenciasEnvioValidar 
( 
	@IdEmpresa varchar(3) = '001', @IdEstado varchar(2) = '21', @IdFarmacia varchar(4) = '1006', 
...
Declare 
	...
	Where IdEmpresa = @IdEmpresa and IdEstadoRecibe = @IdEstado and IdFarmaciaEnvia = @IdFarmaciaEnvia and IdFarmaciaRecibe = @IdFarmacia 
		and FolioTransferencia = @sFolioTransferencia 
...
---		spp_Mtto_TransferenciasEnvioValidar  
