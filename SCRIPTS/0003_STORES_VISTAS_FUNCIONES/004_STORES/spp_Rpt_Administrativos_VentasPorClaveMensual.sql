---------------------------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_Rpt_Administrativos_VentasPorClaveMensual' and xType = 'P' ) 
   Drop Proc spp_Rpt_Administrativos_VentasPorClaveMensual
Go--#SQL 

Create Proc spp_Rpt_Administrativos_VentasPorClaveMensual 
----( 
...
*/ 
	...
	If Exists ( select Name From Sysobjects (NoLock) Where Name = 'Rpt_DispensacionPorClaveMensual' and xType = 'U' ) 
	   Drop Table Rpt_DispensacionPorClaveMensual 
...
----	From Rpt_DispensacionPorClaveMensual 
----	Group by 
----		 IdEmpresa, IdEstado, 
----		 IdPrograma, Programa, IdSubPrograma, SubPrograma, 
----		 IdClaveSSA, ClaveSSA, DescripcionClave, PrecioLicitacion, Año 
