If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_Rpt_VentasPorClaveMensual' and xType = 'P' ) 
   Drop Proc spp_Rpt_VentasPorClaveMensual
Go--#SQL 

---- Exec   spp_Rpt_VentasPorClaveMensual  '20', '0038', '', '2011-07-09', '2011-07-10', '0'  

---	Exec  spp_Rpt_VentasPorClaveMensual '21', '*', '*', '*', '2012-10-01', '2012-10-01', '0', '0'  


---		Exec  spp_Rpt_VentasPorClaveMensual '09', '*', '*', '*', '2014-08-01', '2014-08-01', 0, 0, '', 0, 0, 0, '*', '*', 1, 0      

Create Proc spp_Rpt_VentasPorClaveMensual 
( 
	...
	@TipoDispensacion smallint = 0,	@TipoInsumo tinyint = 1, @SubFarmacias varchar(200) = '',
