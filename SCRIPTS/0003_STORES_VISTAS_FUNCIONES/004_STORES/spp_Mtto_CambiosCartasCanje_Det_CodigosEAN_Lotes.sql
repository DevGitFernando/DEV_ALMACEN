If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'spp_Mtto_CambiosCartasCanje_Det_CodigosEAN_Lotes' and xType = 'P' ) 
	Drop Proc spp_Mtto_CambiosCartasCanje_Det_CodigosEAN_Lotes
Go--#SQL 

Create Proc spp_Mtto_CambiosCartasCanje_Det_CodigosEAN_Lotes 
(
...
Set NoCount On 
	...
	If @iOpcion = 1
	Begin
		Insert Into CambiosCartasCanje_Det_CodigosEAN_Lotes (IdEmpresa, IdEstado, IdFarmacia, FolioCambio, IdProducto, CodigoEAN, IdSubFarmacia, 
