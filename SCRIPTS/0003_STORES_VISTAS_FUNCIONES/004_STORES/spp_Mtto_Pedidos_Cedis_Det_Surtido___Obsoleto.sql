...
Declare @sMensaje varchar(1000), 
	...
	*/
    ...
    If Not Exists 
        ( Select FolioPedido From Pedidos_Cedis_Det_Surtido (NoLock) 
		   Where IdEmpresa = @IdEmpresa And IdEstado = @IdEstado and IdFarmacia = @IdFarmacia 
		   and FolioPedido = @FolioPedido and IdClaveSSA = @IdClaveSSA 
		)
	Begin 
        Insert Into Pedidos_Cedis_Det_Surtido ( IdEmpresa, IdEstado, IdFarmacia, FolioPedido, IdClaveSSA, CantidadSolicitada, CantidadSugerida, Status, Actualizado ) 
