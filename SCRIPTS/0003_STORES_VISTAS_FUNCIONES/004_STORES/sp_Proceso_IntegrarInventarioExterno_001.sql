If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'sp_Proceso_IntegrarInventarioExterno_001' and xType = 'P' ) 
   Drop Proc sp_Proceso_IntegrarInventarioExterno_001 
Go--#SQL 

Create Proc sp_Proceso_IntegrarInventarioExterno_001  
( 
