------------------------------------------------------------------------------------------------------------------------------------------------------ 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'sp_Proceso_IntegrarInventarioInterno_002___Almacen' and xType = 'P' ) 
   Drop Proc sp_Proceso_IntegrarInventarioInterno_002___Almacen 
Go--#SQL 

Create Proc sp_Proceso_IntegrarInventarioInterno_002___Almacen  
( 
...
Declare  
	...
	Begin
		...
		Select 
			IdEmpresa, IdEstado, IdFarmacia, IdSubFarmacia, 
			IdPasillo, IdEstante, IdEntrepaño, IdProducto, CodigoEAN, ClaveLote, EsConsignacion, space(10), 
