If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'sp_Proceso_IntegrarInventarioInterno_003___Almacen' and xType = 'P' ) 
   Drop Proc sp_Proceso_IntegrarInventarioInterno_003___Almacen 
Go--#SQL 

Create Proc sp_Proceso_IntegrarInventarioInterno_003___Almacen  
( 
