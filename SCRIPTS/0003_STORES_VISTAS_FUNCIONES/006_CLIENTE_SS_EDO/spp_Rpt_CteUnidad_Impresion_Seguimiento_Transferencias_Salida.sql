If Exists( Select Name From SysObjects(NoLock) Where Name = 'spp_Rpt_CteUnidad_Impresion_Seguimiento_Transferencias_Salida' And xType = 'P' )
	Drop Proc spp_Rpt_CteUnidad_Impresion_Seguimiento_Transferencias_Salida
Go--#SQL 
...
Create Procedure spp_Rpt_CteUnidad_Impresion_Seguimiento_Transferencias_Salida
( 
...
------------------------ Obtener la informacion base 
	...
	Where E.IdEstado = @IdEstado And E.IdFarmacia = @IdFarmacia And E.TipoTransferencia = 'TS' 
...
--------------- Se elimina la tabla en caso de existir. 
	...
	Select * 
	Into Rpt_CteUnidad_Impresion_Seguimiento_Transferencias_Salida  
	From #tmpProceso 
