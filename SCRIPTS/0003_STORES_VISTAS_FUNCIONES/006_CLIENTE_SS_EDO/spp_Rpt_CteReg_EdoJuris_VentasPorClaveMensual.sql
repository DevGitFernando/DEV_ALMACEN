...
--- 
	...
	Group by 
		T.IdEmpresa, T.IdEstado, F.Estado, T.IdJurisdiccion, F.Jurisdiccion, T.IdFarmacia, F.Farmacia, T.Año, T.Mes, 
...
*/ 
	...
	If @EsConcentrado = 1 
		Begin 
		   Select 
				'Núm. Juris' = IdJurisdiccion, Jurisdiccion, -- 'Unidad' = IdFarmacia, Farmacia, 
				ClaveSSA, 'Descripción Clave' = DescripcionClave, 'Tipo de dispensación' = DescTipoDispensacion, 
				'Precio licitación' = PrecioLicitacion, 
