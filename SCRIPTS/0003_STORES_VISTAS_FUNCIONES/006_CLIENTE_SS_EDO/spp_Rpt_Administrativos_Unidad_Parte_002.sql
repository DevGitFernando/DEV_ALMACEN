If Exists ( Select * From sysobjects (nolock) Where Name = 'spp_Rpt_Administrativos_Unidad_Parte_002' and xType = 'P' ) 
   Drop Proc spp_Rpt_Administrativos_Unidad_Parte_002 
Go--#SQL

Create Proc spp_Rpt_Administrativos_Unidad_Parte_002 
(   
...
--	From RptAdmonDispensacion_Unidad B (NoLock) 
	...
	if @TipoInsumoMedicamento <> 0 
	   Begin
	      if @TipoInsumoMedicamento = 1 
	         Delete from RptAdmonDispensacion_Unidad Where EsSeguroPopular = 2 
	         
	      if @TipoInsumoMedicamento = 2 
	         Delete from RptAdmonDispensacion_Unidad Where EsSeguroPopular = 1 	         
	   End  
