...
------------------------------------------------------------------------------------------------------------------------------------------- 
If Exists( Select Name From SysObjects(NoLock) Where Name = 'spp_Rpt_CteReg_Impresion_Seguimiento_Transferencias_Entrada' And xType = 'P' )
	Drop Proc spp_Rpt_CteReg_Impresion_Seguimiento_Transferencias_Entrada
Go--#SQL 

--	Exec   spp_Rpt_CteReg_Impresion_Seguimiento_Transferencias_Entrada  '21', '1188', '2012-10-01', '2012-11-12', '0', '0'  

Create Procedure spp_Rpt_CteReg_Impresion_Seguimiento_Transferencias_Entrada
( 
	@IdEstado varchar(2) = '21', @IdFarmacia varchar(4) = '1188', 
...
--		spp_Rpt_CteReg_Impresion_Seguimiento_Transferencias_Entrada 
...
------------------------ Completar la informacion de registro 
	...
	Update R Set FarmaciaRecibe = F.Farmacia, EsAlmacenRecibe = F.EsAlmacen  
	From #tmpProceso R 
...
--------------- Se elimina la tabla en caso de existir. 
	...
	Select * 
	Into Rpt_CteReg_Impresion_Seguimiento_Transferencias_Entrada  
	From #tmpProceso 
