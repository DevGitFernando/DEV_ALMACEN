If Exists ( Select * From sysobjects (nolock) Where Name = 'spp_Rpt_CteUnidad_Impresion_Proximos_Caducar' and xType = 'P' ) 
   Drop Proc spp_Rpt_CteUnidad_Impresion_Proximos_Caducar 
Go--#SQL

Create Proc spp_Rpt_CteUnidad_Impresion_Proximos_Caducar ( @IdEmpresa varchar(3) = '', @IdEstado varchar(2) = '', @IdFarmacia varchar(4) = '', 
...
Declare @sEncPrinRpt varchar(200), 
	...
	If Exists( Select Name From SysObjects(NoLock) Where Name = 'Rpt_CteUnidad_Impresion_Proximos_Caducar' And xType = 'U' )
	  Begin
		Drop Table Rpt_CteUnidad_Impresion_Proximos_Caducar
	  End

	-- Se obtiene el Encabezado Principal y el Encabezado Secundario
	Select @sEncPrinRpt = EncabezadoPrincipal, @sEncSecRpt = EncabezadoSecundario From fg_Unidad_EncabezadoReportesClientesSSA()
	...
	Into Rpt_CteUnidad_Impresion_Proximos_Caducar 	
	...
	Set @sSql = 
		' Insert Into Rpt_CteUnidad_Impresion_Proximos_Caducar ( EncPrincipal, EncSecundario, IdEmpresa, Empresa, IdEstado, Estado, IdFarmacia, Farmacia, IdClaveSSA_Sal, ClaveSSA, DescripcionSal, 
