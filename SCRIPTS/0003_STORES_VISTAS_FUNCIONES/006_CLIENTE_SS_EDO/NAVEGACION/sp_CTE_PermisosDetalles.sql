If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'sp_CTE_PermisosDetalles' and xType = 'P' )
   Drop proc sp_CTE_PermisosDetalles 
Go--#SQL 

Create Proc sp_CTE_PermisosDetalles ( @sArbol varchar(4) = 'VEN', @iRamaPadre int, @iNivel int = 1 output ) 
With Encryption 
As 
Begin 
	Set DateFormat YMD 
    ...
    WHILE ( @@FETCH_STATUS = 0 ) 
        BEGIN
            ...
            Begin
               ...
               Set @iNivel = @iNivel + 1
               Exec sp_CTE_PermisosDetalles @sArbol, @iRama, @iNivel out 
               Set @iNivel = @iNivel - 1
            End
