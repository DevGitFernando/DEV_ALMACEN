If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'sp_CTE_PermisosDetallesOrdenar' and xType = 'P' )
   Drop proc sp_CTE_PermisosDetallesOrdenar 
Go--#SQL  

Create Proc sp_CTE_PermisosDetallesOrdenar ( @sArbol varchar(4) = 'COM', @iRamaPadre int, @iNivel int = 1 output ) 
with Encryption 
As 
Begin 
	Set DateFormat YMD 
    ...
    WHILE ( @@FETCH_STATUS = 0 ) 
        BEGIN
            ...
            Begin
               ...
               Set @iNivel = @iNivel + 1
               Exec sp_CTE_PermisosDetallesOrdenar @sArbol, @iRama, @iNivel out 
               Set @iNivel = @iNivel - 1
            End
