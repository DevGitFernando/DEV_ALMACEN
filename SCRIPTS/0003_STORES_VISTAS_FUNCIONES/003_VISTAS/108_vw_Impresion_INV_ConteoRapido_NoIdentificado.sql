----------------------------------------------------------------------------------------------------------------------------     
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'vw_Impresion_INV_ConteoRapido_NoIdentificado' and xType = 'V' ) 
   Drop View vw_Impresion_INV_ConteoRapido_NoIdentificado
Go--#SQL

Create View vw_Impresion_INV_ConteoRapido_NoIdentificado 
With Encryption 
As 
