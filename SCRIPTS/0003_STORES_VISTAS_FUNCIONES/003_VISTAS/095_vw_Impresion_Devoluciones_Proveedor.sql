...
If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'vw_Impresion_Devoluciones_Proveedor' and xType = 'V' ) 
	Drop View vw_Impresion_Devoluciones_Proveedor
Go--#SQL	

Create View vw_Impresion_Devoluciones_Proveedor 
With Encryption 
As 
	...
	From vw_DevolucionesProveedorEnc E (NoLock) 
	Inner Join DevolucionesProveedorDet D (NoLock) On ( E.IdEmpresa = D.IdEmpresa and E.IdEstado = D.IdEstado and E.IdFarmacia = D.IdFarmacia and E.Folio = D.FolioDevProv ) 
	Inner Join DevolucionesProveedorDet_Lotes L (NoLock) 
		On ( D.IdEmpresa = L.IdEmpresa and D.IdEstado = L.IdEstado and D.IdFarmacia = L.IdFarmacia and D.FolioDevProv = L.FolioDevProv 
