If Exists ( Select Name From Sysobjects (NoLock) Where Name = 'sp_GetPermisos_UsuariosDetalles' and xType = 'P' )
   Drop proc sp_GetPermisos_UsuariosDetalles 
Go--#SQL 

Create Proc sp_GetPermisos_UsuariosDetalles ( @sArbol varchar(4) = 'VEN', @iRamaPadre int, @iNivel int = 1 output ) 
With Encryption 
As 
Begin 
	Set DateFormat YMD 
    ...
    WHILE ( @@FETCH_STATUS = 0 ) 
        BEGIN
            ...
            Begin
               ...
               Set @iNivel = @iNivel + 1
               Exec sp_GetPermisos_UsuariosDetalles @sArbol, @iRama, @iNivel out 
               Set @iNivel = @iNivel - 1
            End
