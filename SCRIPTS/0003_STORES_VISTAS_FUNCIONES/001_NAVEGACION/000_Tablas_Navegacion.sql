...
--	IdEstado varchar(2) Not Null, 
	...
	Constraint PK_Net_Arboles Primary Key Clustered  ( Arbol )
) On [Primary]
Go--#SQL 
...
(
	...
	IdSucursal varchar(4) Collate Latin1_General_CI_AI Not Null, 
	...
	Actualizado tinyint Not Null Default 0, 
	Constraint Pk_Net_Usuarios Primary Key Clustered ( IdEstado, IdSucursal, IdPersonal )	
)
Go--#SQL 

Alter Table Net_Usuarios Add Constraint FK_CatPersonal_Net_Usuarios 
	Foreign Key ( IdEstado, IdSucursal, IdPersonal ) References CatPersonal ( IdEstado, IdFarmacia, IdPersonal ) 
Go--#SQL  
...
(
	...
	FechaUpdate datetime Not Null Default getdate(), 	
	Actualizado tinyint Not Null Default 0, 
	Constraint PK_Net_Grupos_De_Usuarios Primary Key Clustered  ( IdEstado, IdSucursal, IdGrupo )
) On [Primary]
Go--#SQL 

Alter Table Net_Grupos_De_Usuarios Add Constraint FK_CatFarmacias_NetGruposDeUsuarios 
	Foreign Key ( IdEstado, IdSucursal ) References CatFarmacias ( IdEstado, IdFarmacia ) 
Go--#SQL  
...
(
	...
	FechaUpdate datetime Not Null Default getdate(), 	
	Actualizado tinyint Not Null Default 0, 
	Constraint PK_Net_Grupos_Usuarios_Miembros Primary Key Clustered ( IdEstado, IdSucursal, IdGrupo, IdPersonal )  
) On [Primary]
Go--#SQL 

Alter Table Net_Grupos_Usuarios_Miembros Add Constraint FK_NetGruposDeUsuarios_NetGruposUsuariosMiembros 
	Foreign Key ( IdEstado, IdSucursal, IdGrupo ) References Net_Grupos_De_Usuarios ( IdEstado, IdSucursal, IdGrupo ) 
Go--#SQL  

Alter Table Net_Grupos_Usuarios_Miembros Add Constraint FK_Net_Usuarios_NetGruposUsuariosMiembros 
	Foreign Key ( IdEstado, IdSucursal, IdPersonal ) References Net_Usuarios ( IdEstado, IdSucursal, IdPersonal ) 
Go--#SQL  
...
(
	...
	Status varchar(1) Collate Latin1_General_CI_AI Not Null Default 'A', 
	Actualizado tinyint Not Null Default 0, 	
	Constraint PK_Net_Navegacion Primary Key Clustered  ( Arbol, Rama )	
) On [Primary]
Go--#SQL 
...
(
	...
	FechaUpdate datetime Not Null Default getdate(), 	
	Actualizado tinyint Not Null Default 0, 	
	Constraint PK_Net_Privilegios_Grupo Primary Key Clustered  ( IdEstado, IdSucursal, IdGrupo, Arbol, Rama )	
) On [Primary]
Go--#SQL 
