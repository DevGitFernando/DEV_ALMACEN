...
If Exists( Select Name From SysObjects(NoLock) Where Name = 'spp_Rpt_Consulta_Ventas_Estado' And xType = 'P' ) 
	Drop Proc spp_Rpt_Consulta_Ventas_Estado
Go--#SQL

Create Procedure spp_Rpt_Consulta_Ventas_Estado ( @IdEstado varchar(2), @FechaInicial varchar(10), @FechaFinal varchar(10), @EsDeConsignacion varchar(1) )
With Encryption
As
Begin
	/*	@EsDeConsignacion 
	...
	*/
	...
	Where V.IdEstado = @IdEstado And V.TipoDeVenta = '2' And Convert( varchar(10), V.FechaSistema, 120 ) Between @FechaInicial And @FechaFinal 
