If Exists( Select Name From SysObjects(NoLock) Where Name = 'spp_ADMI_Impresion_Productos_TransferenciasEntrada' And xType = 'P' )
	Drop Proc spp_ADMI_Impresion_Productos_TransferenciasEntrada
Go--#SQL 

Create Procedure spp_ADMI_Impresion_Productos_TransferenciasEntrada
...
Begin
	...
	Where E.IdEmpresa = @IdEmpresa And E.IdEstado = @IdEstado And E.IdFarmacia = @IdFarmacia And E.TipoTransferencia = 'TE' -- And L.ClaveLote Like '%*%'
	...
	-------------------------------------------------------	
	If Exists ( Select Name From SysObjects(NoLock) Where Name = 'tmpADMI_Productos_TransferenciaEntrada' And xType = 'U' )
	  Begin
		Drop Table tmpADMI_Productos_TransferenciaEntrada
	  End	
	
	Select *
	Into tmpADMI_Productos_TransferenciaEntrada
	...
	Select * From tmpADMI_Productos_TransferenciaEntrada(NoLock) Order By IdFarmacia, DescripcionSal
End
Go--#SQL 
