...
As 
	...
	Select L.IdProveedor, P.Nombre, 
		   L.IdClaveSSA, C.ClaveSSA, C.DescripcionSal as DescripcionClave, 
	...
	Inner Join vw_Productos_CodigoEAN C (NoLock) On ( L.IdClaveSSA = C.IdClaveSSA_Sal and L.CodigoEAN = C.CodigoEAN ) 
