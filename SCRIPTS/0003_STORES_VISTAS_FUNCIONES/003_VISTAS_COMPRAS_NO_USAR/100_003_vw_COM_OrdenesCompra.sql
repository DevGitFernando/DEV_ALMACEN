...
As
	Select M.IdEmpresa, Ex.Nombre as Empresa, M.IdEstado, E.Nombre as Estado, E.ClaveRenapo, M.IdFarmacia, F.NombreFarmacia as Farmacia, 
		 M.FolioOrdenCompra as Folio, M.FolioOrdenCompraReferencia, M.FolioMovtoInv, 
		 M.IdPersonal, vP.NombreCompleto as NombrePersonal, M.FechaRegistro, M.FechaSistema, 
		 M.IdProveedor, P.Nombre as Proveedor, M.ReferenciaDocto, M.FechaDocto, M.FechaVenceDocto, M.Observaciones, 
		 M.SubTotal, M.Iva, M.Total, M.FechaPromesaEntrega,  
		 M.Status  
...
As 	
	...
	Select E.IdEmpresa, E.Empresa, E.IdEstado, E.Estado, E.ClaveRenapo, E.IdFarmacia, E.Farmacia, L.IdSubFarmacia, F.SubFarmacia,
