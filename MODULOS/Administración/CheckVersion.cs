...
namespace Administracion
{
    public class CheckVersion
    {
        ...
        private string sModuloUpdater = "Updater Administración.exe";
        ...
        public CheckVersion(string Modulo, string Version, bool ServidorLocal)
        {
            ...
            sServidorLocal = ServidorLocal ? "1" : "0";
        ...
        {
            string sFile = Path.Combine(Application.StartupPath, "Updater Administración.exe");
        ...
        private bool RevisarVersionUpdater()
        {
            ...
            byte[] Buffer;
            clsLeer leer = new clsLeer();
            clsDatosCliente datosDeCliente = new clsDatosCliente(GnAdministracion.DatosApp, "", "");
