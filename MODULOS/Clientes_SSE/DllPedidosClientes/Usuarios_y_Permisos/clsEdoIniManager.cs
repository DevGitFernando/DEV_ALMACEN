...
namespace DllPedidosClientes.Usuarios_y_Permisos
{
    ...
    public class clsEdoIniManager
    {
        ...
        public bool ExisteArchivo()
        {
            ...
            if (! Dir.Exists )
            {
                ...
                if (Frm.bAceptar)
                {
                    ...
                    AgregarValuesDefault(sUsarWebService, sServer, sWebService, sPaginaASMX, "", "", "", "", "0");
                    pDataSetConfig.WriteXml(strFilePath);
                }
                else
                    bRegresa = false;
        ...
        private void AgregarValuesDefault(string UsarCnnWeb, string Servidor, string WebService, string PaginaAsmx, 
            string IdEmpresa, string IdEstado, string IdSucursal, string Usuario, string TipoImpresion)
        {
            object[] objValues = { UsarCnnWeb, Servidor, WebService, PaginaAsmx, IdEmpresa, IdEstado, IdSucursal, Usuario, TipoImpresion };
