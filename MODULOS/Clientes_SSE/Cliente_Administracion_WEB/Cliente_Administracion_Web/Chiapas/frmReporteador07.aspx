<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmReporteador07.aspx.cs" Inherits="Chiapas_frmReporteador07" %>
...
<head runat="server">
    ...
    <%--<% { Response.Write("<link rel=\"stylesheet\" type=\"text/css\" href=\"../css/" + DtGeneral.EstadoConectado + ".css\" />"); } %>--%>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
         ...
         $(function () {
             ...
             $("#dtpFechaInicial").datepicker("setDate", "2015-12-01");
