...
public partial class Chiapas_frmPenalizacionTapachula : BasePage
{
    ...
    private void DumpExcel(string sData)
    {
        ...
        {
            DataSet dtsExcel = (DataSet)Session["Penalizaciones"];
            ...
            string sFarmacia = "0011 -- HOSPITAL REGIONAL DE ALTA ESPECIALIDAD";

            sTituloPeriodo = string.Format("Resumen de Penalizaciones 2015");
