<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_UNI_RPT__011__Estupefacientes_Psicotropicos.aspx.cs" Inherits="Unidosis_frm_BI_UNI_RPT__011__Estupefacientes_Psicotropicos" %>
...
<body>
    <form id="frm_BI_UNI_RPT__011__Estupefacientes_Psicotropicos" runat="server">
    ...
    <div id="container" class="container">
        <div id="Info"class="Controls cont">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div id="Servicio" class="m-input-prepend">
                    <label class="m-wrap inline">
                        <span class="fechaspan">Servicio : </span>
                        <input type="text" class="m-wrap" id="txtServicio" value="" placeholder="Servicio" maxlength="200" />
                    </label>
                </div>
                <div class="clear"></div>
                <div class="m-input-prepend">
