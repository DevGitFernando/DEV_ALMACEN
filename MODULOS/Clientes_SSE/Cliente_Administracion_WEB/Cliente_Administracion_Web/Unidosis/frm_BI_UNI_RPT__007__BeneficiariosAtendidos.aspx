<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_UNI_RPT__007__BeneficiariosAtendidos.aspx.cs" Inherits="Unidosis_frm_BI_UNI_RPT__007__BeneficiariosAtendidos" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="https://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BeneficiariosAtendidos</title>
...
<body>
    <form id="frm_BI_UNI_RPT__007__BeneficiariosAtendidos" runat="server">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div id="Procedencia" class="m-input-prepend">
                    <label class="m-wrap inline">
                        ...
                        <input type="text" class="m-wrap" id="txtServicio" value="" placeholder="Servicio" maxlength="100" />
                    </label>
                </div>
           </div>
        </div>
