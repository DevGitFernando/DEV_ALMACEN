<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmRegistroDePedidos.aspx.cs" Inherits="Pedidos_Especiales_frmRegistroDePedidos" %>
                ...
                <div id="FechaRegistro" class="Textbox Unique m-input-prepend HaveLegend">
                    <label class="m-wrap">
                        ...
                        <input type="text" class="m-wrap" id="dtpFechaRegistro" value="" 
                         placeholder="2013-08-14" maxlength="10" tabindex="2" runat="server" disabled="disabled"/>
                    </label>
                </div>
                <div id="ComboPA" class="Textbox Unique m-input-prepend fullWidth" runat="server"></div>
                <div id="ComboB" class="Textbox Unique m-input-prepend fullWidth" runat="server"></div>
                <div class="Textbox Unique m-input-prepend">
                    <label class="m-wrap">
                        <span class="add-on">Folio documento :</span>
                        <input type="text" class="m-wrap numeric" id="txtReferencia" value="" 
                         placeholder="Folio documento" maxlength="200" tabindex="1" title="Folio de referencia."/>
                    </label>
                </div>
                <div class="Textbox Unique m-input-prepend fullWidth">
                    <label class="m-wrap">
                        <span class="add-on">Observaciones :</span>
                        <textarea  id="txtObservaciones" class="m-wrap" cols="" rows="" tabindex="3" maxlength="200" disabled></textarea>
                    </label>
                </div>
            </div>
        </div>
        <%--<div class="Controls cont">
            <div id="InfoPrograma" class="Groups">
                <span class="labelGpoleft">Información Programa</span>
                <div id="ComboPA" class="checkbox m-wrap inline" runat="server">
                </div>
                <div id="ComboB" class="checkbox m-wrap inline" runat="server">
                </div>
            </div>
        </div>--%>
