...
public partial class DllClienteRegionalWeb_FrmAntibioticosControlados : BasePage
{
    ...
    {
        DataSet dtsExcel = (DataSet)Session["AntibioticosControlados"];
        ...
        string sPlantilla = DtGeneral.GetNombrePlantilla(DtGeneral.ListaPlantillas.Salidas_Antibioticos_Controlados);
