<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmInformacionVales.aspx.cs" Inherits="DllClienteRegionalWeb_FrmInformacionVales" %>
...
<body>
    <form id="FrmInformacionVales" runat="server">
    ...
    <div id="container" class="container">
        <div class="Controls">
           <div class="Combo m-input-prepend">
                <label class="m-wrap">
           ...
           <div class="Groups">
                <label class="m-radio m-wrap">
                    <input type="radio" class="m-wrap" name="Clave" id="rbTodasLasClaves" value="Todas las claves" />
                    Todas las claves
                </label>
                <label class="m-radio m-wrap">
                    <input type="radio" class="m-wrap" name="Clave" id="rbClave" value="Clave" />
                    Clave
                </label>
           </div>
           <div class="Radio">
                <label class="m-radio m-wrap">
                    Farmacias con convenio. (Ver)
                </label>
            </div>
        </div>
        <div class="Results">
