<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmMedicosDiagnosticos.aspx.cs" Inherits="DllClienteRegionalWeb_FrmMedicosDiagnosticos" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Consumos  Medicos -- Diagnosticos por  Claves</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if(opcDate) { $("#dtpFechaInicial").datepicker("option", "dateFormat", "yy-mm-dd"); }
            ...
            if(opcDate) { $("#dtpFechaFinal").datepicker("option", "dateFormat", "yy-mm-dd"); }
...
<body>
    <form id="frmMedicosDiagnostico" runat="server">
    ...
    <div id="container" class="container">
        <div class="Controls cont">
            ...
            <div id="Insumos" class="Groups">
                <span class="labelGpoleft">Filtros de parámetros</span>
                <label class="m-checkbox m-wrap inline">
                    <input id="chkClaves" type="checkbox" class="m-wrap" value="" checked/>
                        Claves
                </label>
                <label class="m-checkbox m-wrap inline">
                    <input id="chkDiagnosticos" type="checkbox" class="m-wrap" value=""/>
                        Diagnósticos
                </label>
                <label class="m-checkbox m-wrap inline">
                    <input id="chkMedicos" type="checkbox" class="m-wrap" value=""/>
                        Médicos
                </label>
            </div>
