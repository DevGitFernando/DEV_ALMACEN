<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmCostoPacienteProgramaDeAtencion.aspx.cs" Inherits="DllClienteRegionalWeb_FrmCostoPacienteProgramaDeAtencion" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Costo por paciente por Programa de Atención</title>
...
//                }
//            });
//            $("#dtpFechaInicial").datepicker("option", $.datepicker.regional["es"]);
//            $("#dtpFechaInicial").datepicker("option", "dateFormat", "yy-mm-01");
            $("#dtpFechaInicial").datepicker('setDate', '-1m');
...
<body>
    <form id="FrmCostoPacienteProgramaDeAtencion" runat="server">
        ...
        <div class="Controls cont">
            ...
            <div id="Insumos" class="Groups">
                ...
                <label class="m-radio m-wrap">
                    <input type="radio" class="m-wrap" name="tipoReporte" id="rdoConcentradoFarmacias" value="1" checked/>
                    Concentrado por farmacia
                </label>
                <label class="m-radio m-wrap">
                    <input type="radio" class="m-wrap" name="tipoReporte" id="rdoConcentradoProgramaDeAtencion" value="2"/>
                    Concentrado por programa de atención
                </label>
            </div>
        </div>
        <div class="Results">
