    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function designGroups(val) {
                ...
                $.ajax({
                    url: "../DllClienteRegionalWeb/ws_General.aspx/designGroups",
                    type: 'POST',
                    dataType: 'json',
            ...
            function AddRelaciones(Grupo, Opcion, Tipo, ui, $ulLista) {
                ...
                sWebService = '../DllClienteRegionalWeb/ws_General.aspx/ManageRel';
...
<body>
    ...
    <div id="containerPerfiles" class="container">
        <div id="Info" class="Controls cont">
            ...
            <div id="Groups" class="Groups" runat="server">
                <span class="labelGpoleft">Perfil</span>
            </div>
