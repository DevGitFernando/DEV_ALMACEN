...
( 
	...
	@IdFarmacia varchar(4) = '0111', @TipoMovto int = 0, @ClaveSSA varchar(50) = '010.000.1711.00', --010.000.0101.00',  
	@FechaInicial varchar(10) = '2018-04-10', @FechaFinal varchar(10) = '2018-04-13',  
...
----------------------------------------------------- DATOS FILTRO 
	...
	From vw_Productos_CodigoEAN__PRCS 
...
----------------------------------------------------- OBTENCION DE DATOS  
	...
	( 
		Select 
			...
			min(D.Keyx) as MovtoInicial, max(D.Keyx) as MovtoFinal, 
			0 as ExistenciaInicial, 0 as ExistenciaFinal, 
...
------------------------------- Obtener las existencias iniciales y finales 		
	...
	-- select 'aqui', * from #tmp_Movimientos 
...
--		spp_BI_RPT__003__Entradas_y_Salidas	
	...
	Select 
		...
		P.ClaveSSA, cast('' as varchar(5000)) as NombreGenerico, P.DescripcionClave, 
