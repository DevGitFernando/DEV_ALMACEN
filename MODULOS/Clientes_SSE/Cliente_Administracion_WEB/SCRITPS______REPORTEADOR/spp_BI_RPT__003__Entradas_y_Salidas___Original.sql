...
( 
	...
	@IdFarmacia varchar(4) = '25', @TipoMovto int = 0, @ClaveSSA varchar(20) = '', 
	@FechaInicial varchar(10) = '2017-02-01', @FechaFinal varchar(10) = '2017-02-28'	
) 
As 
Begin 
Set DateFormat YMD 
...
------------------------------- Obtener las existencias iniciales y finales 		
	...
	---- Comentariar 
	--Select D.IdEmpresa, D.IdEstado, D.IdFarmacia, D.IdProducto, D.CodigoEAN, max(D.Keyx) as MaxKeyx, cast( 0 as int ) as UltimaExistencia 
	...
	--Select D.IdEmpresa, D.IdEstado, D.IdFarmacia, D.IdProducto, D.CodigoEAN, L.ClaveLote, max(L.Keyx) as MaxKeyx, cast( 0 as int ) as UltimaExistencia 
	...
	--	and E.IdEmpresa = @IdEmpresa 
	--Group by D.IdEmpresa, D.IdEstado, D.IdFarmacia, D.IdProducto, D.CodigoEAN, L.ClaveLote 
	------ Comentariar 
------------------------------- Obtener las existencias iniciales y finales 		
...
------------------------------- Obtener las existencias iniciales y finales 	
	...
	--From #tmp_Movimientos M  
	--Inner Join MovtosInv_Det_CodigosEAN_Lotes D (NoLock) On ( M.MovtoInicial = D.Keyx ) 
	
	--Update M Set ExistenciaFinal = D.Existencia 
	--From #tmp_Movimientos M  
	--Inner Join MovtosInv_Det_CodigosEAN_Lotes D (NoLock) On ( M.MovtoFinal = D.Keyx ) 
	------ Comentariar 
------------------------------- Obtener las existencias iniciales y finales 	
