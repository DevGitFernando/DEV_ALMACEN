------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_BI_RPT__001__Existencias_vs_Maximos_y_Minimos__002___UnaFecha' and xType = 'P' ) 
   Drop Proc spp_BI_RPT__001__Existencias_vs_Maximos_y_Minimos__002___UnaFecha 
Go--#SQL 

Create Proc spp_BI_RPT__001__Existencias_vs_Maximos_y_Minimos__002___UnaFecha 
( 
	@IdEmpresa varchar(3) = '001', 
	@IdEstado varchar(2) = '13', @IdMunicipio varchar(4) = '*', @IdJurisdiccion varchar(3) = '*', 
	@IdFarmacia varchar(4) = '0111', 
	@Fecha  varchar(10) = '2018-04-15' 
) 
As 
Begin 
Set DateFormat YMD 
...
------------------------------------------ Generar tablas de catalogos  
	...
	--Set @IdFarmacia = right('00000' + @IdFarmacia, 34 
...
---------------------		spp_BI_RPT__001__Existencias_vs_Maximos_y_Minimos__002___UnaFecha  
...
----------------------------------------------------- OBTENCION DE DATOS  
	...
	Select 
		...
		P.IdClaveSSA_Sal as IdClaveSSA, E.ClaveSSA, E.ClaveSSA as ClaveSSA_Fisica, 0 as EsRelacionada,  
	...
	Group by 
		E.IdEmpresa, E.IdEstado, E.IdFarmacia, 
		P.IdClaveSSA_Sal, E.ClaveSSA, P.DescripcionClave, P.Presentacion, P.TipoDeClave, P.TipoDeClaveDescripcion  
	...
	--Update E Set CantidadMinima = (M.CantidadMinima / (M.MesesContenidos * 1.0)), CantidadMaxima = (M.CantidadMaxima)  
	Update E Set CantidadMinima = M.CantidadMinima, CantidadMaxima = M.CantidadMaxima 
	From #tmp_Existencia_A_Una_Fecha E 	
