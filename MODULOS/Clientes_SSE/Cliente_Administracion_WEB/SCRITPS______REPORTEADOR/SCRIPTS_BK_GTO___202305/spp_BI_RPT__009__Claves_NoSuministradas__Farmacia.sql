------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_BI_RPT__009__Claves_NoSuministradas__Farmacia' and xType = 'P' ) 
   Drop Proc spp_BI_RPT__009__Claves_NoSuministradas__Farmacia 
Go--#SQL 

Create Proc spp_BI_RPT__009__Claves_NoSuministradas__Farmacia 
( 
	@IdEmpresa varchar(3) = '001', 
	@IdEstado varchar(2) = '21', @IdMunicipio varchar(4) = '*', @IdJurisdiccion varchar(3) = '*', 
	@IdFarmacia varchar(4) = '3188', @ClaveSSA varchar(100) = '', 
	@Unidad_Beneficiario varchar(1000) = '', 
	@FechaInicial varchar(10) = '2018-01-01', @FechaFinal varchar(10) = '2018-01-15' 
) 
As 
Begin 
Set DateFormat YMD  
...
----------------------------------------------------- DATOS FILTRO 
	...
	Delete From #vw_Farmacias Where IdFarmacia = 5 
...
---------------------		spp_BI_RPT__009__Claves_NoSuministradas__Farmacia  
