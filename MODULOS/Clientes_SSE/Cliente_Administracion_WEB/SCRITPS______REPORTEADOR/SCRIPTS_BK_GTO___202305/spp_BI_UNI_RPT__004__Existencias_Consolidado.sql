------------------------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_BI_UNI_RPT__004__Existencias_Consolidado' and xType = 'P' ) 
   Drop Proc spp_BI_UNI_RPT__004__Existencias_Consolidado 
Go--#SQL 

Create Proc spp_BI_UNI_RPT__004__Existencias_Consolidado  
( 
	@IdEmpresa varchar(3) = '001', 
	@IdEstado varchar(2) = '13', @IdMunicipio varchar(4) = '', @IdJurisdiccion varchar(3) = '', 
	@IdFarmacia varchar(4) = '13', 
	@Fecha  varchar(10) = '2017-06-28' 
) 
As 
Begin 
Set DateFormat YMD 
...
---------------------		spp_BI_UNI_RPT__004__Existencias_Consolidado  
...
--	Select * From #tmp_Existencia_A_Una_Fecha___Movtos 
	...
	Select 
		...
		'Cantidad' = sum(Existencia),   
		'Procedencia' = Procedencia, 
		'Fuente de financiamiento' = FuenteDeFinanciamiento 
	From #tmp_Existencia_A_Una_Fecha 
	Group By ClaveSSA, DescripcionClave, Presentacion, Laboratorio, TipoDeClaveDescripcion, Procedencia, FuenteDeFinanciamiento
	Order By   
		ClaveSSA, DescripcionClave, Presentacion, Laboratorio, TipoDeClaveDescripcion, Procedencia, FuenteDeFinanciamiento 
