--------------------------------------------------------------------------------------------------------------------------------------------  
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_BI_RPT__003__Entradas_y_Salidas___TEST' and xType = 'P' ) 
   Drop Proc spp_BI_RPT__003__Entradas_y_Salidas___TEST 
Go--#SQL 

/* 

	Exec spp_BI_RPT__003__Entradas_y_Salidas___TEST 
		@IdEmpresa = '001', 
...
Create Proc spp_BI_RPT__003__Entradas_y_Salidas___TEST  
( 
	@IdEmpresa varchar(3) = '001', 
	@IdEstado varchar(2) = '22', @IdMunicipio varchar(4) = '*', @IdJurisdiccion varchar(3) = '', 
	@IdFarmacia varchar(4) = '', @TipoMovto int = 0, @ClaveSSA varchar(50) = '', --010.000.0101.00',  
	@FechaInicial varchar(10) = '2019-02-01', @FechaFinal varchar(10) = '2021-05-17',  
...
-----		spp_BI_RPT__003__Entradas_y_Salidas___TEST
...
----------------------------------------------------- SALIDA FINAL 
	...
	If Exists ( Select * from sysobjects (nolock) Where name = 'Kardex___20210518_1250' and xType = 'U' ) Drop Table Kardex___20210518_1250 

	Select * 
	Into Kardex___20210518_1250 
