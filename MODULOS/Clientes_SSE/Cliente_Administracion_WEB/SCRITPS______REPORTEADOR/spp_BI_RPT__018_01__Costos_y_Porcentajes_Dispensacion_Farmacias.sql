...
----------------------------------------------------- OBTENCION DE DATOS  
	Select 
		...
		round(cast(sum((D.CantidadRequerida + D.CantidadEntregada) * P.PrecioUnitario) as numeric(14,4)), 2) as Costo_Recetado, 		
		...
		cast(0 as numeric(14,2)) as Porcentaje_CostoDispensado, 
		cast(0 as numeric(14,2)) as Porcentaje_CostoNoDispensado 
	...
	Update P Set 
		Porcentaje_Dispensado = (case when CantidadRecetada > 0 Then round((CantidadEntregada / CantidadRecetada) * 100, 2) Else 0 End) , 
		Porcentaje_NoDispensado = (case when CantidadRecetada > 0 Then round((CantidadNoEntregada / CantidadRecetada) * 100, 2) Else 0 End),   
		Porcentaje_CostoDispensado = (case when Costo_Recetado > 0 Then round((Costo_Dispensado / Costo_Recetado) * 100, 2) Else 0 End), 
		Porcentaje_CostoNoDispensado = (case when Costo_Recetado > 0 Then round((Costo_NoDispensado / Costo_Recetado) * 100, 2) Else 0 End)    
