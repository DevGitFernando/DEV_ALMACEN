...
<head runat="server">
    ...
    <link type="text/css" rel="stylesheet" href="css/components.css?v=0.2.3">
    <link type="text/css" rel="stylesheet" href="css/jquery-ui.min.css">
    <link type="text/css" rel="stylesheet" href="css/001/main.css?v=0.2.3">
...
<body>
        ...
        <div id="wrapper" class="fullSize">
            ...
            <div id="nav" class="leftside">
                <div class="profile">
                    ...
                    <div id="btnDiploma" class="title" runat="server">Diploma</div>
    ...
    <%
        string sVersion = DateTime.Now.ToString("yyyyMMddHHmmss");
    %>
    <script type="text/javascript" src="js/jquery.js"></script>
    <script type="text/javascript" src="js/jquery-ui.min.js"></script>
    <script type="text/javascript" src="js/toastr.js"></script>
    <script type="text/javascript" src="js/general.js?v=<%Response.Write(sVersion);%>"></script>
    <script type="text/javascript" src="js/reports.js?v=<%Response.Write(sVersion);%>"></script>
    <script type="text/javascript" src="js/forms.js?v=<%Response.Write(sVersion);%>"></script>
    <script type="text/javascript" src="js/main.js?v=<%Response.Write(sVersion);%>"></script>
