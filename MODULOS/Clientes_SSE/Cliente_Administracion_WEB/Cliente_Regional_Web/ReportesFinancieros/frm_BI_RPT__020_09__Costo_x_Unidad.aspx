<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_RPT__020_09__Costo_x_Unidad.aspx.cs" Inherits="ReportesFinancieros_frm_BI_RPT__020_09__Costo_x_Unidad" %>
...
<body>
    <form id="frm_BI_RPT__020_09__Costo_x_Unidad" runat="server">
            ...
            <div id="InfoUnidad" class="Groups">
                ...
                <div id="Combos" class="Combo m-input-prepend" runat="server">
                    ...
                    <label class="m-wrap">
                        ...
                        <select id="cboFarmacia" class="m-wrap" disabled></select>
                    </label>
                    <div class="clear"></div>
                </div>
            </div>
