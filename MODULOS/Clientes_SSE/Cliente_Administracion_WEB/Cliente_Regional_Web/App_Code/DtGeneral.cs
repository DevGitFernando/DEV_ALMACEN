...
public static class DtGeneral
{
    ...
    static string sVersion = "0.9.2.0";
    ...
    private static readonly string sArchivoIniConexion = "SII-Regional";
    private static string sNombreCookie = "cteRegional";
    ...
    public static void GetInfoUnidad()
    {
        ...
        string sSql = string.Format("Select * From vw_Farmacias (Nolock) " +
                                    ...
                                    "Where IdEstado = '{0}' And IdFarmacia = '{1}'", IdEstado, ObtenerValorCookie("IdSucursal"));
        ValidarLeer();
    ...
    public static void GetJurisdicciones()
    {
        ...
        if (ObtenerValorCookie("IdSucursal") != "0001")
        {
            ...
            sFiltro = string.Format("And IdJurisdiccion = '{0}'", ObtenerValorCookie("Jurisdiccion"));
        }
    ...
    public static string GetUsers()
    {
        ...
        sSql = string.Format("Select IdUsuario, Nombre, Login, Status From Net_Regional_Usuarios (NoLock) " +
                            ...
                            "Where IdEstado = '{0}' And IdFarmacia = '{1}' And Status ='A'", DtGeneral.IdEstado, ObtenerValorCookie("IdSucursal"));
    ...
    /// <summary>
    /// Obtiene el valor de la coookie previamente configurada en sNombreCookie
    /// </summary>
    ...
    static public string ObtenerValorCookie(string sKey)
    {
        ...
        sValue = myDictionary.Search(sKey);
