<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_RPT__015__Medicamentos_Prescritos_x_Medico.aspx.cs" Inherits="Generales_spp_BI_RPT__015__Medicamentos_Prescritos_x_Medico" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="https://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Estupefacientes_Psicotropicos</title>
...
<body>
    <form id="spp_BI_RPT__015__Medicamentos_Prescritos_x_Medico" runat="server">
    ...
    <div id="container" class="container elementCenter">
        ...
        <div id="Info"class="Controls cont">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div class="m-input-prepend">
                    <label class="m-wrap">
                        <span class="add-on">CIE10 : </span>
                        <input type="text" class="m-wrap" id="txtCIE10" value="" placeholder="CIE10" maxlength="20" />
                    </label>
                </div>
                <div class="m-input-prepend">
                    <label class="m-wrap inline">
                        <span class="add-on">Diagnostico : </span>
                        <input type="text" class="m-wrap" id="txtDiagnostico" value="" placeholder="Diagnostico" maxlength="200" />
                    </label>
                </div>
           </div>
        </div>
