<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_RPT__009__Claves_NoSuministradas__Farmacia.aspx.cs" Inherits="Generales_frm_BI_RPT__009__Claves_NoSuministradas__Farmacia" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="https://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Claves_NoSuministradas__Farmacia</title>
...
<body>
    <form id="frm_BI_RPT__009__Claves_NoSuministradas__Farmacia" runat="server">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div class="m-input-prepend">
                    <label class="m-wrap inline">
                        ...
                        <input type="text" class="m-wrap" id="txtUnidad_Beneficiario" value="" placeholder="beneficiario o usuario" maxlength="1000" />
                    </label>
                </div>
                <div class="clear"></div>
                <div class="m-input-prepend">
                    <label class="m-wrap">
                        ...
                        <input type="text" class="m-wrap" id="txtNumeroDeReceta" value="" placeholder="Folio o número de receta" maxlength="200">
                    </label>
                </div>
           </div>
        </div>
