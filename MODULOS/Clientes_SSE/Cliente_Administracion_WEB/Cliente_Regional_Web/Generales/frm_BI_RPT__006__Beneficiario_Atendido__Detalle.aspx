<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_RPT__006__Beneficiario_Atendido__Detalle.aspx.cs" Inherits="Generales_frm_BI_RPT__006__Beneficiario_Atendido__Detalle" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="https://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Beneficiario_Atendido__Detalle</title>
...
<body>
    <form id="frm_BI_RPT__006__Beneficiario_Atendido__Detalle" runat="server">
    ...
    <div id="container" class="container elementCenter">
        <div class="titleFrm">Añadir Título aquí</div>
           ...
           <div id="Parametros" class="Groups">
                ...
                <div class="m-input-prepend">
                    <label class="m-wrap">
                        ...
                        <input type="text" class="m-wrap" id="txtNombreBeneficiario" value="" placeholder="Beneficiario" maxlength="200" />
                    </label>
                </div>
                <div class="clear"></div>
                <div class="m-input-prepend">
                    <label class="m-wrap">
                        ...
                        <input type="text" class="m-wrap" id="txtProgramaDeAtencion" value="" placeholder="Programa de atención" maxlength="200">
                    </label>
                </div>
           </div>
        </div>
