<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_RPT__008__Claves_Suministradas__Stock_01_Pedidos.aspx.cs" Inherits="frm_BI_RPT__008__Claves_Suministradas__Stock_01_Pedidos" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Claves_NoSuministradas__Stock</title>
...
<body>
    <form id="frm_BI_RPT__008_Claves_Suministradas__Stock_01_Pedidos" runat="server">
        ...
        <div id="container" class="container elementCenter">
            ...
            <div id="Info" class="Controls cont">
                ...
                <div id="Parametros" class="Groups">
                    ...
                    <div id="JurisdiccionEntrega" class="m-input-prepend" runat="server">
                        <label class="m-wrap inline">
                            <span class="add-on">Juris Entrega :</span>
                            <select id="cboJurisdiccionEntrega" class="m-wrap"></select>
                        </label>
                    </div>
                    ...
                    <div class="clear"></div>
                    <div id="Beneficiarios" class="m-input-prepend" runat="server">
                        <label class="m-wrap inline">
                            <span class="add-on">Clave Unidad:</span>
                            <select id="cboBeneficiarios" class="m-wrap"></select>
                        </label>
                    </div>
                    <div class="m-input-prepend">
                        <label class="m-wrap inline">
