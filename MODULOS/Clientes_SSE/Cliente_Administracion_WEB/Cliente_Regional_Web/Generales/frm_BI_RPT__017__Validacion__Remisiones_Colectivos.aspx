<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_RPT__017__Validacion__Remisiones_Colectivos.aspx.cs" Inherits="Generales_frm_BI_RPT__017__Validacion__Remisiones" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="https://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Validacion__Remisiones</title>
...
<body>
    <form id="frm_BI_RPT__017__Validacion__Remisiones" runat="server">
        ...
        <div id="Info"class="Controls cont">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div class="m-input-prepend">
                    <label class="m-wrap">
                        <span class="add-on Semaforizacion">Dispensación:</span>
                        <select id="cboTipoDeDispensacion" class="m-wrap" runat="server">
                            <option value="0">Todos</option>
                            <option value="1">Recetas</option>
                            <option value="2">Colectivos</option>
                        </select>
                    </label>
                </div>
                <div id="Procedencia" class="m-input-prepend">
                    <label class="m-wrap inline">
                        <span class="fechaspan">Referencia:</span>
                        <input type="text" class="m-wrap" id="txtRemision" value="" placeholder="Referencia" maxlength="200" />
                    </label>
                </div>
           </div>
        </div>
