<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_RPT__010__Vales_Emitidos.aspx.cs" Inherits="Generales_frm_BI_RPT__010__Vales_Emitidos" %>
...
<body>
    <form id="frm_BI_RPT__010__Vales_Emitidos" runat="server">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div id="Procedencia" class="m-input-prepend">
                    <label class="m-wrap inline">
                        ...
                        <input type="text" class="m-wrap" id="txtBeneficiario" value="" placeholder="Beneficiario" maxlength="200" style="width: 401px;" />
                    </label>
                </div>
           </div>
        </div>
