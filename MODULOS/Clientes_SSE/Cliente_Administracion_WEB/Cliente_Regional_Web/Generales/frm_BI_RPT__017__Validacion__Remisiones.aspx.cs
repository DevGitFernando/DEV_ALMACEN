...
public partial class Generales_frm_BI_RPT__017__Validacion__Remisiones : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (DtGeneral.IdEstado == "11")
            {
                cboTipoDeDispensacion.Disabled = true;
                cboTipoDeDispensacion.Items[1].Selected = true;
            }
            else
            {
                cboTipoDeDispensacion.Disabled = true;
                cboTipoDeDispensacion.Items[0].Selected = true;
            }
