<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_UNI_RPT__009__Claves_NoSuministradas__Farmacia_Unidosis.aspx.cs" Inherits="Unidosis_frm_BI_UNI_RPT__009__Claves_NoSuministradas__Farmacia_Unidosis" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "https://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="https://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Claves_NoSuministradas__Farmacia_Unidosis</title>
...
<body>
    <form id="frm_BI_UNI_RPT__009__Claves_NoSuministradas__Farmacia_Unidosis" runat="server">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div class="m-input-prepend">
                    <label class="m-wrap inline">
                        ...
                        <input type="text" class="m-wrap" id="txtUnidad_Beneficiario" value="" placeholder="Unidad Beneficiario" maxlength="1000" />
                    </label>
                </div>
                <div class="clear"></div>
                <div class="m-input-prepend">
                    <label class="m-wrap">
                        <span class="add-on"># Receta :</span>
                        <input type="text" class="m-wrap" id="txtFolioReceta" value="" placeholder="Folio de la receta" maxlength="100" />
                    </label>
                </div>
                <div class="m-input-prepend">
                    <label class="m-wrap inline">
                        <span class="add-on">Servicio :</span>
                        <input type="text" class="m-wrap" id="txtServicio" value="" placeholder="Servicio" maxlength="1000" />
                    </label>
                </div>
           </div>
        </div>
