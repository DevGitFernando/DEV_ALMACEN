<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_UNI_RPT__012__Medicamentos_Prescritos_x_Medico.aspx.cs" Inherits="Unidosis_frm_BI_UNI_RPT__012__Medicamentos_Prescritos_x_Medico" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Medicamentos_Prescritos_x_Medico</title>
...
<body>
    <form id="frm_BI_UNI_RPT__012__Medicamentos_Prescritos_x_Medico" runat="server">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div class="m-input-prepend">
                    <label class="m-wrap inline">
                        ...
                        <input type="text" class="m-wrap" id="txtServicio" value="" placeholder="Área o Servicio" maxlength="200" />
                    </label>
                </div>
                <div class="m-input-prepend">
                    <label class="m-wrap inline">
                        <span class="add-on">Turno : </span>
                        <input type="text" class="m-wrap" id="txtTurno" value="" placeholder="Turno" maxlength="200" />
                    </label>
                </div>
                <div class="clear"></div>
           </div>
