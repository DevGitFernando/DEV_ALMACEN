<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_UNI_RPT__005__Entradas_y_Salidas.aspx.cs" Inherits="Unidosis_frm_BI_UNI_RPT__005__Entradas_y_Salidas" %>
...
<body>
    <form id="frm_BI_UNI_RPT__005__Entradas_y_Salidas" runat="server">
        ...
        <div id="Info"class="Controls cont">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div id="Procedencia" class="m-input-prepend">
                    <label class="m-wrap inline">
                        <span class="add-on">Fuente de Financiamiento :</span>
