<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frm_BI_UNI_RPT__014__Validacion__Remisiones.aspx.cs" Inherits="Unidosis_frm_BI_UNI_RPT__014__Validacion__Remisiones" %>
...
<body>
    <form id="frm_BI_UNI_RPT__014__Validacion__Remisiones" runat="server">
        ...
        <div id="Info"class="Controls cont">
           ...
           <div id="Parametros" class="Groups">
                ...
                <div class="m-input-prepend">
                    <label class="m-wrap inline">
                        <span class="add-on">Remision:</span>
                        <input type="text" class="m-wrap" id="txtRemision" value="" placeholder="Remision" maxlength="200" />
                    </label>
                </div>
                <div class="m-input-prepend">
                    <label class="m-wrap inline">
