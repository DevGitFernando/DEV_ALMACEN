...
public static class clsToolsHtml
{
    ...
    public static string OptionDropList(DataTable dtData, string sValue, string sText, int iTipoText, bool AddSelect, string sValueSelect, string sTextSelect)
    {
        ...
        if (AddSelect)
        {
            ...
            if (sTextSelect == "")
            {
                sTextSelect = "&lt;&lt; Seleccione &gt;&gt;";
            }
            sEstructura = string.Format("<option value=\"{0}\">{1}</option>", sValueSelect, sTextSelect);
        }
    ...
    static public string DtsToTableHtml(string sSql, string sIdTabla)
    {
        ...
        dtsTabla = DtGeneral.ExecQuery(sSql, "TableHTML", "clsToolsHtml DtsTotableHmtl");
