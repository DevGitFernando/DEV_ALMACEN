<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__019_018__ProgramacionDeConsumos.aspx.cs" Inherits="Generales_frm_BI_RPT__019_018__ProgramacionDeConsumos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 class="EncFormTitle">  Reporte de Programación de la DGSSA </h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Reporte1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
