<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__017__Validacion__Remisiones_Colectivos.aspx.cs" Inherits="frm_BI_RPT__017__Validacion__Remisiones_Colectivos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 id="EncFormTitle" class="EncFormTitle" runat="server">Solicitud colectiva de medicamento y material de curación</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Solicitud1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
        ...
        <dx:ASPxFormLayout runat="server" ID="Solicitud2" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Parámetros:" ColumnCount="5">
                    ...
                    <Items>
                        <dx:LayoutItem Caption="Dispensación" ColumnSpan="3">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox runat="server" ID="cboDispensacion" ClientInstanceName="cboDispensacion" EnableCallbackMode="false" Enabled="false"
                                        ValueType="System.String" ValueField="IdDispensacion" TextFormatString="{0} -- {1}"
                                        DropDownStyle="DropDown" Width="100%" AutoPostBack="false">
                                        <ValidationSettings RequiredField-IsRequired="true" Display="Dynamic" ValidationGroup="MyForm">
                                            <RequiredField IsRequired="True"></RequiredField>
                                        </ValidationSettings>
                                        <Items>
                                           <dx:ListEditItem Text="Colectivos" Value="2"  Selected="true" />
                                       </Items>
                                    </dx:ASPxComboBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
