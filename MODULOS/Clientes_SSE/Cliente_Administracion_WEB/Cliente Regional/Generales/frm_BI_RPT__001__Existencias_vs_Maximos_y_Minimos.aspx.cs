...
using System.IO;
//public partial class Generales_frm_BI_RPT__001__Existencias_vs_Maximos_y_Minimos : System.Web.UI.Page
public partial class Generales_frm_BI_RPT__001__Existencias_vs_Maximos_y_Minimos : BasePage
{
        ...
        if (IsPostBack)
        {
            switch (name)
            {
                case "Save":
                    ...
                    //https://www.intermedgto.mx:8443/BI/frameset?__report=RPT__001__Existencias_vs_Maximos_y_Minimos.rptdesign&IdEmpresa=001&IdEstado=11&IdMunicipio=0015&IdJurisdiccion=001&IdFarmacia=3012&Fecha=2021-11-08
                    
                    //string sUrlReporte = string.Format("{0}/frameset?__report={1}.rptdesign&IdEmpresa={2}&IdEstado={3}&IdMunicipio={4}&IdJurisdiccion={5}&IdFarmacia={6}&Fecha={7}",DtGeneral.ServidorBI, "RPT__001__Existencias_vs_Maximos_y_Minimos", DtGeneral.IdEmpresa, DtGeneral.IdEstado, cboLocalidad.Value.ToString(), cboJurisdiccion.Value.ToString(), cboFarmacia.Value.ToString(), dtFecha.ToString("yyyy-MM-dd"));

                    string sUrlReporte = "";                    
                    sUrlReporte = string.Format("{0}/frameset?__report={1}.rptdesign&", DtGeneral.ServidorBI, "RPT__001__Existencias_vs_Maximos_y_Minimos");
                    ...
                    sUrlReporte += string.Format("Fecha={0}", dtFecha.ToString("yyyy-MM-dd")); // el ultimo parámentro no requiere el & 
