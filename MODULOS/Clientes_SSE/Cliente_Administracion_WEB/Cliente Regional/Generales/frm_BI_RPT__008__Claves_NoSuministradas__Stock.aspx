<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__008__Claves_NoSuministradas__Stock.aspx.cs" Inherits="Generales_frm_BI_RPT__008__Claves_NoSuministradas__Stock" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 class="EncFormTitle">  Claves de medicamento y material de curación suministradas 
        por stock a la unidad médica conforme a su calendario y programación</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Claves1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Información de Unidad:" ColumnCount="5">
                    ...
                    <Items>
                        ...
                        <dx:LayoutItem Caption="Almacen" ColumnSpan="3">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                         ...
                         <%--<dx:LayoutItem Caption="Beneficiarios" ColumnSpan="3">
        ...
        <dx:ASPxFormLayout runat="server" ID="Claves2" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Parámetros:" ColumnCount="6">
                    ...
                    <Items>
                        <dx:LayoutItem Caption="Juris Entreg" ColumnSpan="3">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox runat="server" ID="cboJuris" ClientInstanceName="cboJuris" EnableCallbackMode="false"
                                        ValueType="System.String" ValueField="IdJuris" TextFormatString="{0} -- {1}"
                                        DropDownStyle="DropDown" Width="100%" AutoPostBack="false">
                                        <ValidationSettings RequiredField-IsRequired="true" Display="Dynamic" ValidationGroup="MyForm">
                                            <RequiredField IsRequired="True"></RequiredField>
                                        </ValidationSettings>
                                        <Items>
                                           <dx:ListEditItem Text="* -- Todas las jurisdicciones" Value="*"  Selected="true"/>
                                           <dx:ListEditItem Text="001 -- Guanajuato" Value="001" />
                                           <dx:ListEditItem Text="002 -- San Miguel de Allende" Value="002" />
                                           <dx:ListEditItem Text="007 -- León" Value="007" />
                                           <dx:ListEditItem Text="008 -- León delta" Value="008" />
                                       </Items>
                                    </dx:ASPxComboBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                       ...
                       <dx:LayoutItem ShowCaption="False" Caption="Clave SSA" ColumnSpan="3">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                         ...
                         <dx:LayoutItem Caption="Clave Unidad" ColumnSpan="3">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox runat="server" ID="cboBeneficiarios" ClientInstanceName="cboBeneficiarios" EnableCallbackMode="false"
                                        ValueType="System.String" ValueField="IdBeneficiario" TextFormatString="{0} -- {1}"
                                        DropDownStyle="DropDown" Width="100%" AutoPostBack="false" SelectedIndex="0">
                                        <ValidationSettings RequiredField-IsRequired="true" Display="Dynamic" ValidationGroup="MyForm">
                                            <RequiredField IsRequired="true"></RequiredField>
                                        </ValidationSettings>
                                        <Columns>
                                            <dx:ListBoxColumn FieldName="IdBeneficiario" />
                        ...
                        <dx:LayoutItem Caption="Unidad" ColumnSpan="3">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox runat="server" ID="txtUniBeneficiario" ClientInstanceName="txtUniBeneficiario" SpinButtons-ClientVisible="false">
                                            <ValidationSettings RequiredField-IsRequired="true" Display="Dynamic" ValidationGroup="MyForm">
                                                <RequiredField IsRequired="true"></RequiredField>
                                            </ValidationSettings>
                                        </dx:ASPxTextBox>
