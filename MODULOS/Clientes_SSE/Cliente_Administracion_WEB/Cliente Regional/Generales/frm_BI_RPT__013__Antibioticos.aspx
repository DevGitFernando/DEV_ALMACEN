<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__013__Antibioticos.aspx.cs" Inherits="frm_BI_RPT__013__Antibioticos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 id="EncFormTitle" class="EncFormTitle" runat="server">Antibióticos dispensados</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Anti1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
        ...
        <dx:ASPxFormLayout runat="server" ID="Anti2" Width="100%" ClientInstanceName="FormLayout">
            <Items>
