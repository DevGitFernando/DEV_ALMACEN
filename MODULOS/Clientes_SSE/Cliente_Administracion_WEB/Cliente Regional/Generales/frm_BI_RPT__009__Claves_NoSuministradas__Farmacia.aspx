<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__009__Claves_NoSuministradas__Farmacia.aspx.cs" Inherits="Generales_frm_BI_RPT__009__Claves_NoSuministradas__Farmacia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 id="EncFormTitle" class="EncFormTitle" runat="server">Claves dispensadas de medicamento y material de curación en la modalidad de farmacia</h2>
            ...
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Parámetros:" ColumnCount="6">
                    ...
                    <Items>
                        ...
                        <dx:LayoutItem Caption="# receta" ColumnSpan="3">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
