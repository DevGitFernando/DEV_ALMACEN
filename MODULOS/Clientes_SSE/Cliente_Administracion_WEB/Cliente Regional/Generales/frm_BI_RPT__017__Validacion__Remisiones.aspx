<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__017__Validacion__Remisiones.aspx.cs" Inherits="frm_BI_RPT__017__Validacion__Remisiones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 id="EncFormTitle" class="EncFormTitle" runat="server">Consumos para validación y remisión para facturación</h2>
                ...
                <dx:LayoutGroup Width="100%" Caption="Información de Unidad:" ColumnCount="5">
                    ...
                    <Items>
                       ...
                       <dx:LayoutItem Caption="Farmacia" ColumnSpan="3">
                        ...
                        <dx:LayoutItem Caption="Nombre de solicitante">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox ID="txtSolicitante" runat="server" Width="300px">
                                        <ValidationSettings>
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox runat="server" ID="cboDispensacion" ClientInstanceName="cboDispensacion" EnableCallbackMode="false" Enabled="false"
                                        ...
                                        <Items>
                                           <dx:ListEditItem Text="Recetas" Value="1" Selected="true" />
                                       </Items>
                                    </dx:ASPxComboBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
