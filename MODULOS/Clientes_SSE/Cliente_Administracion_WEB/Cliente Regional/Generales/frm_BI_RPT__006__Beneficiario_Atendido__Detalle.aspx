<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__006__Beneficiario_Atendido__Detalle.aspx.cs" Inherits="Generales_frm_BI_RPT__006__Beneficiario_Atendido__Detalle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 id="EncFormTitle" class="EncFormTitle" runat="server">Reporte de Beneficiarios</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Beneficiarios1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
        ...
        <dx:ASPxFormLayout runat="server" ID="Beneficiarios2" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Parámetros:" ColumnCount="5">
                    ...
                    <Items>
                       <dx:LayoutItem Caption="CURP/INSABI" ColumnSpan="2">
                        ...
                        <dx:LayoutItem ShowCaption="False" Caption="Programa" ColumnSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox runat="server" ID="txtPrograma" ClientInstanceName="txtPrograma" SpinButtons-ClientVisible="false">
                                        <ValidationSettings RequiredField-IsRequired="true" Display="Dynamic" ValidationGroup="MyForm">
