<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__012__Vales_Emitidos_y_Surtidos.aspx.cs" Inherits="Generales_frm_BI_RPT__012__Vales_Emitidos_y_Surtidos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 class="EncFormTitle">  Vales emitidos Vs. Vales Surtidos</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Vales1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
        ...
        <dx:ASPxFormLayout runat="server" ID="Vales2" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                    ...
                    <Items>
                       <dx:LayoutItem Caption="Clave SSA" ColumnSpan="2">
                        ...
                        <dx:LayoutItem Caption="" ColumnSpan="3">
                         ...
                         <dx:LayoutItem Caption="Num. de Poliza" ColumnSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
