<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__014__Estupefacientes_Psicotropicos.aspx.cs" Inherits="frm_BI_RPT__014__Estupefacientes_Psicotropicos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 id="EncFormTitle" class="EncFormTitle" runat="server">Estupefacientes y psicotrópicos Dispensados</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Estupe1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
        ...
        <dx:ASPxFormLayout runat="server" ID="Estupe2" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Parámetros:" ColumnCount="5">
                    ...
                    <Items>
                       <dx:LayoutItem Caption="Clave SSA" ColumnSpan="2">
                        ...
                        <dx:LayoutItem Caption="Médico" ColumnSpan="3">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox runat="server" ID="txtMedico" ClientInstanceName="txtMedico" SpinButtons-ClientVisible="false">
                                            <ValidationSettings RequiredField-IsRequired="true" Display="Dynamic" ValidationGroup="MyForm">
                                                <RequiredField IsRequired="True"></RequiredField>
                                            </ValidationSettings>
                                        </dx:ASPxTextBox>
