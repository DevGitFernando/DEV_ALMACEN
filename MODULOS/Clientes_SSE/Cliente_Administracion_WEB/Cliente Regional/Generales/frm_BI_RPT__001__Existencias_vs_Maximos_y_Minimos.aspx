<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__001__Existencias_vs_Maximos_y_Minimos.aspx.cs" Inherits="Generales_frm_BI_RPT__001__Existencias_vs_Maximos_y_Minimos" %>

<asp:Content ID="localCss" ContentPlaceHolderID="Head" runat="server" EnableViewState="true">
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 class="EncFormTitle">Existencias vs Máximos y Mínimos </h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Existencias1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Información de Unidad:" ColumnCount="5">
                    ...
                    <Items>
                        ...
                        <dx:LayoutItem Caption="Fecha" VerticalAlign="Middle" ColumnSpan="2">
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxDateEdit runat="server" ID="DtFecha" Width="100%" DisplayFormatString="yyyy-MM-dd" EditFormatString="yyyy-MM-dd">
                                    </dx:ASPxDateEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
