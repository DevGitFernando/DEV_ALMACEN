<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="FrmAntibioticosControlados.aspx.cs" Inherits="FrmAntibioticosControlados" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <dx:ASPxMenu ID="Menu" ClientInstanceName="Menu" runat="server" ShowAsToolbar="true" ShowPopOutImages="true" Width="" 
        ...
        <Items>
           <dx:MenuItem Enabled="false" BeginGroup="true" Name="New" Text="Nuevo">
                <Image IconID="actions_new_32x32"></Image>
            </dx:MenuItem>
            <dx:MenuItem Enabled="false" BeginGroup="true" Name="Save" Text="Ejecutar">
                <Image IconID="save_save_32x32"></Image>
            </dx:MenuItem>
        </Items>
    </dx:ASPxMenu>
    <h2 class="EncFormTitle">  Consumos : Antibióticos -- Controlados</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Reportes1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Información de Unidad:" ColumnCount="8">
                    ...
                    <Items>
                        <dx:LayoutItem Caption="Tipo de Unidad" ColumnSpan="4">
                         ...
                         <dx:LayoutItem Caption="Tipo de Medicamentos" VerticalAlign="Middle" ColumnSpan="1" BackColor="LightGreen">
                            </dx:LayoutItem>

                         <dx:LayoutItem Caption="Jurisdicción" ColumnSpan="4">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                         ...
                         <dx:LayoutItem Caption="Antibióticos" ColumnSpan="2">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxCheckBox runat="server" ID="ChecAntibióticos" ClientInstanceName="ChecAntibióticos">
<%--                                            <ClientSideEvents CheckedChanged="ChecAntibióticos_CheckedChanged" />--%>
                                        </dx:ASPxCheckBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                        <dx:LayoutItem Caption="Controlados" ColumnSpan="2">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxCheckBox runat="server" ID="ChecControlados" ClientInstanceName="ChecControlados">
<%--                                            <ClientSideEvents CheckedChanged="ChecControlados_CheckedChanged" />--%>
                                        </dx:ASPxCheckBox>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                        <dx:LayoutItem Caption="Localidad" ColumnSpan="4">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                        ...
                        <dx:LayoutItem Caption="Periodo de revisión" VerticalAlign="Middle" ColumnSpan="1" BackColor="LightGreen" >
                            </dx:LayoutItem>

                        <dx:LayoutItem Caption="Farmacia" ColumnSpan="4">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
