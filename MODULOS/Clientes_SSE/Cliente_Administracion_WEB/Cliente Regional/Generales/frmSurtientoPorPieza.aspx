<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frmSurtientoPorPieza.aspx.cs" Inherits="frmSurtientoPorPieza" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 class="EncFormTitle">  Surtimiento Por Pieza </h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Surtimiento1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Información de Unidad:" ColumnCount="5">
                    ...
                    <Items>
                        ...
                        <dx:LayoutItem Caption="Periodo de revisión" VerticalAlign="Middle" ColumnSpan="1">
                         ...
                         <dx:LayoutItem Caption="Inicio" VerticalAlign="Middle" ColumnSpan="2">
                            <SpanRules>
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxDateEdit runat="server" ID="DtFechaInicio" Width="100%">
                                    </dx:ASPxDateEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
