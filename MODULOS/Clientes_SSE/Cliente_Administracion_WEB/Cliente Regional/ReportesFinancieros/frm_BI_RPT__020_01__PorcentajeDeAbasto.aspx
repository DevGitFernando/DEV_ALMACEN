<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_RPT__020_01__PorcentajeDeAbasto.aspx.cs" Inherits="Generales_frm_BI_RPT__020_01__PorcentajeDeAbasto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 class="EncFormTitle">  Porcentaje de abasto</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Abasto1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
