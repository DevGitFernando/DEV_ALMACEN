...
using System.IO;
public partial class frm_BI_RPT__020_06__Dispensacion_GrupoTerapeutico : BasePage
{
        ...
        if (IsPostBack)
        {
            switch (name)
            {
                case "Save":
                    ...
                    //https://www.intermedgto.mx:8443/BI/frameset?__report=BI_RPT__020_06__Dispensacion_GrupoTerapeutico.rptdesign&IdEmpresa=001&IdEstado=11&IdMunicipio=*&IdJurisdiccion=*&IdFarmacia=*&FechaInicial=2021-11-15&FechaFinal=2021-12-15
