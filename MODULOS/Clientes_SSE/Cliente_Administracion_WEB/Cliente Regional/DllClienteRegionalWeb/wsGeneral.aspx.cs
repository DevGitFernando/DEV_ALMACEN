...
public partial class DllClienteRegionalWeb_wsGeneral : System.Web.UI.Page
{
    ...
    public static string GetInfoGeneral()
    {
        ...
        if (HttpContext.Current.Session["InfoGeneral"] == null)
        {
            ...
            DataSet dtsInfoGeneral = DtGeneral.ExecQuery(sSql, "Info", "wsGeneral GetInfoGeneral");
            ...
            lst.Add("Programas", clsToolsHtml.SerializerDataSet(DtGeneral.ExecQuery(sSql, "Pro_SubPro", "wsGeneral GetInfoGeneral")));
    ...
    public static string GetMovtosAuditor(string dtpFechaInicial, string dtpFechaFinal)
    {
        ...
        HttpContext.Current.Session["AuditorMovimientos"] = DtGeneral.ExecQuery(sSql, "AuditorMovimientos", "wsGeneral GetMovtosAuditor");
    ...
    public static string GetUser(string sIdFarmacia, string sIdPersonal)
    {
        ...
        sEstructura = clsToolsHtml.SerializerDataSet(DtGeneral.ExecQuery(sSql, "User", "wsGeneral GetUser"));
    ...
    private static string getPass()
    {
        ...
        myLeerPass.DataSetClase = DtGeneral.ExecQuery(sSql, "sInfoUser", "wsGeneral getPass");
