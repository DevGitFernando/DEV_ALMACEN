<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_UNI_RPT__009__Claves_NoSuministradas__Farmacia_Unidosis.aspx.cs" Inherits="frm_BI_UNI_RPT__009__Claves_NoSuministradas__Farmacia_Unidosis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 class="EncFormTitle">Medicamento de acuerdo al anexo V-2, no atendidas de medicamento en la modalidad de unidosis</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Clave1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
        ...
        <dx:ASPxFormLayout runat="server" ID="Clave2" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Parámetros:" ColumnCount="5">
                    ...
                    <Items>
                        ...
                        <dx:LayoutItem Caption="Beneficiario" ColumnSpan="3">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                        ...
                        <dx:LayoutItem Caption="# Receta" ColumnSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox runat="server" ID="txtReceta" ClientInstanceName="txtReceta" SpinButtons-ClientVisible="false">
                                        <ValidationSettings RequiredField-IsRequired="true" Display="Dynamic" ValidationGroup="MyForm">
                                            <RequiredField IsRequired="True"></RequiredField>
                                        </ValidationSettings>
                                    </dx:ASPxTextBox>
                        ...
                        <dx:LayoutItem Caption="Servicio" ColumnSpan="3">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
