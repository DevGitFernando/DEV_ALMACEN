<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_UNI_RPT__014__Validacion__Remisiones.aspx.cs" Inherits="frm_BI_UNI_RPT__014__Validacion__Remisiones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 class="EncFormTitle">  Consumos para validación y remisión para facturación</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="validacion1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
        ...
        <dx:ASPxFormLayout runat="server" ID="validacion2" Width="100%" ClientInstanceName="FormLayout">
            <Items>
