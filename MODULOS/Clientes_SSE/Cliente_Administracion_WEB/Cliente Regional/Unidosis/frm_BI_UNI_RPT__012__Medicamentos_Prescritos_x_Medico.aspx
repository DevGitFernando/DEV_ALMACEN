<%@ Page Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeFile="frm_BI_UNI_RPT__012__Medicamentos_Prescritos_x_Medico.aspx.cs" Inherits="frm_BI_UNI_RPT__012__Medicamentos_Prescritos_x_Medico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageContent" runat="Server">
    ...
    <h2 class="EncFormTitle">  Medicamentos prescritos por turno</h2>
    <div id="ResizedDiv" style="width: 100%;">
        <dx:ASPxFormLayout runat="server" ID="Medicamentos1" Width="100%" ClientInstanceName="FormLayout">
            <Items>
        ...
        <dx:ASPxFormLayout runat="server" ID="Medicamentos2" Width="100%" ClientInstanceName="FormLayout">
            <Items>
                <dx:LayoutGroup Width="100%" Caption="Parámetros:" ColumnCount="4">
                    <GridSettings StretchLastItem="true" ChangeCaptionLocationAtWidth="660">
                        <Breakpoints>
                            <dx:LayoutBreakpoint MaxWidth="500" ColumnCount="1" Name="S" />
                            <dx:LayoutBreakpoint MaxWidth="800" ColumnCount="2" Name="M" />
                    ...
                    <Items>
                       <dx:LayoutItem Caption="Clave SSA" ColumnSpan="2">
                        ...
                        <dx:LayoutItem ShowCaption="False" Caption="Médico " ColumnSpan="2">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                        ...
                        <dx:LayoutItem Caption="Área/Servicio" ColumnSpan="2">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                        ...
                        <dx:LayoutItem Caption="Turno" ColumnSpan="2">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxTextBox runat="server" ID="txtTurno" ClientInstanceName="txtTurno" SpinButtons-ClientVisible="false">
                                            <ValidationSettings RequiredField-IsRequired="true" Display="Dynamic" ValidationGroup="MyForm">
                                                <RequiredField IsRequired="True"></RequiredField>
                                            </ValidationSettings>
                                        </dx:ASPxTextBox>
