...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName=" Cliente_Regional_Web.Model.Issue"
        TypeName=" Cliente_Regional_Web.Model.DataProvider"
        SelectMethod="GetIssues" InsertMethod="AddNewIssue" UpdateMethod="UpdateIssue"></asp:ObjectDataSource>

    <asp:ObjectDataSource ID="ContactsDataSource" runat="server" DataObjectTypeName=" Cliente_Regional_Web.Model.Contact"
        TypeName=" Cliente_Regional_Web.Model.DataProvider"
