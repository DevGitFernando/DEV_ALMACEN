...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v20.2, Version=20.2.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dx" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" Cliente_Regional_Web.Model.SchedulerAppointment"
        TypeName=" Cliente_Regional_Web.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" Cliente_Regional_Web.Model.SchedulerResource"
        TypeName=" Cliente_Regional_Web.Model.ResourceDataSourceHelper"
