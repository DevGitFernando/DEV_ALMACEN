...
( 
	...
	@IdEstado varchar(2) = '11', @IdMunicipio varchar(4) = '0001', @IdJurisdiccion varchar(3) = '007', 
	@IdFarmacia varchar(4) = '0088', @ClaveSSA varchar(20) = '010.000.0101.00', @FuenteDeFinanciamiento varchar(200) = '',
	@Fecha  varchar(10) = '2016-05-19' 
) 
As 
Begin 
Set DateFormat YMD 
...
----------------------------------------------------- OBTENCION DE DATOS  
	...
	Where EM.IdEmpresa = @IdEmpresa and EM.IdEstado = @IdEstado 
		...
		and P.ClaveSSA like '%' + @ClaveSSA + '01'
