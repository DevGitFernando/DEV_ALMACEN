...
{
    public partial class FrmReporteador_Remisiones : FrmBaseExt
    {
        enum Cols
        {
            Ninguna = 0,
        ...
        public FrmReporteador_Remisiones()
        {
        ...
        private void CargarFormatosDeImpresion()
        {
            string sSql = string.Format(
                ...
                "Where IdEmpresa = '{0}' and IdEstado = '{1}' and IdFarmacia = '{2}' and Status = 'A' and EsManual = 0 \n" +
