...
{
    public class clsOficinaCentral : clsIntegrarInformacion
    {
        public clsOficinaCentral(clsDatosConexion DatosConexion):base(DatosConexion, TipoServicio.OficinaCentral)
        { 
        }

        public clsOficinaCentral(clsDatosConexion DatosConexion, Encoding Encode): base(DatosConexion, TipoServicio.OficinaCentral, Encode)
        {
        }
