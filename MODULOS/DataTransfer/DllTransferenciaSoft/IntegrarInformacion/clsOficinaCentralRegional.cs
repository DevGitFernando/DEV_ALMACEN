...
{
    public class clsOficinaCentralRegional : clsIntegrarInformacion
    {
        public clsOficinaCentralRegional(clsDatosConexion DatosConexion)
            : base(DatosConexion, TipoServicio.OficinaCentralRegional)
        { 
        }

        public clsOficinaCentralRegional(clsDatosConexion DatosConexion, Encoding Encode)
            : base(DatosConexion, TipoServicio.OficinaCentralRegional, Encode)
        {
        }
        ...
        //////public clsOficinaCentral(clsDatosConexion DatosConexion)
        //////{
