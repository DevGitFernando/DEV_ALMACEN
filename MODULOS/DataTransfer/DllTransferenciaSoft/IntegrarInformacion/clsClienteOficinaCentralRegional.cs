...
namespace DllTransferenciaSoft.IntegrarInformacion
{
    ...
    /// </summary>
    public class clsClienteOficinaCentralRegional : clsIntegrarInformacion
    {
        public clsClienteOficinaCentralRegional(clsDatosConexion DatosConexion): base(DatosConexion, TipoServicio.ClienteOficinaCentralRegional)
        {
        }

        public clsClienteOficinaCentralRegional(clsDatosConexion DatosConexion, Encoding Encode): base(DatosConexion, TipoServicio.ClienteOficinaCentralRegional, Encode)
        {
        }
