...
namespace DllTransferenciaSoft.wsOficinaCentralRegional {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="wsCnnOficinaCentralRegionalSoap", Namespace="http://SC-Solutions/ServiciosWeb/")]
    public partial class wsCnnOficinaCentralRegional : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback ReplicacionInformacionOperationCompleted;
        ...
        /// <remarks/>
        public wsCnnOficinaCentralRegional() {
            this.Url = global::DllTransferenciaSoft.Properties.Settings.Default.DllTransferenciaSoft_wsOficinaCentralRegional_wsCnnOficinaCentralRegional;
        ...
        /// <remarks/>
        public event ReplicacionInformacionCompletedEventHandler ReplicacionInformacionCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://SC-Solutions/ServiciosWeb/ReplicacionInformacion", RequestNamespace="http://SC-Solutions/ServiciosWeb/", ResponseNamespace="http://SC-Solutions/ServiciosWeb/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public bool ReplicacionInformacion(string NombreArchivo, [System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] Archivo) {
            object[] results = this.Invoke("ReplicacionInformacion", new object[] {
                        NombreArchivo,
                        Archivo});
            return ((bool)(results[0]));
        }
        ...
        /// <remarks/>
        public void ReplicacionInformacionAsync(string NombreArchivo, byte[] Archivo) {
            this.ReplicacionInformacionAsync(NombreArchivo, Archivo, null);
        }
        
        /// <remarks/>
        public void ReplicacionInformacionAsync(string NombreArchivo, byte[] Archivo, object userState) {
            if ((this.ReplicacionInformacionOperationCompleted == null)) {
                this.ReplicacionInformacionOperationCompleted = new System.Threading.SendOrPostCallback(this.OnReplicacionInformacionOperationCompleted);
            }
            this.InvokeAsync("ReplicacionInformacion", new object[] {
                        NombreArchivo,
                        Archivo}, this.ReplicacionInformacionOperationCompleted, userState);
        }
        
        private void OnReplicacionInformacionOperationCompleted(object arg) {
            if ((this.ReplicacionInformacionCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ReplicacionInformacionCompleted(this, new ReplicacionInformacionCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1586.0")]
    public delegate void ReplicacionInformacionCompletedEventHandler(object sender, ReplicacionInformacionCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1586.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class ReplicacionInformacionCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal ReplicacionInformacionCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
