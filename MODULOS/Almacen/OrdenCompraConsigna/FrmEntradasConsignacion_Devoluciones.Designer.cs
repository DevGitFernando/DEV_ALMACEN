...
{
    partial class FrmEntradasConsignacion_Devoluciones
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox2.Size = new System.Drawing.Size(1423, 429);
            ...
            this.grdProductos.Size = new System.Drawing.Size(1401, 398);
            ...
            this.grdProductos_Sheet1.Cells.Get(0, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(0, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(0, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(0, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(0, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(0, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(0, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(0, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(1, 2).Locked = false;
            this.grdProductos_Sheet1.Cells.Get(1, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(1, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(1, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(1, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(1, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(1, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(1, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(1, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(2, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(2, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(2, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(2, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(2, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(2, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(2, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(2, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(3, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(3, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(3, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(3, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(3, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(3, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(3, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(3, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(4, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(4, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(4, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(4, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(4, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(4, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(4, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(4, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(5, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(5, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(5, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(5, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(5, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(5, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(5, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(5, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(6, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(6, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(6, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(6, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(6, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(6, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(6, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(6, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(7, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(7, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(7, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(7, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(7, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(7, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(7, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(7, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(8, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(8, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(8, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(8, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(8, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(8, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(8, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(8, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(9, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(9, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(9, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(9, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(9, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(9, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(9, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(9, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            this.grdProductos_Sheet1.Cells.Get(10, 9).Formula = "(RC[-3]*RC[-1])";
            this.grdProductos_Sheet1.Cells.Get(10, 9).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(10, 10).Formula = "((1+(RC[-7]/100))*RC[-1])-RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(10, 10).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(10, 11).Formula = "RC[-2]+RC[-1]";
            this.grdProductos_Sheet1.Cells.Get(10, 11).Value = 0D;
            this.grdProductos_Sheet1.Cells.Get(10, 12).Formula = "(RC[1]/RC[-8])*100";
            this.grdProductos_Sheet1.Cells.Get(10, 12).Value = FarPoint.CalcEngine.CalcError.DivideByZero;
            ...
            this.grdProductos_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "Cantidad Prometida Cajas";
            this.grdProductos_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "Cantidad Prometida Piezas";
            this.grdProductos_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "Cantidad Recibida";
            this.grdProductos_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "Cantidad Devuelta";
            this.grdProductos_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "Costo";
            this.grdProductos_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "Importe";
            this.grdProductos_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "ImporteIva";
            this.grdProductos_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "ImporteTotal";
            this.grdProductos_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "Porcentaje Surtimiento";
            ...
            this.groupBox3.Location = new System.Drawing.Point(12, 787);
            ...
            this.lblPersonal.Size = new System.Drawing.Size(1156, 26);
            ...
            this.label11.Location = new System.Drawing.Point(0, 749);
            ...
            this.FrameEncabezado.Controls.Add(this.label18);
            this.FrameEncabezado.Controls.Add(this.dtpFechaVenceDocto);
            this.FrameEncabezado.Controls.Add(this.label16);
            this.FrameEncabezado.Controls.Add(this.dtpFechaDocto);
            this.FrameEncabezado.Controls.Add(this.label17);
            ...
            this.FrameEncabezado.Location = new System.Drawing.Point(12, 57);
            ...
            this.FrameEncabezado.Size = new System.Drawing.Size(1423, 252);
            ...
            this.txtFolioPre.Location = new System.Drawing.Point(822, 122);
            ...
            this.txtFolioPre.Size = new System.Drawing.Size(278, 22);
            this.txtFolioPre.TabIndex = 52;
            this.txtFolioPre.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
            // 
            // label14
            // 
            this.label14.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.8F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.label14.Location = new System.Drawing.Point(662, 127);
            ...
            this.txtOrden.Location = new System.Drawing.Point(822, 84);
            ...
            this.txtOrden.Size = new System.Drawing.Size(278, 22);
            this.txtOrden.TabIndex = 51;
            this.txtOrden.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
            // 
            // label13
            // 
            this.label13.Font = new System.Drawing.Font("Microsoft Sans Serif", 7.8F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.label13.Location = new System.Drawing.Point(698, 89);
            ...
            this.cboLicitacion.Location = new System.Drawing.Point(128, 84);
            ...
            this.cboLicitacion.Size = new System.Drawing.Size(527, 24);
            this.cboLicitacion.TabIndex = 49;
            // 
            // label2
            // 
            ...
            this.cboSubFarmacias.Location = new System.Drawing.Point(128, 119);
            ...
            this.cboSubFarmacias.Size = new System.Drawing.Size(527, 24);
            this.cboSubFarmacias.TabIndex = 50;
            // 
            // txtTotalFactura
            // 
            ...
            this.txtTotalFactura.DecimalPoint = '.';
            this.txtTotalFactura.DigitsInGroup = 3;
            this.txtTotalFactura.Double = 1D;
            this.txtTotalFactura.Flags = 7680;
            this.txtTotalFactura.GroupSeparator = ',';
            this.txtTotalFactura.Int = 0;
            this.txtTotalFactura.Location = new System.Drawing.Point(1277, 222);
            this.txtTotalFactura.Long = ((long)(0));
            ...
            this.txtTotalFactura.NegativeSign = '-';
            ...
            this.txtTotalFactura.Size = new System.Drawing.Size(132, 22);
            this.txtTotalFactura.TabIndex = 47;
            ...
            this.label18.Location = new System.Drawing.Point(1167, 225);
            ...
            this.dtpFechaVenceDocto.Location = new System.Drawing.Point(1287, 103);
            this.dtpFechaVenceDocto.Margin = new System.Windows.Forms.Padding(4);
            this.dtpFechaVenceDocto.Name = "dtpFechaVenceDocto";
            this.dtpFechaVenceDocto.Size = new System.Drawing.Size(117, 22);
            this.dtpFechaVenceDocto.TabIndex = 44;
            // 
            // label16
            // 
            this.label16.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.label16.Location = new System.Drawing.Point(1160, 108);
            this.label16.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.label16.Name = "label16";
            this.label16.Size = new System.Drawing.Size(121, 15);
            this.label16.TabIndex = 46;
            this.label16.Text = "F. Vence Docto :";
            ...
            this.dtpFechaDocto.Location = new System.Drawing.Point(1287, 74);
            this.dtpFechaDocto.Margin = new System.Windows.Forms.Padding(4);
            this.dtpFechaDocto.Name = "dtpFechaDocto";
            this.dtpFechaDocto.Size = new System.Drawing.Size(117, 22);
            this.dtpFechaDocto.TabIndex = 43;
            // 
            // label17
            // 
            this.label17.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.label17.Location = new System.Drawing.Point(1166, 79);
            this.label17.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.label17.Name = "label17";
            this.label17.Size = new System.Drawing.Size(115, 15);
            this.label17.TabIndex = 45;
            this.label17.Text = "F. Documento :";
            ...
            this.dtpFechaPromesaEntrega.Location = new System.Drawing.Point(1287, 45);
            this.dtpFechaPromesaEntrega.Margin = new System.Windows.Forms.Padding(4);
            this.dtpFechaPromesaEntrega.Name = "dtpFechaPromesaEntrega";
            this.dtpFechaPromesaEntrega.Size = new System.Drawing.Size(117, 22);
            this.dtpFechaPromesaEntrega.TabIndex = 41;
            // 
            // label15
            // 
            this.label15.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.label15.Location = new System.Drawing.Point(1179, 47);
            this.label15.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.label15.Name = "label15";
            this.label15.Size = new System.Drawing.Size(103, 16);
            this.label15.TabIndex = 42;
            this.label15.Text = "F. Entrega :";
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.lblProveedor.Location = new System.Drawing.Point(269, 49);
            this.lblProveedor.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.lblProveedor.Name = "lblProveedor";
            this.lblProveedor.Size = new System.Drawing.Size(831, 26);
            ...
            this.txtIdProveedor.Location = new System.Drawing.Point(128, 49);
            ...
            this.txtReferenciaDocto_Auxiliar.Location = new System.Drawing.Point(888, 155);
            this.txtReferenciaDocto_Auxiliar.Margin = new System.Windows.Forms.Padding(4);
            ...
            this.txtReferenciaDocto_Auxiliar.Size = new System.Drawing.Size(212, 22);
            this.txtReferenciaDocto_Auxiliar.TabIndex = 3;
            ...
            this.lblReferenciaDocto_Auxiliar.Location = new System.Drawing.Point(700, 158);
            this.lblReferenciaDocto_Auxiliar.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.lblReferenciaDocto_Auxiliar.Name = "lblReferenciaDocto_Auxiliar";
            this.lblReferenciaDocto_Auxiliar.Size = new System.Drawing.Size(184, 15);
            ...
            this.lblTituloInventario.Location = new System.Drawing.Point(687, 17);
            ...
            this.lblTituloInventario.Size = new System.Drawing.Size(315, 25);
            ...
            this.txtTotal.Int = 0;
            this.txtTotal.Location = new System.Drawing.Point(1277, 194);
            ...
            this.txtIva.Int = 0;
            this.txtIva.Location = new System.Drawing.Point(1277, 165);
            ...
            this.txtSubTotal.Location = new System.Drawing.Point(1277, 137);
            ...
            this.txtObservaciones.Location = new System.Drawing.Point(128, 185);
            ...
            this.txtObservaciones.Size = new System.Drawing.Size(972, 59);
            ...
            this.label9.Location = new System.Drawing.Point(1171, 199);
            ...
            this.label8.Location = new System.Drawing.Point(1171, 170);
            ...
            this.label7.Location = new System.Drawing.Point(1171, 142);
            ...
            this.txtReferenciaDocto.Location = new System.Drawing.Point(128, 154);
            ...
            this.dtpFechaRegistro.Location = new System.Drawing.Point(1287, 16);
            this.dtpFechaRegistro.Margin = new System.Windows.Forms.Padding(4);
            this.dtpFechaRegistro.Name = "dtpFechaRegistro";
            this.dtpFechaRegistro.Size = new System.Drawing.Size(117, 22);
            this.dtpFechaRegistro.TabIndex = 5;
            // 
            // label3
            // 
            this.label3.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            this.label3.Location = new System.Drawing.Point(1144, 21);
            this.label3.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.label3.Name = "label3";
            this.label3.Size = new System.Drawing.Size(136, 16);
            this.label3.TabIndex = 7;
            this.label3.Text = "F. Devolución :";
            ...
            this.lblCancelado.Location = new System.Drawing.Point(271, 18);
            ...
            this.txtFolio.Location = new System.Drawing.Point(128, 18);
            ...
            // 
            // FrmEntradasConsignacion_Devoluciones
            // 
            ...
            this.Name = "FrmEntradasConsignacion_Devoluciones";
            this.ShowIcon = false;
            this.Text = "Devolución Recepción OC";
