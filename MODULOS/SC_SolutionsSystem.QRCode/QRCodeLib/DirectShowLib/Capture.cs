...
////////namespace SC_SolutionsSystem.QRCode.DirectShowLib
////////{
////////    class Capture
////////    {
////////    }
...
namespace SC_SolutionsSystem.QRCode.DirectShowLib
{
    ...
    internal class Capture : ISampleGrabberCB, IDisposable
    {
        ...
        public Capture(string DeviceName, int iWidth, int iHeight, short iBPP, Control hControl)
        {
            m_bRunning = false; 
            int iVideoDevice = -1;
            DsDevice[] capDevices;
            ...
            {
                iVideoDevice++;
                if (dv.Name.ToUpper() == DeviceName.ToUpper())
                {
                    break;
                }
            }
            ...
            if (iVideoDevice >= 0)
            {
                try
                {
                    ...
                    SetupGraph(capDevices[iVideoDevice], iWidth, iHeight, iBPP, hControl);
