...
using FinderPatternNotFoundException = SC_SolutionsSystem.QRCode.ExceptionHandler.FinderPatternNotFoundException;
...
using VersionInformationException = SC_SolutionsSystem.QRCode.ExceptionHandler.VersionInformationException;
using SC_SolutionsSystem.QRCode.Geom;
using SC_SolutionsSystem.QRCode.Codec.Reader.Pattern;
using SC_SolutionsSystem.QRCode.Codec.Util;
using SystemUtils = SC_SolutionsSystem.QRCode.Codec.Util.SystemUtils;

namespace SC_SolutionsSystem.QRCode.Codec.Reader
{
	...
	public class QRCodeImageReader
	{
		...
		internal virtual bool[][] getQRCodeMatrix(bool[][] image, SamplingGrid gridLines)
		{
			...
			canvas.drawPoint(bottomRightPoint, SC_SolutionsSystem.QRCode.Codec.Util.Color_Fields.BLUE);
