...
using InvalidVersionInfoException = SC_SolutionsSystem.QRCode.ExceptionHandler.InvalidVersionInfoException;
...
namespace SC_SolutionsSystem.QRCode.Codec.Reader.Pattern
{
	...
	public class FinderPattern
	{
		...
		internal static Line[] findLineAcross(bool[][] image)
		{
			...
			canvas.drawLines(foundLines, SC_SolutionsSystem.QRCode.Codec.Util.Color_Fields.LIGHTGREEN);
			return foundLines;
		}
		...
		internal static Point[] getCenter(Line[] crossLines)
		{
			...
			{
				canvas.drawPolygon(foundPoints, SC_SolutionsSystem.QRCode.Codec.Util.Color_Fields.RED);
				return foundPoints;
			}
			else
		...
		internal static int calcExactVersion(Point[] centers, int[] angle, int[] moduleSize, bool[][] image)
		{
			...
			canvas.drawPoints(points, SC_SolutionsSystem.QRCode.Codec.Util.Color_Fields.RED);
