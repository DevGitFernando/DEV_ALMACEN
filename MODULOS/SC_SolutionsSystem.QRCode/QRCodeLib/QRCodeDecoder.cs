...
using QRCodeImage = SC_SolutionsSystem.QRCode.Codec.Data.QRCodeImage;
using QRCodeSymbol = SC_SolutionsSystem.QRCode.Codec.Data.QRCodeSymbol;
using ReedSolomon = SC_SolutionsSystem.QRCode.Codec.Ecc.ReedSolomon;
using DecodingFailedException = SC_SolutionsSystem.QRCode.ExceptionHandler.DecodingFailedException;
using InvalidDataBlockException = SC_SolutionsSystem.QRCode.ExceptionHandler.InvalidDataBlockException;
using SymbolNotFoundException = SC_SolutionsSystem.QRCode.ExceptionHandler.SymbolNotFoundException;
using Point = SC_SolutionsSystem.QRCode.Geom.Point;
using QRCodeDataBlockReader = SC_SolutionsSystem.QRCode.Codec.Reader.QRCodeDataBlockReader;
using QRCodeImageReader = SC_SolutionsSystem.QRCode.Codec.Reader.QRCodeImageReader;
using DebugCanvas = SC_SolutionsSystem.QRCode.Codec.Util.DebugCanvas;
using DebugCanvasAdapter = SC_SolutionsSystem.QRCode.Codec.Util.DebugCanvasAdapter;
using QRCodeUtility = SC_SolutionsSystem.QRCode.Codec.Util.QRCodeUtility;
using QRCodeBitmapImage = SC_SolutionsSystem.QRCode.Codec.Data.QRCodeBitmapImage; 
...
namespace SC_SolutionsSystem.QRCode.Codec
{
	...
	public class QRCodeDecoder
    {
        ...
        internal string sDatosDecodificados = ""; 
        internal PictureBox picEncode = new PictureBox();
        internal Bitmap picEncode_Image = new Bitmap(1, 1); 
        #endregion Declaracio de Variables 

        #region Declaracion de Clases Internas 
        ...
        #endregion Declaracion de Clases Internas
        ...
        {
            get { return QRCodeDecoder.canvas; } 
            set { QRCodeDecoder.canvas = value; } 
        }

        virtual public string DatosDecodificados
        {
            get { return sDatosDecodificados; }
        }

        virtual public Bitmap Imagen
        {
        ...
        public bool Abrir(bool Decodificar)
        {
            bool bRegresa = false;
            ...
            if (openFile.ShowDialog() == DialogResult.OK)
            {
                ...
                picEncode_Image = new Bitmap(fileName);
        ...
        public bool Imprimir()
        {
            ...
            documento.PrintPage += new PrintPageEventHandler(printDocument_PrintPage);
        ...
        {
            picEncode.Image = picEncode_Image;
            e.Graphics.DrawImage(picEncode.Image, 0, 0);
        }

        public virtual string Decode()
        { 
            return Decode(new QRCodeBitmapImage(new Bitmap(picEncode_Image))); 
        } 
        ...
        public virtual string Decode(QRCodeImage qrCodeImage)
        {
            ...
            sDatosDecodificados = decodedData; 
            return decodedData;
        }
        ...
        internal virtual sbyte[] DecodeBytes(QRCodeImage qrCodeImage)
        {
