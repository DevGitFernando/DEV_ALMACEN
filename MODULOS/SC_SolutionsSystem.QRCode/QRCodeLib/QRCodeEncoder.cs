...
using SC_SolutionsSystem.QRCode.Properties;
...
namespace SC_SolutionsSystem.QRCode.Codec
{
    public class QRCodeEncoder
    {
        ...
        public bool Guardar()
        {
            ...
            {
                FileStream fs = (System.IO.FileStream)saveFile.OpenFile();
                picEncode.Image = picEncode_Image;
                formato = (FormatosImagen)saveFile.FilterIndex;
