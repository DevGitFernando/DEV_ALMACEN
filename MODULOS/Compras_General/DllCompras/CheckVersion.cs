...
namespace DllCompras
{
    public class CheckVersion
    {
        ...
        private string sModuloUpdater = "Updater Compras.exe";
        private string sVersionUpdater = "0.0.0.0";
        private string sModuloEnEjecucion = "";
        ...
        public CheckVersion(string Modulo, string Version, string ModuloUpdater, string ModuloEnEjecucion)
        {
            sModulo = Modulo;
            sVersion = Version;
            sModuloEnEjecucion = ModuloEnEjecucion; 

            if ( ModuloUpdater!= "" )
            {
                sModuloUpdater = ModuloUpdater;
            }
        ...
        public void DescargarActualizacion()
        {
            ...
            string sFile = Path.Combine(Application.StartupPath, sModuloUpdater);
            string sParametros = "m" + sModuloEnEjecucion + " "; 
        ...
        private bool RevisarVersionUpdater()
        {
            ...
            byte[] Buffer;
            clsLeer leer = new clsLeer();
            clsDatosCliente datosDeCliente = new clsDatosCliente(GnCompras.DatosApp, "", "");
