$(document).ready(function () {
    ...
    $("div.toolbar").html('<div class="mensaje"> ' +
            			            '<b>Click derecho para descargar orden de compra.</b>' +
            		            '</div>');
    /* Add events */
    $('#lstOrdenes_ListViewTable tbody tr').live('contextmenu', function (e) {
        ...
        menu.html('<ul> ' +
                            '<li id="menu_download">Descargar orden con el folio ' + sFolio + '</li>' +
            		    '</ul>');
    ...
    menu.click(function (e) {
        ...
        //si esta activada, gestionamos cada una y sus acciones
            ...
            switch (e.target.id) {
                case "menu_download":
                    document.OrdenesDescargadas.__IdFolio.value = sFolio;
                    document.OrdenesDescargadas.__IdFarmaciaRecibe.value = sFarmaciaRecibe;
                    document.OrdenesDescargadas.__IdFarmacia.value = sFarmacia;
    ...
    $('.window .close').click(function (e) {
        document.location.href = "frmOrdenesDescargadas.aspx";
        //Cancelamos el link
        e.preventDefault();
    ...
    function __doPostBack(eventTarget, eventArgument) {
        document.OrdenesDescargadas.__EVENTTARGET.value = eventTarget;
        document.OrdenesDescargadas.__EVENTARGUMENT.value = eventArgument;
        if (eventTarget == "Limpiar") {
            document.location.href = "frmOrdenesDescargadas.aspx";
        } else if (eventTarget == "Exportar") {
            if (!document.getElementById('lstOrdenes_ListViewTable')) {
                alert("No existe información para exportar.")
            } else if (document.getElementById('lstOrdenes_ListViewTable')) {
                document.OrdenesDescargadas.submit();
            }
