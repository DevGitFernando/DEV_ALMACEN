<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmOrdenesDescargadas.aspx.cs" Inherits="Opciones_frmOrdenesDescargadas" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript" src="../scripts/JScript_frmOrdenesDescargadas.js"></script>
...
<body>
    <form id="OrdenesDescargadas" runat="server">
    <div id="menu"></div>
    <div id="boxes">
