------------------------------------------------------------------------------------------------------------- 
If Exists ( Select * From Sysobjects (NoLock) Where Name = 'spp_Registrar_Huellas' and xType = 'P' ) 
   Drop Proc spp_Registrar_Huellas 
Go--#SQL 

Create Proc spp_Registrar_Huellas 
( 
...
Declare 
	...
	If Exists ( Select * From FP_Huellas (NoLock) Where Huella = @Huella ) -- ReferenciaHuella = @ReferenciaHuella and Dedo = @Dedo ) 
	Begin 
	...
	Else 
	Begin 
		Insert Into FP_Huellas ( FechaRegistro, ReferenciaHuella, Dedo, Huella, Status ) 
