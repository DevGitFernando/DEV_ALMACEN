...
namespace DllFarmaciaSoft.Usuarios_y_Permisos
{
    public class clsEdoFileConfig
    {
        ...
        public clsEdoFileConfig(string sRutaArchivo)
        {
        ...
        public clsEdoFileConfig(int iRuta)
        {
            Fg.CentrarForma(Frm);
            Frm.ShowDialog();
        ...
        public bool BuscarConfiguracion()
        {
            ...
            if (bMostrar)
            {
                ...
                if (Frm.bAceptar)
                {
                    ...
                    //General.DatosConexion.Servidor = sServer;
                    //General.DatosConexion.BaseDeDatos = sBD;
                    //General.DatosConexion.Usuario = sUsuario;
                    //General.DatosConexion.Password = sPassword; 
