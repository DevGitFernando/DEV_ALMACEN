...
namespace DllFarmaciaSoft.PDF
{
    [StructLayout(LayoutKind.Sequential)]
    public struct iTextOutline
    {
        public string Title;
                        ...
                        for (int i = 1; i <= pageCount; i++)
                        {
                            ...
                            if (SetWaterMark)
                            {
                                ...
                                cb.BeginText();
                                    ...
                                    ////cb.ShowTextAligned(PdfContentByte.TEXT_RENDER_MODE_FILL, watermarkText, (rect.Width / 2), (int)(rect.Height * .97), 0); // Top 
                                    //cb.ShowTextAligned(PdfContentByte.TEXT_RENDER_MODE_FILL, watermarkText, (rect.Width / 2), (int)(rect.Height -30), 0); // Top 
                                //cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, watermarkText, (rect.Width - 200), 10, 0); //Bottom 

                                //cb.ShowTextAligned(PdfContentByte.ALIGN_RIGHT, watermarkText, 20, 10, 0); //Bottom 
                                ...
                                //cb.ShowTextAligned(PdfContentByte.TEXT_RENDER_MODE_FILL, watermarkText, iPosX, 10, 0); //Bottom 
