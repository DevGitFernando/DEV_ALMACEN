...
namespace Dll_IFacturacion
{
    internal class SelloDigital
    {
        ...
        DateTime dtFechaInicia = DateTime.Now;
        DateTime dtFechaFinaliza = DateTime.Now; 
        ...
        public SelloDigital(string Certificado, string LlavePrivada, string Password)
        {
        ...
        {
            string sRegresa = Fecha; // .Substring(0, Fecha.Length -1); 

            try
            {
                sRegresa = sRegresa.Substring(0, 10) + " " + sRegresa.Substring(11, 8);
            }
            catch { } 
            return sRegresa; 
        } 
        ...
        public void ObtenerDatos() 
        {
            ...
            sFechaUsoCertificado = FormatearFecha(sFechaUsoCertificado);
            sFechaExpiraCertificado = FormatearFecha(sFechaExpiraCertificado);
        ...
        public string FechaVigenciaInicia
        {
            get { return sFechaUsoCertificado; }
            set { ; }
        }

        public string FechaVigenciaFinaliza
        {
            get { return sFechaExpiraCertificado; }
            set { ; }
        }
        ...
        public DateTime FechaInicia
        {
            get
            {
                ...
                try
                {
                    dTime = Convert.ToDateTime(sFechaUsoCertificado); 
                }
                catch{ }
        ...
        public DateTime FechaTermina
        {
            get
            {
                ...
                try
                {
                    dTime = Convert.ToDateTime(sFechaExpiraCertificado);
                }
                catch { }
                return dTime;
            }
        ...
        public string GenerarSelloDigital(string CadenaOriginal)
        {
            ...
            block = Rsa.EncodeMsgForSignature(keyBytes, b, Dll_IFacturacion.CryptoSysPKI.HashAlgorithm.Md5);
