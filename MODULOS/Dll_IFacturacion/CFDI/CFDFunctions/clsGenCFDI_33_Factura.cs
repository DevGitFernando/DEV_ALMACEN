...
{
    public class clsGenCFDI_33_Factura
    {
        ...
        private clsCFDI_33_Factura ccfdi = new clsCFDI_33_Factura();
        ...
        public clsGenCFDI_33_Factura()
        {
            tpVersionCFDI = eVersionCFDI.Version__4_0; 
        }
        ...
        private clsCFDI_33_Factura generarCFD(CFDFunctionsEx.clsComprobante Comprobante)
        {
            clsCFDI_33_Factura ccfdi = new clsCFDI_33_Factura();
            ...
            try
            {
                ...
                ccfdi.Exportacion = Comprobante.Exportacion;


                //ccfdi.tipoDeComprobante = Comprobante.TipoDeComprobante.ToString();
                ccfdi.tipoDeComprobante = "I"; // Ingreso 
                ...
                ccfdi.Referencia_02 = Comprobante.Referencia_02;
                ccfdi.Referencia_03 = Comprobante.Referencia_03;
                ccfdi.Referencia_04 = Comprobante.Referencia_04;
                ccfdi.Referencia_05 = Comprobante.Referencia_05;
                ...
                ccfdi.Receptor.DomicilioFiscal = Comprobante.Receptor.DomicilioFiscal;
                ccfdi.Receptor.RegimenFiscal = Comprobante.Receptor.RegimenFiscal;
                ccfdi.Receptor.RegimenFiscal_Descripcion = Comprobante.Receptor.RegimenFiscal_Descripcion;
                ...
                foreach (CFDFunctionsEx.clsConcepto comprobante in Comprobante.Conceptos.Conceptos)
                {
                    ...
                    concepto.Impuesto_TasaOCuotaRetencion = comprobante.Impuesto_TasaOCuotaRetencion;
                    concepto.Impuesto_ImporteRetencion = comprobante.Impuesto_ImporteRetencion;
                    ...
                    concepto.EsObjetoDeImpuesto = comprobante.EsObjetoDeImpuesto;
                    ...
                    concepto.valorUnitario = comprobante.ValorUnitario;
                    concepto.importe = comprobante.SubTotal;
                ...
                if (ccfdi.Impuestos.totalImpuestosRetenidos > 0.0) 
                {
                    //retencion = null;
                    ...
                    foreach (clsRetencion ret in Comprobante.Retenciones.ListaRetenciones)
                    {
                        ccfdi.Impuestos.Retenciones.Add(ret);
                    }
                }

                ////if (ccfdi.Impuestos.totalImpuestosTrasladados > 0.0)
                {
                    //retencion = null;
                    //retencion = new clsRetencion();
                    ...
                    foreach (CFDFunctionsEx.clsTraslado tras in Comprobante.Traslados.ListaTralados)
                    {
                        clsTraslado traslado_aux = new clsTraslado();
                        traslado_aux.Impuesto_Base = tras.Impuesto_Base;
                        traslado_aux.Impuesto_ImpuestoClave = tras.Impuesto_ImpuestoClave;
                        traslado_aux.Impuesto_Impuesto = tras.Impuesto_Impuesto;
                        traslado_aux.Impuesto_TasaOCuota = tras.Impuesto_TasaOCuota;
                        traslado_aux.Impuesto_TipoFactor = tras.Impuesto_TipoFactor;
                        traslado_aux.Impuesto_Importe = tras.Impuesto_Importe;
                        ccfdi.Impuestos.Traslados.Add(traslado_aux);
                    }
                }
        ...
        private long generarFacturaElectronica(CFDFunctionsEx.clsComprobante Comprobante, string xsltfile, string privateKeyFileName, string pwd)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    strSelloDigital = this.proccess.getDigitalSeal(filenameXML, xsltfile, privateKeyFileName, pwd, "4.0");
        ...
        private void Log(string msg, string Funcion)
        {
            if (Error == null)
            {
                Error = new clsGrabarError(General.DatosConexion, DtIFacturacion.DatosApp, "clsGenCFDI_33_Factura"); 
            }
        ...
        private DataTable GetExtras()
        {
            ...
            dato.Valor = ccfdi.Referencia_02;  //list.LeerItem().Campo("Referencia_02");
            Datos.Add(dato);

            dato = new DatosExtraImpresion();
            dato.Nombre = "Referencia_03";
            dato.Valor = ccfdi.Referencia_03;  //list.LeerItem().Campo("Referencia_02");
            Datos.Add(dato);

            dato = new DatosExtraImpresion();
            dato.Nombre = "Referencia_04";
            dato.Valor = ccfdi.Referencia_04;  //list.LeerItem().Campo("Referencia_02");
            Datos.Add(dato);

            dato = new DatosExtraImpresion();
            dato.Nombre = "Referencia_05";
            dato.Valor = ccfdi.Referencia_05;  //list.LeerItem().Campo("Referencia_02");
            Datos.Add(dato);
        ...
        private bool GenerarTimbre_VP(string ArchivoXml, string Referencia, string Segmento_Sello)
        {
            ...
            else
            {
                ...
                string sSql = string.Format(
                    ...
                    "From FACT_CFDI_XML_VP X (NoLock) " +
