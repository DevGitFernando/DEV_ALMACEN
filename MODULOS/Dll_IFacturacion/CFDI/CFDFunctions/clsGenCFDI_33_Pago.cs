    ...
    public class clsGenCFDI_33_Pago
    {
        ...
        private clsCFDI_33_Pagos generarCFD( CFDFunctionsEx.clsComprobante Comprobante )
        {
            ...
            try
            {
                ...
                //ccfdi.SAT_ClaveDeConfirmacion = Comprobante.sat
                ...
                ccfdi.SAT_ClaveDeConfirmacion = Comprobante.SAT_ClaveDeConfirmacion;
                ccfdi.CFDI_Relacionado_CPago = Comprobante.CFDI_Relacionado_CPago;
                ccfdi.Serie_Relacionada_CPago = Comprobante.Serie_Relacionada_CPago;
                ccfdi.Folio_Relacionado_CPago = Comprobante.Folio_Relacionado_CPago;
                ...
                if (ccfdi.Impuestos.totalImpuestosRetenidos > 0.0)
                {
                    ...
                    ////retencion.importe = this.ogCFD.roundValue(ccfdi.Impuestos.totalImpuestosRetenidos);
                    ////ccfdi.Impuestos.Retenciones.Add(retencion);
                }

                ////////////REMOVER ESTO PARA APLICAR SIEMPRE LOS IMPUESTOS TRASLADADOS 
