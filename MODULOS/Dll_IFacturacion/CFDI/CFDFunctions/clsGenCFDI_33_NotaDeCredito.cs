...
{
    public class clsGenCFDI_33_NotaDeCredito
    {
        ...
        private clsCFDI_33_NotasDeCredito ccfdi = new clsCFDI_33_NotasDeCredito();
        ...
        private clsCFDI_33_NotasDeCredito generarCFD(CFDFunctionsEx.clsComprobante Comprobante)
        {
            clsCFDI_33_NotasDeCredito ccfdi = new clsCFDI_33_NotasDeCredito();
            ...
            try
            {
                ...
                ccfdi.tipoDeComprobante = "E";  // Egreso
        ...
        private void Log(string msg, string Funcion)
        {
            if (Error == null)
            {
                Error = new clsGrabarError(General.DatosConexion, DtIFacturacion.DatosApp, "clsGenCFDI_33_NotaDeCredito"); 
            }
