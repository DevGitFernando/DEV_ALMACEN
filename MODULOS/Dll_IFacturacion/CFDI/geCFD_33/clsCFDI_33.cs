...
namespace Dll_IFacturacion.CFDI.geCFD_33
{
    public class clsCFDI_33_Factura
    {
        ...
        private string sReferencia_02 = "";
        private string sReferencia_03 = "";
        private string sReferencia_04 = "";
        private string sReferencia_05 = "";
        ...
        {
            clsGrabarError.LogFileError(string.Format("clsCFDI_40_Factura.{0}:    {1}", Funcion, Mensaje));
        }
        ...
        public string getXML(string filename, bool omitSeal)
        {
            ...
            documentElement.SetAttribute("schemaLocation",
                ...
                "http://www.sat.gob.mx/cfd/4 http://www.sat.gob.mx/sitio_internet/cfd/4/cfdv40.xsd" + str);
            ...
            //////// FACTURACION GLOBAL 
            ////clsLeer datosGenerales = new clsLeer();
            ////clsLeer datosEncabezado = new clsLeer();

            ////datosGenerales.DataSetClase = dtsInformacionGeneral;
            ////datosEncabezado.DataTableClase = datosGenerales.Tabla("Comprobante");

            ////if (datosEncabezado.Leer())
            ////{
            ////    if (datosEncabezado.CampoBool("EsFacturaGlobal"))
            ////    {
            ////        elementFacturaGlobal = this.newElement("InformacionGlobal");

            ////        elementFacturaGlobal.SetAttribute("Periodicidad", this.toUTF8(datosEncabezado.Campo("FG_Periodicidad")));
            ////        elementFacturaGlobal.SetAttribute("Meses", this.toUTF8(datosEncabezado.Campo("FG_Meses")));
            ////        elementFacturaGlobal.SetAttribute("Año", this.toUTF8(datosEncabezado.CampoInt("FG_Año").ToString()));

            ////        documentElement.AppendChild(elementFacturaGlobal);
            ////    }
            ////}
            //////// FACTURACION GLOBAL 
            ...
            foreach (clsConcepto concepto in this.Conceptos)
            {
                ...
                element3.SetAttribute("ObjetoImp", concepto.EsObjetoDeImpuesto);
                ...
                if (concepto.Impuesto_ImporteRetencion > 0)
                {
                    elementRetenciones = this.newElement("Retenciones");
                    elementRetencion_Item = this.newElement("Retencion");
                    elementRetencion_Item.SetAttribute("Base", concepto.Impuesto_Base.ToString("0.#0"));
                    elementRetencion_Item.SetAttribute("Impuesto", toUTF8(concepto.Impuesto_ImpuestoClave));
                    elementRetencion_Item.SetAttribute("TipoFactor", toUTF8(concepto.Impuesto_TipoFactor));
                    elementRetencion_Item.SetAttribute("TasaOCuota", concepto.Impuesto_TasaOCuotaRetencion.ToString("0.#####0"));
                    elementRetencion_Item.SetAttribute("Importe", concepto.Impuesto_ImporteRetencion.ToString("0.#0"));
                    elementRetenciones.AppendChild(elementRetencion_Item);
            ...
            if (this.Impuestos.Retenciones.Count > 0)
            {
                ...
                {
                    object[] obj = {
                        retencion.Impuesto_Base,
                        toUTF8(retencion.Impuesto_Impuesto), retencion.Impuesto_TipoFactor, retencion.tasa, retencion.Impuesto_Importe,
                        retencion.Impuesto_ImpuestoClave, retencion.Impuesto_TasaOCuota
                                   };
                    ...
                    element5.SetAttribute("Base", this.toUTF8(retencion.Impuesto_Base.ToString("0.#0")));
                    element5.SetAttribute("Impuesto", this.toUTF8(retencion.Impuesto_ImpuestoClave));
                    element5.SetAttribute("TipoFactor", this.toUTF8(retencion.Impuesto_TipoFactor));
                    element5.SetAttribute("TasaOCuota", retencion.Impuesto_TasaOCuota.ToString("0.#####0"));
                    element5.SetAttribute("Importe", retencion.Impuesto_Importe.ToString("0.#0"));
                    element4.AppendChild(element5);
                    element5 = null;
                }
            ...
            if (this.Impuestos.Traslados.Count > 0)
            {
                ...
                {
                    object[] obj = {
                        traslado.Impuesto_Base,
                        toUTF8(traslado.Impuesto_Impuesto), traslado.Impuesto_TipoFactor, traslado.tasa, traslado.Impuesto_Importe,
                        traslado.Impuesto_ImpuestoClave, traslado.Impuesto_TasaOCuota
                                   };
                    ...
                    element5.SetAttribute("Base", this.toUTF8(traslado.Impuesto_Base.ToString("0.#0")));
        ...
        private void Preparar_Dts_08_Conceptos()
        {
            ...
            ////////////////////////////////////////////////////////////////
            string[] sListaColumnas = { "Serie", "Folio", "Serie_Relacionada", "Folio_Relacionado", "UUID_Relacionado", "Total_Base", "SubTotal", "IVA", "Total" };
        ...
        private void Preparar_Dts_09_Traslados()
        {
            ...
            dtRetenciones.Columns.Add("Impuestos_Base", System.Type.GetType("System.Double"));
            dtRetenciones.Columns.Add("Impuesto", System.Type.GetType("System.String"));
            dtRetenciones.Columns.Add("TipoFactor", System.Type.GetType("System.String"));
            dtRetenciones.Columns.Add("Tasa", System.Type.GetType("System.Int32"));
            dtRetenciones.Columns.Add("Importe", System.Type.GetType("System.Double"));
            dtRetenciones.Columns.Add("ClaveImpuesto", System.Type.GetType("System.String"));
            dtRetenciones.Columns.Add("TasaOCuota", System.Type.GetType("System.Double"));
