...
{
    public class clsCFDI_33_NotasDeCredito
    {
        ...
        public clsCFDI_33_NotasDeCredito()
        {
            this.InitCFD();
        }
        ...
        {
            clsGrabarError.LogFileError(string.Format("clsCFDI_40_NotasDeCredito.{0}:    {1}", Funcion, Mensaje));
        }
