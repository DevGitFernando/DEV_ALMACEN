...
namespace Dll_IFacturacion.CFDI.CFDFunctionsEx
{
    public class clsReceptor
    {
        ...
        string mDomicilioFiscal = "";
        string mRegimenFiscal = "";
        string mRegimenFiscal_Descripcion = "";
        ...
        private void CargarDatos()
        {
            ...
            if (leerReceptor.Leer())
            {
                ...
                mDomicilioFiscal = leerReceptor.Campo("DomicilioFiscal");
                mRegimenFiscal = leerReceptor.Campo("RegimenFiscal");
                mRegimenFiscal_Descripcion = leerReceptor.Campo("RegimenFiscal_Descripcion");
            }
