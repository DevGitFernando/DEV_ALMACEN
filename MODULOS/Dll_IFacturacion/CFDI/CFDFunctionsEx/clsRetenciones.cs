...
namespace Dll_IFacturacion.CFDI.CFDFunctionsEx
{
    ...
    {
        List<Dll_IFacturacion.CFDI.geCFD.clsRetencion> pListaRetenciones; //  = new List<clsConcepto>();
        ...
        {
            pListaRetenciones = new List<Dll_IFacturacion.CFDI.geCFD.clsRetencion>();
        }
        ...
        private void CargarDatos()
        {
            ...
            {
                Dll_IFacturacion.CFDI.geCFD.clsRetencion retencion = new Dll_IFacturacion.CFDI.geCFD.clsRetencion();
                ...
                retencion.Impuesto_Base = leerRetenciones.CampoDouble("Impuestos_Base");
        ...
        public bool Add(Dll_IFacturacion.CFDI.geCFD.clsRetencion Retencion)
        {
            bool bRegresa = true;
        ...
        #region Propiedades 
        public List<Dll_IFacturacion.CFDI.geCFD.clsRetencion> ListaRetenciones
        {
