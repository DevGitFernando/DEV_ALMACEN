...
namespace Dll_IFacturacion.CFDI.CFDFunctionsEx
{
    ...
    public class clsTraslados
    {
        ...
        #region Propiedades
        public List<clsTraslado> ListaTralados
        {
        ...
        private void CargarDatos()
        {
            ...
            while (leerTraslados.Leer())
            {
                ...
                //Impuesto_Impuesto, Impuestos_TipoFactor, Impuestos_TasaOCuota, Impuesto1 as TasaIva, sum(Impuestos_Importe) as Importe 

                traslado.Impuesto_Base = leerTraslados.CampoDouble("Impuestos_Base");
