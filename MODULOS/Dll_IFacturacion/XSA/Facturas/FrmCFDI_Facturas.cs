...
{
    public partial class FrmCFDI_Facturas : FrmBaseExt
    {
        ...
        enum Cols
        {
            ...
            Ninguna = 0, 
            IdClave = 1, SAT_ClaveProductoServicio, ClaveSSA, Descripcion, PrecioUnitario, Cantidad, 
        ...
        #region Form
        private void FrmCFDI_Facturas_Load(object sender, EventArgs e)
        {
            list.LimpiarItems(); 
            InicializaPantalla();
        ...
        {
            dTotal = Convert.ToDouble("0" + lblTotal.Text.Replace(",", "").Replace(" ", ""));
            formaMetodoPago.ImporteACobrar = dTotal;
        ...
        private void TiposDeDocumentos()
        {
            ...
            cboTiposDocumentos.Filtro = string.Format(" Status = 'A' and IdTipoDocumento = '{0}' ", sTipoDoctoFactura);
        ...
        private void tmProceso_Tick(object sender, EventArgs e)
        {
            if (!bProcesando) 
            {
                ...
                {
                    if (bDocumentoElectronico_Generado)
                    {
        ...
        private void BloquearControles(bool Bloquear)
        {
            ...
            cboTiposDocumentos.Enabled = Bloquear; 
        ...
        private bool RegistrarDocumentoElectronico()
        {
            bool bRegresa = false;
            ...
            //sXMLFormaPago = sXMLFormaPago == "" DtIFacturacion.XMLFormaPago_Default ? sXMLFormaPago; 
            ...
            sSql = string.Format("Exec {0} \n" +
                ...
                "\t@IdPersonalEmite = '{26}', @UsoDeCFDI = '{27}',  " +
                "\t@Referencia_02 = '{28}',  @Referencia_03 = '{29}', @Referencia_04 = '{30}',  @Referencia_05 = '{31}', \n" +
                "\t@IdEstablecimiento = '{32}', @IdEstablecimiento_Receptor = '{33}' \n", 
                sStoreEnc,
                sIdEmpresa, sIdEstado, sIdFarmacia, sTipoDoctoFactura, //cboTiposDocumentos.Data,
            ...
            else
            {
                ...
                for (int Renglon = 1; Renglon <= list.Registros; Renglon++)
                {
                    ...
                    string Identificador = Renglon.ToString(); 
        ...
        private void ImprimirDocumento()
        {
            ...
            print.Imprimir(sSerieDocumento, sFolioDocumento); 
        }
        ...
        private bool ImprimirDocumento_Timbrado()
        {
            ...
            string sMensaje = "¿ Desea visualisar el documento generado ?";
            string sFileName = ""; 
            string sXML = "";
            string sPDF = "";
            string sEmail = ""; 
        ...
        private void Encabezado(DateTime FechaHora)
        {
            ...
            cfdi.TipoDocumento = xsaTipoDocumento.TipoDePlantilla(cboTiposDocumentos.ItemActual.GetItem("Alias")); 
        ...
        {
            clsGrabarError.LogFileError("GenerarCFDI : " + Mensaje);
        }
        ...
        private bool GenerarTimbre_PAC()
        {
            ...
            {
                ////LogProceso("");
                ////LogProceso("Generando informacion para factura electronica");
                ...
                if (bRegresa)
                {
                    ...
                    CFDI_FD.PAC = tpPAC;
                    ////LogProceso("Generando factura electronica");
        ...
        private void IniciarEtiquetasTotales()
        {
            int iValor = 0;
        ...
        {
            int iID = 0;
            string sSAT_ClaveProducto_Servicio = list.GetValue(Renglon, (int)Cols.SAT_ClaveProductoServicio);
            string sSAT_UnidadDeMedida = list.GetValue(Renglon, (int)Cols.SAT_UnidadDeMedida);  
            ...
            if (Tipo == 1)
            {
                ...
                if (f.Guardado)
                {
                    ...
                    sSAT_ClaveProducto_Servicio = f.SAT_ClaveProductoServicio;
                    sSAT_UnidadDeMedida = f.SAT_UnidadDeMedida; 
                    Clave = f.Clave;
                    ...
                    itmX.SubItems.Add(sSAT_ClaveProducto_Servicio);
            ...
            if (Tipo == 2)
            {
                ...
                f.SAT_ClaveProductoServicio = sSAT_ClaveProducto_Servicio;
                f.SAT_UnidadDeMedida = sSAT_UnidadDeMedida; 
                f.Clave = Clave;
                ...
                if (f.Guardado)
                {
                    ...
                    list.SetValue(Renglon, (int)Cols.SAT_ClaveProductoServicio, sSAT_ClaveProducto_Servicio);
                    list.SetValue(Renglon, (int)Cols.SAT_UnidadDeMedida, sSAT_UnidadDeMedida);
        ...
        private void FrmCFDI_Facturas_Shown( object sender, EventArgs e )
        {
