...
{
    public partial class FrmGenerarCDFIs : FrmBaseExt
    {
        ...
        eVersionCFDI tpVersionCFDI = eVersionCFDI.Version__3_2; 
        ...
        clsGenCFDI_Ex myCFDI = null; //new clsGenCFDI_Ex();
        ...
        #region Form
        private void FrmGenerarCDFIs_Load(object sender, EventArgs e)
        {
            list.LimpiarItems(); 
            InicializaPantalla();
            TiposDeDocumentos(); 
        ...
        private bool RegistrarDocumentoElectronico()
        {
            ...
            sXMLFormaPago = formaMetodoPago.FormaDePago;
            ...
            sSql = string.Format("Exec {0} " + 
                ...
                " @IdPersonalEmite = '{26}' ", 
                sStoreEnc, 
                sIdEmpresa, sIdEstado, sIdFarmacia, cboTiposDocumentos.Data,
                ...
                if (bRegresa)
                {
                    ...
                    while (leerMetodosDePago.Leer())
                    {
                        if (leerMetodosDePago.CampoDouble("Importe") > 0)
                        {
                           ...
                           sIdEmpresa, sIdEstado, sIdFarmacia, sSerieDocumento, sFolioDocumento,
                           leerMetodosDePago.Campo("IdMetodoDePago"), leerMetodosDePago.CampoDouble("Importe"), leerMetodosDePago.Campo("Referencia"));
