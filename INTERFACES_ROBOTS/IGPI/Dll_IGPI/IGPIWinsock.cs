...
namespace Dll_IGPI
{
    public class IGPI_Winsock 
    {
        ...
        static bool bSolicitud_K_Interrumpida = false;
        ...
        public static void Solicitud_K_Interrumpir()
        {
        ...
        public static bool Solicitud_K_Interrumpida
        {
            get { return bSolicitud_K_Interrumpida; }
            //set { bSolicitud_K_Interrumpida = value; }
        } 
        ...
        private static void RegistrarEvento_Ext(int Tipo, string Mensaje)
        {
            ...
            bool bRegistrar_Log = false;
            EventoLog TipoDeEvento = (EventoLog)Tipo; //EventoLog.Ninguno;
            string sTexto = "";
            string sContenido = ""; 
            string sMarcaTiempo = string.Format("{0}{1}{2}_{3}{4}{5}{6}",
            ...
            sTexto = string.Format("{0}\tTipo : {1}\t{2} ", sMarcaTiempo, TipoDeEvento.ToString(), Mensaje);
            ...
            if (rtxtLog_Comunicacion != null)
            {
                ...
                try
                {
                    ...
                    bRegistrar_Log = ( TipoDeEvento == EventoLog.EnvioDeDatos || TipoDeEvento == EventoLog.RecepcionDeDatos ); 
                    if (bRegistrar_Log)
                    {
                        rtxtLog_Comunicacion.Text += string.Format("{0} \n", sTexto);
        ...
        private static void DecodificarDialogo(string MensajeRecibido)
        {
            ...
            switch (dialogo)
            {
                ...
                case Dialogos.i:
                    ...
                    ////if (I.Status == IGPI_i_State.ConfirmationPackageStored)
                    ////{
        ...
        private static void AbrirConexion()
        {
            ...
            Error = new clsGrabarError(cnn.DatosConexion, IGPI.DatosApp, "IGPI_Winsock");
        ...
        public static bool Terminar()
        {
            ...
            if (General.msjConfirmar("Si cierra Interface IGPI se deshabilitara la entrega de Productos al mostrador.\n\n¿ Desea continuar ?") == DialogResult.Yes)
            {
