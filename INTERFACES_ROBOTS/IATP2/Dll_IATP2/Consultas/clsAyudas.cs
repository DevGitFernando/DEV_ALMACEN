...
namespace Dll_IATP2
{
    public class clsAyudas_IATP2
    {
        ...
        private clsConsultas_IATP2 query;
        ...
        private FrmIMachAyuda FrmI_Ayuda; 

        private clsDatosConexion DatosConexion;
        private clsConexionSQL ConexionSql;
        private string Name = "DllFarmaciaSoft.clsAyudas_IATP2";
        string sNameDll = "";
        string sPantalla = "";
        string sVersion = "";
        ...
        public clsAyudas_IATP2(string prtCnnString, string cnnWebUrl, bool bUsarRedLocal)
        {
        ...
        public clsAyudas_IATP2(clsDatosConexion Conexion, clsDatosApp DatosApp, string Pantalla)
        {
            ...
            query = new clsConsultas_IATP2(DatosConexion, DatosApp.Modulo, Pantalla, DatosApp.Version);
        }

        public clsAyudas_IATP2(clsDatosConexion Conexion, clsDatosApp DatosApp, string Pantalla, bool MostrarMsjLeerVacio)
        {
            this.sNameDll = DatosApp.Modulo;
            this.sPantalla = Pantalla;
            this.sVersion = DatosApp.Version;
        ...
        public clsAyudas_IATP2(clsDatosConexion Conexion, string Modulo, string Pantalla, string Version)
        {
            ...
            ConexionSql = new clsConexionSQL(Conexion);
            ConexionSql.SetConnectionString();
            query = new clsConsultas_IATP2(DatosConexion, Modulo, Pantalla, Version);
        }

        public clsAyudas_IATP2(clsDatosConexion Conexion, string Modulo, string Pantalla, string Version, bool MostrarMsjLeerVacio)
        {
            this.sNameDll = Modulo;
            this.sPantalla = Pantalla;
            this.sVersion = Version;
            ...
            ConexionSql = new clsConexionSQL(Conexion);
            ConexionSql.SetConnectionString();
            query = new clsConsultas_IATP2(DatosConexion, Modulo, Pantalla, Version, MostrarMsjLeerVacio);
        }
        ...
        public DataSet Terminales(string Funcion)
        {
            ...
            sSql = "Select Nombre as Terminal, 'Clave de Terminal' = IdTerminal From IMach_CFGC_Terminales (NoLock) Order by Nombre ";
            dtsClase = new DataSet();
