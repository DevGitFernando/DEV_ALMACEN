...
Create Proc spp_Mtto_IMach_CFGC_Terminales 
( 
	...
	If @iOpcion = 1 
       Begin 
		   ...
		   If Not Exists ( Select * From IMach_CFGC_Terminales (NoLock) Where IdTerminal = @IdTerminal ) 
			  Begin 
				 Insert Into IMach_CFGC_Terminales ( IdTerminal, Nombre, MAC_Address, EsDeSistema, Status, Actualizado ) 
				 Select @IdTerminal, @Nombre, @MAC_Address, @iEsInterface, @sStatus, @iActualizado 
              End 
		   Else 
			  Begin 
			     Update IMach_CFGC_Terminales 
