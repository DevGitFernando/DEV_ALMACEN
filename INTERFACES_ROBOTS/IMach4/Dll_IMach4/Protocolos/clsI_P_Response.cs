...
namespace Dll_IMach4.Protocolos
{
    public class clsI_P_Response
    {
        ...
        public clsI_P_Response(IMach4Parametros Parametros)
        {
            sRespuesta = ""; 
            pMach = Parametros; 
            pMach.Dialogo = "P"; 
        ...
        private void DecodificarMensaje()
        {
            ...
            sSql = string.Format("Select top 1 replace(convert(varchar(10), getdate(), 104 ), '.', '') as ERP_Date, " +
                " right( (replicate('0', {1}) + CodigoEAN), {1}) as CodigoIMach4, *, " +
            ...
            else
            {
                ...
                else
                {
                    ...
                    ////pMach.ProductCode = leer.Campo("CodigoIMach4");  // Enviar el dato original 
                    ////pMach.Barcode = leer.Campo("CodigoIMach4");
