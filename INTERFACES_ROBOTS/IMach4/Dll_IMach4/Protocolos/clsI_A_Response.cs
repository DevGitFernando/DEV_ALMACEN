...
namespace Dll_IMach4.Protocolos
{
    public class clsI_A_Response
    {
        ...
        bool bResponder = IMach4.Habilitar_B__Al_Dispensar; //false;
        ...
        public clsI_A_Response(string Mensaje)
        {
            ...
            bResponder = IMach4.Habilitar_B__Al_Dispensar; 
        }
        ...
        {
            string sSql = string.Format(" Exec spp_Mtto_IMach_SolicitudesProductosRespuesta '{0}', '{1}', '{2}', '{3}' ",
